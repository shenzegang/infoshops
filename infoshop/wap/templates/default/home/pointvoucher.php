      ...
      <ul>
        ...
        <li class="item">
					<div class="voucher-pic" nc_type='exchangebtn'
						data-param='{"vid":"<?php echo $v_voucher['voucher_t_id'];?>"}'>
						<span class="thumb size160"><i></i> <img
							src="<?php echo $v_voucher['voucher_t_customimg'];?>"
						...
						<dl>
							...
							<dd><?php echo $lang['home_voucher_desc_1']; ?><?php echo $v_voucher['voucher_t_limit'];?><?php echo $lang['currency_zh'].$lang['home_voucher_desc_2']; ?><em><?php echo $lang['currency'].$v_voucher['voucher_t_price'];?></em>
							</dd>
						</dl>
					</div>
					<div class="voucher-store">
						<p class="logo">
							<span class="thumb size160-48"><i></i> <img
								src="<?php echo getStoreLogo($v_voucher['store_label']);?>"
								onload="javascript:DrawImage(this,160,48);"> </span>
						</p>
						<p class="name">
							<a target="_blank"
								href="<?php echo urlShop('show_store', 'index', array('store_id'=>$v_voucher['store_id']));?>"><?php echo $v_voucher['store_name'];?></a>
						</p>
					</div>
				</li>
        <?php }?>
