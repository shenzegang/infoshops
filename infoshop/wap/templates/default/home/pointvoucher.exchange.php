...
<div class="voucherinfo">
  ...
  <form method="post"
		action="index.php?act=pointvoucher&op=voucherexchange_save"
		id="exform" onsubmit="ajaxpost('exform', '', '', 'onerror');">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="vid"
			value="<?php echo $output['voucher_info']['voucher_t_id']; ?>" />
		...
		<div class="enter">
			<input type="submit" class="submit"
				value="<?php echo $lang['home_voucher_exchangbtn'];?>" />
		</div>
	</form>
  <?php }else {?>
