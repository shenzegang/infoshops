...
class brandControl extends BaseHomeControl
{
    ...
    public function indexOp()
    {
        ...
        // 获得品牌列表
        $model = Model();
        $brand_c_list = $model->table('brand')
            ->where(array(
            'brand_apply' => '1'
        ))
    ...
    private function _tidyBrand($brand_c_list)
    {
        ...
        return array(
            'brand_listnew' => $brand_listnew,
            'brand_class' => $brand_class,
            'brand_r_list' => $brand_r_list
        );
    }
    ...
    public function listOp()
    {
        ...
        Tpl::output('brand_name', $brand_lise['brand_name']);
        ...
        Model('seo')->type('brand_list')
            ->param(array(
            'name' => $brand_lise['brand_name']
        ))
            ->show();
