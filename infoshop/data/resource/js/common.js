...
//点击立即购买跳转至提交订单页面
function login_dialog_for_buy(goods){
    CUR_DIALOG = ajax_form('login','登录',SITEURL+'/index.php?act=login&inajax=1&ref_url=index.php?act=buy%26op=buy_step1%26cart_id[]='+goods,360,1);
}
