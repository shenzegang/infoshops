...
<div
	class="tabs-panel sale-goods-list <?php echo $i==1 ? '':'tabs-hide';?>">
	<ul>
			...
			<dl>
				...
				<dd class="goods-price"><?php echo $lang['index_index_store_goods_price'].$lang['nc_colon'];?><em><?php echo ncPriceFormatForList($v['goods_price']); ?></em>
				</dd>
			</dl>
		</li>
                                    <?php } ?>
