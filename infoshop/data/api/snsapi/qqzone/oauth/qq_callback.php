...
{
        $token_url = "https://graph.qq.com/oauth2.0/token?grant_type=authorization_code&" . "client_id=" . $_SESSION['qqzone']["appid"] . "&redirect_uri=" . urlencode($_SESSION['qqzone']["callback"]) . "&client_secret=" . $_SESSION['qqzone']["appkey"] . "&code=" . $_REQUEST["code"];
