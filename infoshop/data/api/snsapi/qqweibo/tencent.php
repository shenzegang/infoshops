...
class OAuth
{
    ...
    {
        if (isset($_SESSION['qqweibo']['t_access_token']))
            unset($_SESSION['qqweibo']['t_access_token']);
        if (isset($_SESSION['qqweibo']['t_expire_in']))
            unset($_SESSION['qqweibo']['t_expire_in']);
        if (isset($_SESSION['qqweibo']['t_code']))
            unset($_SESSION['qqweibo']['t_code']);
        if (isset($_SESSION['qqweibo']['t_openid']))
            unset($_SESSION['qqweibo']['t_openid']);
        if (isset($_SESSION['qqweibo']['t_openkey']))
            unset($_SESSION['qqweibo']['t_openkey']);
        if (isset($_SESSION['qqweibo']['t_oauth_version']))
            unset($_SESSION['qqweibo']['t_oauth_version']);
    }
}
