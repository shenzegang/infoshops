...
abstract class XSDataSource
{
     ...
     * 
     * @param string $type
     *            数据源类型, 如: mysql://.., json, csv ...
     * @param mixed $arg
     *            建立对象的参数, 如 SQL 语句, JSON/CSV 文件
...
abstract class XSDatabase
{
     ...
     * 
     * @param array $param
     *            连接参数, 采用 parse_url 解析, 可能包含: scheme,user,pass,host,path,table,dbname ...
     */
...
class XSDatabaseMySQL extends XSDatabase
{
     ...
     * 
     * @param array $param
     *            连接参数, 包含: user,pass,host,table,dbname ...
     */
