...
class life_article_classModel
{
    ...
    {
        $param = array();
        $param['table'] = 'life_article_class';
    ...
    public function add($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = Db::insert('life_article_class', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function update($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = Db::update('life_article_class', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function del($id)
    {
        if (intval($id) > 0) {
            ...
            $result = Db::delete('life_article_class', $where);
            return $result;
        } else {
            return false;
        }
    ...
    {
        $all_class = $this->getClassList(array(
            'order' => 'ac_parent_id asc,ac_sort asc,ac_id asc'
        ));
