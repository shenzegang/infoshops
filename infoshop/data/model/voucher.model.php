...
class voucherModel extends Model
{
    ...
    public function getNewApply($store_id)
    {
        ...
        $new_apply = $this->table('voucher_apply')
            ->where(array(
    ...
    public function getUsableTemplateInfo($vid)
    {
        ...
        $voucher_info = $this->table('voucher_template,store')
            ->field($field)
            ->join('left')
            ->on($on)
            ->where(array(
