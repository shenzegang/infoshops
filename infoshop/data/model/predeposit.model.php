...
class predepositModel extends Model
{
     ...
     * @return unknown
     */
    public function changePd($change_type, $data = array(), $log = true)
    {
        $data_log = array();
        $data_pd = array();
        ...
        switch ($change_type) {
            case 'order_pay':
                ...
                $data_pd['available_predeposit'] = array(
                    'exp',
                    'available_predeposit-' . $data['amount']
                );
                break;
            case 'order_freeze':
                $data_log['lg_av_amount'] = - $data['amount'];
                ...
                $data_pd['freeze_predeposit'] = array(
                    'exp',
                    'freeze_predeposit+' . $data['amount']
                );
                $data_pd['available_predeposit'] = array(
                    'exp',
                    'available_predeposit-' . $data['amount']
