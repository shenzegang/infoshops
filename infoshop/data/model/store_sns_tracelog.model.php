    ...
    public function spellingStyle($type, $data)
    {
        ...
        switch ($type) {
            ...
            case '3':
                ...
                )) . "\"><img src=\"" . cthumb($data['goods_image'], 240, $data['store_id']) . "\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['goods_name'] . "\"></a></div>
    					<div class=\"goodsinfo\">
    					<dl>
    					   <dt><i class=\"desc-type desc-type-new\">" . L('store_sns_new_selease') . "</i><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\">" . $data['goods_name'] . "</a></dt>
            ...
            case '4':
                $rs = "<div class=\"fd-media\">
					<div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('coupon_store', 'detail', array(
                    'coupon_id' => $data['coupon_id'],
                    'id' => $data['store_id']
                )) . "\"><img src=\"" . $data['coupon_pic'] . "\" onerror=\"this.src='" . SHOP_TEMPLATES_URL . "/images/default_coupon_image.png'\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['coupon_title'] . "\"></a></div>
    					<div class=\"goodsinfo\">
    					<dl>
        					<dt><i class=\"desc-type desc-type-coupon\">" . L('store_sns_coupon') . "</i><a target=\"_blank\" href=\"" . urlShop('coupon_store', 'detail', array(
                    'coupon_id' => $data['coupon_id'],
                    'id' => $data['store_id']
                )) . "\">" . $data['coupon_title'] . "</a></dt>
            ...
            case '5':
                $rs = "<div class=\"fd-media\">
                    ...
                    'goods_id' => $data['goods_id']
    					...
    					<div class=\"goodsinfo\">
    					<dl>
        					<dt><i class=\"desc-type desc-type-xianshi\">" . L('store_sns_xianshi') . "</i><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\">" . $data['goods_name'] . "</a></dt>
    						<dd>" . L('sns_sharegoods_price') . L('nc_colon') . L('currency') . ncPriceFormat($data['goods_price']) . "</dd>
            ...
            case '6':
                $rs = "<div class=\"fd-media\">
					<div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('show_store', 'index', array(
                    'store_id' => $data['store_id']
                )) . "\"><img src=\"" . SHOP_TEMPLATES_URL . "/images/mjs-pic.gif\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['ansong_name'] . "\"></a></div>
    					<div class=\"goodsinfo\">
    					<dl>
        					<dt><i class=\"desc-type desc-type-mansong\">" . L('store_sns_mansong') . "</i><a target=\"_blank\" href=\"" . urlShop('show_store', 'index', array(
                    'store_id' => $data['store_id']
                )) . "\">" . $data['mansong_name'] . "</a></dt>
            ...
            case '7':
                $rs = "<div class=\"fd-media\">
					<div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\"><img src=\"" . cthumb($data['bl_img'], 240, $data['store_id']) . "\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['bl_name'] . "\"></a></div>
    					<div class=\"goodsinfo\">
    					<dl>
        					<dt><i class=\"desc-type desc-type-bundling\">" . L('store_sns_bundling') . "</i><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\">" . $data['bl_name'] . "</a></dt>
            ...
            case '8':
                $rs = "<div class=\"fd-media\">
					<div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\"><img src=\"" . gthumb($data['group_pic'], 'small', $data['store_id']) . "\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['group_name'] . "\"></a></div>
    					<div class=\"goodsinfo\">
    					<dl>
        					<dt><i class=\"desc-type desc-type-groupbuy\">" . L('store_sns_gronpbuy') . "</i><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\">" . $data['group_name'] . "</a></dt>
            ...
            case '9':
                $rs = "<div class=\"fd-media\">
    				<div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\"><img src=\"" . thumb($data, 240) . "\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['goods_name'] . "\"></a></div>
    				<div class=\"goodsinfo\">
    				<dl>
    					<dt><i class=\"desc-type desc-type-recommend\">" . L('store_sns_store_recommend') . "</i><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\">" . $data['goods_name'] . "</a></dt>
				        <dd>" . L('sns_sharegoods_price') . L('nc_colon') . L('currency') . ncPriceFormat($data['goods_price']) . "</dd>
            ...
            case '10':
                $rs = "<div class=\"fd-media\">
					...
					<div class=\"goodsinfo\">
						<dl>
							<dt><i class=\"desc-type desc-type-hotsell\">" . L('store_sns_hotsell') . "</i><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array(
                    'goods_id' => $data['goods_id']
                )) . "\">" . $data['goods_name'] . "</a></dt>
					        <dd>" . L('sns_sharegoods_price') . L('nc_colon') . L('currency') . ncPriceFormat($data['goods_price']) . "</dd>
							<dd>" . L('sns_sharegoods_freight') . L('nc_colon') . L('currency') . ncPriceFormat($data['goods_freight']) . "</dd>
