...
class albumModel extends Model
{
    ...
    public function getClassList($condition, $page = '')
    {
        ...
        $param['join_on'] = array(
            'album_class.aclass_id = album_pic.aclass_id'
        );
    ...
    public function delAlbum($id)
    {
        ...
        $pic_list = $this->getPicList(array(
            " store_id= " . $id
        ), '', 'apic_cover');
    ...
    public function getOneClass($param)
    {
        if (is_array($param) && ! empty($param)) {
            return Db::getRow(array_merge(array(
                'table' => 'album_class'
            ), $param));
        } else {
            return false;
