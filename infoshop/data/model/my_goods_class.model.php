...
class my_goods_classModel extends Model
{
    ...
    public function dropGoodsClass($store_class_id)
    {
        ...
        foreach ($array as $val) {
            $class_info = $this->getClassInfo(array(
                'stc_id' => $val,
    ...
    {
        $show_class = array();
        $class_list = $this->getClassList(array(
            'store_id' => $store_id,
            'stc_state' => '1',
            'order' => 'stc_parent_id asc,stc_sort asc,stc_id asc'
        ));
