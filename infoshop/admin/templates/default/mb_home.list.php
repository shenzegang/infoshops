	...
	<form method='post' id="form_link">
        ...
        <tr class="hover edit">
					...
					<td class="w48 sort"><span class="tooltip editable"
						title="<?php echo $lang['nc_editable'];?>" ajax_branch='h_sort'
						datatype="number" fieldid="<?php echo $v['h_id'];?>"
						fieldname="h_sort" nc_type="inline_edit"><?php echo $v['h_sort'];?></span></td>
                ...
                ?></td>
					<td class="w96 align-center"><a
						href="index.php?act=mb_home&op=mb_home_edit&h_id=<?php echo $v['h_id'];?>"><?php echo $lang['nc_edit'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
