...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" value="cms_comment" name="act"> <input
			...
			<tbody>
                ...
                <tr class="hover edit">
					...
					<td>
                        ...
                        <?php } else { ?>
                        <a
						href="<?php echo $cms_url.DS.'index.php?act='.$output['type_array'][$value['comment_type']]['key'].'&op='.$output['type_array'][$value['comment_type']]['key'].'_detail&'.$output['type_array'][$value['comment_type']]['key'].'_id='.$value['comment_object_id'];?>"
						target="_blank">
                            <?php echo $value['comment_object_id'];?>
                        </a>
                        <?php } ?>
