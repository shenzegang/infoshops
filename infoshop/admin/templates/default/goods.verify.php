...
<div class="page">
	...
	<form method="get" name="formSearch" id="formSearch">
		<input type="hidden" name="act" value="goods" /> <input type="hidden"
			name="op" value="goods" /> <input type="hidden" name="type"
			value="waitverify" />
			...
			<tbody>
				<tr>
					...
					<td><select name="search_verify">
							...
							<option value="10"
								<?php if ($output['search']['search_verify'] != '' && $output['search']['search_verify'] == 10) {?>
								selected="selected" <?php }?>>等待审核</option>
							<option value="0"
								<?php if ($output['search']['search_verify'] != '' && $output['search']['search_verify'] == 0) {?>
								selected="selected" <?php }?>>未通过</option>
					</select></td>
					<th><label><?php echo $lang['goods_index_class_name'];?></label></th>
					<td id="gcategory"><input type="hidden" id="cate_id" name="cate_id"
						value="" class="mls_id" /> <input type="hidden" id="cate_name"
              ...
              <?php } ?>
              <?php } ?>
            </select> <a href="javascript:void(0);" id="ncsubmit"
	...
	<form method='post' id="form_goods"
        ...
        <tr class="hover edit">
					<td class="w24"><input type="checkbox" name="id[]"
						value="<?php echo $v['goods_commonid'];?>" class="checkitem"></td>
					<td><i class="icon-plus-sign" nctype="ajaxGoodsList"
						data-comminid="<?php echo $v['goods_commonid'];?>"
						style="cursor: pointer;"></i></td>
					<td><?php echo $v['goods_commonid'];?></td>
					<td class="w60"><div class="goods-picture">
							<span class="thumb size-goods"><i></i><img
					...
					<td class="w48 align-center">
						...
						<p>
							<a href="javascript:void(0);"
								onclick="goods_verify(<?php echo $v['goods_commonid'];?>);">审核</a>
						</p>
					</td>
				</tr>
			...
			<tfoot>
				<tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						nctype="verify_batch"><span>审核</span></a> <a
