...
<div class="page">
	...
	<form id="add_form" method="post" enctype="multipart/form-data"
		action="index.php?act=complain&op=complain_subject_save">
		<table class="table tb-type2 nobdb">
			<tbody>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="complain_subject_content"><?php echo $lang['complain_subject_content'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						id="complain_subject_content" name="complain_subject_content"
						class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="complain_subject_desc"><?php echo $lang['complain_subject_desc'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="complain_subject_desc"
							rows="6" class="tarea" id="complain_subject_desc"></textarea></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tfoot>
