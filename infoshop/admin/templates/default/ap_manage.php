...
<div class="page">
	...
	<form method="get" action="index.php?act=adv&op=ap_manage"
		name="formSearch">
		<input type="hidden" name="act" value="adv" /> <input type="hidden"
			name="op" value="ap_manage" />
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><label for="search_name"><?php echo $lang['ap_name']; ?></label></th>
					<td><input class="txt" type="text" name="search_name"
						id="search_name" value="<?php echo $_GET['search_name'];?>" /></td>
            ...
            <a href="JavaScript:void(0);" onclick=window.location.href=
						'index.php?act=adv&op=ap_manage ' class="btns "
						title="<?php echo $lang['adv_all']; ?>"><span><?php echo $lang['adv_all']; ?></span></a>
            <?php }?></td>
				</tr>
			</tbody>
		</table>
	...
	<form method="post" id="store_form">
        ...
        <tr class="hover">
					<td class="w24"><input type="checkbox" class="checkitem"
						name="del_id[]" value="<?php echo $v['ap_id']; ?>" /></td>
            ...
            <a href="JavaScript:void(0);" class=" disabled"
						ajax_branch="is_use" nc_type="inline_edit" fieldname="is_use"
						fieldid="<?php echo $v['ap_id']?>" fieldvalue="0"
            ...
            <a href="JavaScript:void(0);" class=" enabled"
						ajax_branch="is_use" nc_type="inline_edit" fieldname="is_use"
						fieldid="<?php echo $v['ap_id']?>" fieldvalue="1"
						title="<?php echo $lang['nc_editable'];?>"><img
							src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php } ?></td>
					<td class="align-center"><a
						href="index.php?act=adv&op=adv&ap_id=<?php echo $v['ap_id'];?>">管理广告</a>
						| <a
						href='index.php?act=adv&op=ap_edit&ap_id=<?php echo $v['ap_id'];?>'><?php echo $lang['nc_edit'];?></a>
						|<a href="javascript:void(0)"
						onclick="copyToClipBoard('<?php echo $v['ap_id'];?>');"><?php echo $lang['ap_get_js'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
			...
			<tfoot>
				<tr class="tfoot">
					...
					<td id="batchAction" colspan="15"><span class="all_checkbox"> <label
							for="checkall"><?php echo $lang['nc_select_all'];?></label>
					</span>&nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn"
						onclick="if(confirm('<?php echo $lang['ap_del_sure'];?>')){$('#store_form').submit();}"><span><?php echo $lang['nc_del'];?></span></a>
