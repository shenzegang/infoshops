...
<div class="page">
	...
	<form method="get" action="index.php" name="formSearch" id="formSearch">
		<input type="hidden" name="act" value="refund" /> <input type="hidden"
			name="op" value="refund_all" />
				...
				<tr>
					<th><select name="type">
							...
							<option value="store_name"
								<?php if($_GET['type'] == 'store_name'){?> selected <?php }?>><?php echo $lang['refund_store_name']; ?></option>
					...
					<td><input type="text" class="text" name="key"
						value="<?php echo trim($_GET['key']); ?>" /></td>
					<th><label for="add_time_from"><?php echo '申请时间';?></label></th>
					<td><input class="txt date" type="text"
						value="<?php echo $_GET['add_time_from'];?>" id="add_time_from"
						name="add_time_from"> <label for="add_time_to">~</label> <input
						class="txt date" type="text"
						value="<?php echo $_GET['add_time_to'];?>" id="add_time_to"
						name="add_time_to" /></td>
	...
	<table class="table tb-type2 nobdb">
      ...
      <tr class="bd-line">
				...
				<td class="align-center"><a
					href="index.php?act=refund&op=view&refund_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a></td>
			</tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
