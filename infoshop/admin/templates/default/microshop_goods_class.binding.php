...
<div class="page">
	...
	<table class="table tb-type2">
		<tbody>
			...
			<tr class="noborder">
				<td class="vatop rowform" colspan="2"><ul
						id="goods_class_binding_list" class="goods-class-binding-list">
            ...
            <li class="class_binding_item"><?php echo $output['goods_class'][$val['shop_class_id']]['gc_name'];?> <i
							class="class_binding_item_delete"
							gc_id="<?php echo $val['shop_class_id'];?>"
			...
			<tr class="noborder">
				<td class="vatop rowform" colspan="2"><select id="goods_class"
					name="goods_class">
...
<form id="add_form" method="POST"
	action="index.php?act=microshop&op=goodsclass_binding_save">
	<input id="class_id" name="class_id" type="hidden"
		value="<?php echo $output['class_id'];?>" /> <input id="shop_class_id"
		name="shop_class_id" type="hidden"
		value="<?php echo $output['class_binding_string'];?>" />
</form>
