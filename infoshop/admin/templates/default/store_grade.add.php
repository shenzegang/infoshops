	...
	<form id="grade_form" method="post">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="" id="sg_name"
						name="sg_name" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="1000"
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul class="nofloat">
							<li><input type="checkbox" id="function_editor_multimedia"
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="" id="sg_price"
						name="sg_price" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea rows="6" class="tarea"
							id="sg_description" name="sg_description"></textarea></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="sg_sort"
						name="sg_sort" class="txt"></td>
