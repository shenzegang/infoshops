...
<div class="page">
	...
	<form method="post" id="form_email" name="settingForm"
		...
		<table class="table tb-type2">
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label for="subject">邮件标题:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input id="subject" name="subject"
						class="txt" type="text" /></td>
					<td class="vatop tips"><span class="vatop rowform"></span></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label for="content">邮件内容:</label></td>
				</tr>
				<tr class="noborder">
            ...
            <?php showEditor('content'); ?>
				...
				<tr>
					<td colspan="2" class="required"><label for="subject">目标:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="radio" name="type" value="0">
						所有会员 <input type="radio" name="type" value="1"> 所有商铺</td>
					<td class="vatop tips"><span class="vatop rowform"></span></td>
				</tr>
			</tbody>
			<tfoot>
