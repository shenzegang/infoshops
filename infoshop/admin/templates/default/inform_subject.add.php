...
<div class="page">
	...
	<form id="add_form" method="post" enctype="multipart/form-data"
		action="index.php?act=inform&op=inform_subject_save">
              ...
              <li>
								<p>
									<input type='radio' name="inform_subject_type"
										id="<?php echo $inform_type['inform_type_id'].','.$inform_type['inform_type_name'];?>"
										value="<?php echo $inform_type['inform_type_id'].','.$inform_type['inform_type_name'];?>">
									<label
										for="<?php echo $inform_type['inform_type_id'].','.$inform_type['inform_type_name'];?>"><?php echo $inform_type['inform_type_name'];?>:</label>
									</input> &nbsp;&nbsp;<span style="color: green"><?php echo $inform_type['inform_type_desc'];?></span>
								</p>
							</li>
              <?php } ?>
            </ul></td>
				...
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="inform_subject_content"><?php echo $lang['inform_subject'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						id="inform_subject_content" name="inform_subject_content"
						class="txt"></td>
