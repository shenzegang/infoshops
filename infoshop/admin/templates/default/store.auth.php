...
<div class="page">
	...
	<form method="post" id="store_form">
        ...
        <tr class="hover edit">
					<td><input type="checkbox" value="<?php echo $v['store_id'];?>"
            ...
            <?php }?></td>
					...
					<td class="align-center"><a
						href="index.php?act=store&op=store_edit&store_id=<?php echo $v['store_id']?>&type=auth"><?php echo $lang['store_verify'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
			...
			<tfoot>
				<tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						onclick="batchAuth();"><span><?php echo $lang['store_pass_auth'];?></span></a>
