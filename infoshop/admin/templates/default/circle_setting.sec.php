	...
	<form id="circle_form" method="post" enctype="multipart/form-data">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_intervaltime"
						id="c_intervaltime" class="txt"
						value="<?php echo $output['list_setting']['circle_intervaltime'];?>"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_contentleast"
						id="c_contentleast" class="txt"
						value="<?php echo $output['list_setting']['circle_contentleast'];?>" /></td>
