...
<div class="page">
	...
	<form method="post" enctype="multipart/form-data" name="form1">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="old_login_pic1"
			value="<?php echo $output['list'][0];?>" /> <input type="hidden"
			name="old_login_pic2" value="<?php echo $output['list'][1];?>" /> <input
			type="hidden" name="old_login_pic3"
			value="<?php echo $output['list'][2];?>" /> <input type="hidden"
			name="old_login_pic4" value="<?php echo $output['list'][3];?>" />
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><a
							...
							href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_PATH.'/login/'.$output['list'][0]);?>"><img
								class="show_image"
								title="<?php echo Language::get('login_click_open');?>"
								src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png"></a>
					</span><span class="type-file-box"> <input name="login_pic1"
							type="file" class="type-file-file" id="login_pic1" size="30"
							hidefocus="true">
					</span></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><a
							class="nyroModal" rel="gal"
							href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_PATH.'/login/'.$output['list'][1]);?>"><img
								class="show_image"
								title="<?php echo Language::get('login_click_open');?>"
								src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png"></a>
					</span><span class="type-file-box"> <input name="login_pic2"
							type="file" class="type-file-file" id="login_pic2" size="30"
							hidefocus="true">
					</span></td>
					<td class="vatop tips">450px * 350px</td>
				</tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><a
							class="nyroModal" rel="gal"
							href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_PATH.'/login/'.$output['list'][2]);?>"><img
								class="show_image"
								title="<?php echo Language::get('login_click_open');?>"
								src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png"></a>
					</span><span class="type-file-box"> <input name="login_pic3"
							type="file" class="type-file-file" id="login_pic3" size="30"
							hidefocus="true">
					</span></td>
					<td class="vatop tips">450px * 350px</td>
				</tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><a
							class="nyroModal" rel="gal"
							href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_PATH.'/login/'.$output['list'][3]);?>"><img
								class="show_image"
								title="<?php echo Language::get('login_click_open');?>"
								src="<?php echo ADMIN_TEMPLATES_URL;?>/images/preview.png"></a>
					</span><span class="type-file-box"> <input name="login_pic4"
							type="file" class="type-file-file" id="login_pic4" size="30"
							hidefocus="true">
					</span></td>
					<td class="vatop tips">450px * 350px</td>
				</tr>
