...
<div
	class="cms-index-module-article2 module-style-<?php echo $value['module_style'];?>">
	...
	<div class="cms-index-module-article2-1">
      ...
      <div class="cms-index-module-handle">
				<a nctype="btn_module_article_edit"
					save_function="article_type_3_save" limit_count="4"
	...
	<div class="cms-index-module-article2-2">
      ...
      <div class="cms-index-module-handle">
				<a nctype="btn_module_article_edit"
					save_function="article_type_3_save" limit_count="2"
					href="JavaScript:void(0);" class="tip-l"
					title="<?php echo $lang['cms_index_module_article_image_edit'];?>"><?php echo $lang['cms_index_module_article_image_edit'];?></a>
			</div>
      <?php } ?>
      ...
      <div class="cms-index-module-handle">
				<a nctype="btn_module_article_edit"
					save_function="article_type_5_save" limit_count="4"
					href="JavaScript:void(0);" class="tip-l"
	...
	<div class="cms-index-module-article2-3">
      ...
      <?php if($output['edit_flag']) { ?>
      <div class="cms-index-module-handle">
				<a nctype="btn_module_brand_edit" limit_count="12"
					href="JavaScript:void(0);" class="tip-l"
					title="<?php echo $lang['cms_index_module_brand_edit'];?>"><?php echo $lang['cms_index_module_brand_edit'];?></a>
			</div>
      <?php } ?>
    </div>
	</div>
