...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" value="life_info" name="act"> <input
		...
		<table class="tb-type1 noborder search">
            ...
            <a href="index.php?act=life_info&op=list" class="btns "
	...
	<form method="post" id="form_article">
        ...
        <tr class="hover">
					...
					<td class="align-center"><a
						href="index.php?act=life_info&op=edit&id=<?php echo $v['id']; ?>">编辑</a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
