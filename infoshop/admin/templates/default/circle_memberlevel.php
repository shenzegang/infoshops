...
<div class="page">
	...
	<form method="post" id="clmdForm" name="clmdForm">
		...
		<table class="table tb-type2 nomargin">
          ...
          <?php for ($i=1;$i<=16;$i++){?>
          <tr>
					<td class="tc"><?php echo $i;?><input type="hidden"
						name="cmld[<?php echo $i;?>][id]" value="<?php echo $i;?>" /></td>
					<td class="circle-level"><span
						class="circle-level-<?php echo $i;?>"><strong><?php echo $i;?></strong></span></td>
					<td><input type="text" name="cmld[<?php echo $i;?>][name]"
						value="<?php echo $output['mld_list'][$i]['mld_name'];?>" /></td>
					<td><input type="text" name="cmld[<?php echo $i;?>][exp]"
						value="<?php echo $output['mld_list'][$i]['mld_exp'];?>" /></td>
				</tr>
          <?php }?>
        </tbody>
			...
			<tfoot>
				<tr>
					<td colspan="10"><a href="JavaScript:void(0);" class="btn"
