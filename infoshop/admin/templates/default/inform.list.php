...
<div class="page">
	...
	<form id="search_form" method="get" name="formSearch">
		<input type="hidden" id="act" name="act" value="inform" /> <input
			type="hidden" id="op" name="op" value="inform_list" />
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><label for="input_inform_goods_name"><?php echo $lang['inform_goods_name'];?></label></th>
					<td><input class="txt" type="text" name="input_inform_goods_name"
						id="input_inform_goods_name"
						value="<?php echo $_GET['input_inform_goods_name'];?>"></td>
					<th><label for="input_inform_type"><?php echo $lang['inform_type'];?></label></th>
					<td colspan="2"><input class="txt" type="text"
						name="input_inform_type" id="input_inform_type"
						value="<?php echo $_GET['input_inform_type'];?>"
						style="width: 100px;"> <label for="input_inform_member_name"><?php echo $lang['inform_member_name'];?></label>
						<input class="txt" type="text" name="input_inform_member_name"
						id="input_inform_member_name"
						value="<?php echo $_GET['input_inform_member_name'];?>"
						style="width: 100px;"></td>
				</tr>
				<tr>
					<th><label for="input_inform_subject"><?php echo $lang['inform_subject'];?></label></th>
					<td><input class="txt" type="text" name="input_inform_subject"
						id="input_inform_subject"
						value="<?php echo $_GET['input_inform_subject'];?>"></td>
					<th><label for="time_from"><?php echo $lang['inform_datetime'];?></label></th>
					<td><input id="time_from" class="txt date" type="text"
						name="input_inform_datetime_start"
						value="<?php echo $_GET['input_inform_datetime_start'];?>"> <label
						for="time_to">~</label> <input id="time_to" class="txt date"
						type="text" name="input_inform_datetime_end"
						value="<?php echo $_GET['input_inform_datetime_end'];?>"></td>
            ...
            <a href="index.php?act=inform&op=inform_list" class="btns "
	...
	<form method='post' id="list_form"
		action="index.php?act=voucher_price&op=voucher_price_drop">
        ...
        <tr class="line">
					<td><a
						href="<?php echo urlShop('goods', 'index', array('goods_id'=>$v['inform_goods_id']));?>"
						target="_blank"><?php echo $v['inform_goods_name'];?></a></td>
            ...
            <?php } ?></td>
					...
					<td><a href="JavaScript:void(0);" class="show_detail"><?php echo $lang['nc_detail'];?></a>
						<a
						href="index.php?act=inform&op=show_handle_page&inform_id=<?php echo $v['inform_id'];?>&inform_goods_name=<?php echo $v['inform_goods_name'];?>"><?php echo $lang['inform_text_handle'];?></a></td>
				</tr>
							...
							<div class="content">
								...
								<div class="close_detail">
									<a href="JavaScript:void(0);"
										title="<?php echo $lang['nc_close'];?>"><?php echo $lang['nc_close'];?></a>
								</div>
							</div>
						</div></td>
				</tr>
