	...
	<form id="circle_form" method="post" enctype="multipart/form-data">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_seotitle"
						id="c_seotitle" class="txt"
						value="<?php echo $output['list_setting']['circle_seotitle'];?>" />
					</td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label for="c_seokeywords">SEO
							keywords:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea" rows="6"
							name="c_seokeywords" id="c_seokeywords"><?php echo $output['list_setting']['circle_seokeywords'];?></textarea>
					</td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label for="c_seodescription">SEO
							description:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea" rows="6"
							name="c_seodescription" id="c_seodescription"><?php echo $output['list_setting']['circle_seodescription'];?></textarea>
					</td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
