...
<div class="page">
  ...
  <form id="ship_form" method="post" name="ship_form"
		action="index.php?act=pointorder&op=order_ship&id=<?php echo $_GET['id']; ?>">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="shippingcode"
						name="shippingcode" class="txt"
						value="<?php echo $output['order_info']['point_shippingcode']; ?>"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="shippingtime"
						name="shippingtime" class="txt date"
						value="<?php if ($output['order_info']['point_shippingtime']){ echo @date('Y-m-d',$output['order_info']['point_shippingtime']);} ?>">
					</td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="shippingdesc" rows="6'"
							class="tarea" id="shippingdesc"><?php echo $output['order_info']['point_shippingdesc']; ?></textarea></td>
					<td class="vatop tips"></td>
				</tr>
  ...
  <?php } else { ?>
  <div class='msgdiv'> <?php echo $output['errormsg']; ?> <br> <br> <a
			class="forward"
			href="index.php?act=pointorder&amp;op=pointorder_list"><?php echo $lang['admin_pointorder_gobacklist']; ?></a>
	</div>
  <?php } ?>
</div>
<script type="text/javascript">
