...
<div class="page">
	...
	<form id="store_form" method="post">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="step" value="two" /> <input type="hidden"
			name="member_name"
			value="<?php echo $output['member_array']['member_name'];?>" /> <input
			type="hidden" name="member_id"
			value="<?php echo $output['member_array']['member_id'];?>" />
		<table class="table tb-type2 nobdb">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						id="store_owner_card" name="store_owner_card" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="store_name"><?php echo $lang['store_name'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						id="store_name" name="store_name" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
              ...
              <?php } ?>
				...
				<tr class="noborder">
					<td class="vatop rowform"><div class="select_add change-select-2"
							id="region">
							<input type="hidden" name="area_id" value="" class="area_ids" />
							<input type="hidden" name="area_info" value=""
								class="area_names " /> <select class="d_inline">
							</select>
						</div></td>
					<td class="vatop tips"></td>
				</tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						id="store_address" name="store_address" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						id="store_zip" name="store_zip" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						id="store_tel" name="store_tel" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
              ...
              <?php } ?>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="store_state1"
						class="cb-enable selected"><span><?php echo $lang['open'];?></span></label>
						<label for="store_state0" class="cb-disable"><span><?php echo $lang['close'];?></span></label>
						<input id="store_state1" name="store_state" checked=""
						onclick="$('#tr_store_close_info').hide();" value="1" type="radio">
						<input id="store_state0" name="store_state"
						onclick="$('#tr_store_close_info').show();" value="0" type="radio"></td>
				</tr>
			</tbody>
			<tbody id="tr_store_close_info">
				...
				<tr class="noborder">
					<td class="vatop rowform"><label for="store_close_info"></label> <textarea
							rows="6" class="tarea" id="store_close_info"
							name="store_close_info"></textarea></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul class="nofloat">
							<li><label for="name_auth"> <input type="checkbox" value="1"
									id="name_auth" name="name_auth">
                  <?php echo $lang['owner_certification'];?></label></li>
							<li><label for="material"> <input type="checkbox" id="store_auth"
									value="1" name="store_auth">
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="store_recommend1"
						...
						<input id="store_recommend1" name="store_recommend" checked=""
						value="1" type="radio"> <input id="store_recommend0"
						name="store_recommend" value="0" type="radio"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="0"
						id="store_sort" name="store_sort" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tfoot>
