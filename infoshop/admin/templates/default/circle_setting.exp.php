	...
	<form id="circle_form" method="post" enctype="multipart/form-data">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_exprelease"
						id="c_exprelease" class="txt"
						value="<?php echo $output['list_setting']['circle_exprelease'];?>"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_expreply"
						id="c_expreply" class="txt"
						value="<?php echo $output['list_setting']['circle_expreply'];?>" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_expreleasemax"
						id="c_expreleasemax" class="txt"
						value="<?php echo $output['list_setting']['circle_expreleasemax'];?>" /></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_expreplied"
						id="c_expreplied" class="txt"
						value="<?php echo $output['list_setting']['circle_expreplied'];?>" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_exprepliedmax"
						id="c_exprepliedmax" class="txt"
						value="<?php echo $output['list_setting']['circle_exprepliedmax'];?>" /></td>
					<td class="vatop tips"><?php echo $lang['circle_setting_exp_tips'];?></td>
				</tr>
			</tbody>
			<tfoot>
