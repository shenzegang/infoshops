	...
	<form method='post' id="form_link">
        ...
        <tr class="hover edit">
					<td class="w24"><input type="checkbox" name="del_id[]"
						value="<?php echo $v['gc_id'];?>" class="checkitem"></td>
                ...
                ?></td>
					<td class="w96 align-center"><a
						href="index.php?act=mb_category&op=mb_category_edit&gc_id=<?php echo $v['gc_id'];?>"><?php echo $lang['nc_edit'];?></a>
						| <a
						href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?act=mb_category&op=mb_category_del&gc_id=<?php echo $v['gc_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
