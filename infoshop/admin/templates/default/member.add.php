			...
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="member_name"><?php echo $lang['member_index_name']?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						name="member_name" id="member_name" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="member_passwd"><?php echo $lang['member_edit_password']?>:</label></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul>
							<li><label> <input type="radio" checked="checked" value="0"
									name="member_sex">
                  <?php echo $lang['member_edit_secret']?></label></li>
							<li><label> <input type="radio" value="1" name="member_sex">
                  <?php echo $lang['member_edit_male']?></label></li>
							<li><label> <input type="radio" value="2" name="member_sex">
                  <?php echo $lang['member_edit_female']?></label></li>
						</ul></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" class="required"><label for="member_tel"><?php echo $lang['member_edit_tel'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
