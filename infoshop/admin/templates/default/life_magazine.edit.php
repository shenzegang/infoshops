	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a href="index.php?act=life_magazine&op=add"><span>新增</span></a></li>
	...
	<form id="form" method="post">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['article_array']['url'];?>" name="url"
						id="url" class="txt"></td>
					<td class="vatop tips">当填写&quot;链接&quot;后点击杂志标题将直接跳转至链接地址，不显示杂志内容。链接格式请以http://开头</td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td colspan="2" class="vatop rowform"><?php showEditor('content',$output['article_array']['content'], '700px', '300px', 'visibility:hidden;', true, true);?></td>
				</tr>
				<tr>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?act=life_magazine&op=pic_upload&item_id=<?php echo $output['article_array']['id'];?>',
