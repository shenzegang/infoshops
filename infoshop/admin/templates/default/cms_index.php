...
<div class="page">
	...
	<div class="cms-edit-bg-line">
		<div
			style="background-color: #FFF; padding: 0 0 8px 0; margin-bottom: 12px; border-bottom: solid 1px #BCE6F8">
			<a class="btn" href="index.php?act=cms_index&op=cms_index_preview"
				target="_blank"><span>预览</span></a> <a class="btn"
				id="btn_index_build" href="Javascript: void(0)"><span><?php echo $lang['cms_index_build'];?></span></a>
			<a class="btn" href="<?php echo CMS_SITE_URL;?>" target="_blank"><span><?php echo $lang['cms_index_go'];?></span></a>
		</div>
		...
		<div id="template_module_list_content"
			class="template-module-list-content">
			<div class="template-module-list">
				<div id="template_module_list">
					<div id="template_module_list_standard"></div>
					<div id="template_module_list_custom_content"
						style="display: none;">
...
<div id="dialog_add_module" style="display: none;">
	...
	<div id="module_frame_edit" style="display: none;">
		...
		<form id="from_new_module" class="module-frame-btns">
			<input id="input_frame_name" type="hidden" /> <a
				id="btn_show_module_frame_list" href="JavaScript:;" class="btn"><span>重新选择框架</span></a>
