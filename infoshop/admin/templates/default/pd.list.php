...
<div class="page">
	...
	<form method="get" action="index.php" name="formSearch" id="formSearch">
		<input type="hidden" name="act" value="predeposit"> <input
			type="hidden" name="op" value="predeposit">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" id="query_start_date"
						name="query_start_date" class="txt date"
						value="<?php echo $_GET['query_start_date'];?>"> <label>~</label>
						<input type="text" id="query_end_date" name="query_end_date"
						class="txt date" value="<?php echo $_GET['query_start_date'];?>"></td>
	...
	<table class="table tb-type2">
      ...
      <tr class="hover">
        ...
        <?php } ?>
          ...
          <a
					href="index.php?act=predeposit&op=recharge_del&id=<?php echo $v['pdr_id']; ?>"><?php echo $lang['nc_del']; ?></a>
          <?php } ?>
          <a
					href="index.php?act=predeposit&op=recharge_info&id=<?php echo $v['pdr_id']; ?>"
