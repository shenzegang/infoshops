...
<div class="page">
	...
	<form method="post" name="form1" id="form1"
		action="index.php?act=bill&op=bill_pay&ob_no=<?php echo $_GET['ob_no'];?>">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input readonly id="pay_date" class=""
						name="pay_date" value="" type="text" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="pay_content" rows="6"
							class="tarea" id="pay_content"></textarea></td>
