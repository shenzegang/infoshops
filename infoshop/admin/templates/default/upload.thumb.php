...
<div class="page">
	...
	<form method="post" enctype="multipart/form-data"
		onsubmit="MySubmit();return false;" name="form1">
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><img
							...
							<div class="type-file-preview">
								<img
									src="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_COMMON.'/'.$output['list_setting']['default_goods_image']);?>">
							</div> </span><span class="type-file-box"> <input
							class="type-file-file" id="default_goods_image"
							name="default_goods_image" type="file" size="30" hidefocus="true"
							nc_type="change_default_goods_image"
							title="<?php echo $lang['default_product_pic'];?>">
					</span></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><img
							...
							<div class="type-file-preview">
								<img
									src="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_COMMON.'/'.$output['list_setting']['default_store_logo']);?>">
							</div> </span><span class="type-file-box"> <input
							class="type-file-file" id="default_store_logo"
							name="default_store_logo" type="file" size="30" hidefocus="true"
							nc_type="change_default_store_logo"
							title="<?php echo $lang['default_store_logo'];?>">
					</span></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><img
							...
							<div class="type-file-preview">
								<img
									src="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_COMMON.'/'.$output['list_setting']['default_user_portrait']);?>">
							</div> </span><span class="type-file-box"> <input
							class="type-file-file" id="default_user_portrait"
							name="default_user_portrait" type="file" size="30"
							hidefocus="true" nc_type="change_default_user_portrait"
							title="<?php echo $lang['default_user_pic'];?>">
					</span></td>
