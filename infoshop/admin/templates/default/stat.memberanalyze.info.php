<div style="text-align: right;">
	<input type="hidden"
		id="export_type_<?php echo $output['stat_field'];?>"
		name="export_type"
		data-param='{"url":"index.php?act=stat_member&op=analyzeinfo&type=<?php echo $output['stat_field'];?>&t=<?php echo $_GET['t'];?>&exporttype=excel"}'
		value="excel" /> <a class="btns" href="javascript:void(0);"
		nc_type="export_btn"
		data-param='{"type":"<?php echo $output['stat_field'];?>"}'><span>导出Excel</span></a>
</div>
