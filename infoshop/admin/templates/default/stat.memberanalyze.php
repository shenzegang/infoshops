...
<div class="page">
	...
	<form method="get" action="index.php" name="formSearch" id="formSearch">
		<input type="hidden" name="act" value="stat_member" /> <input
			type="hidden" name="op" value="analyze" /> <input type="hidden"
			name="" value="" />
	...
	<div id="stat_tabs" class="w100pre close_float ui-tabs"
		...
		<div id="ordernum_div" class="close_float">
			...
			<div id="list_ordernum" class="close_float"
		...
		<div id="goodsnum_div">
			...
			<div id="list_goodsnum" class="close_float"
				style="padding-top: 10px;"></div>
		</div>
		...
		<div id="orderamount_div">
			...
			<div id="list_orderamount" class="close_float"
				style="padding-top: 10px;"></div>
		</div>
	</div>
</div>
