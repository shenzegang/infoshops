...
<div class="page">
	...
	<form method='post' id="list_form"
		...
		<input type="hidden" id="inform_type_id" name="inform_type_id"
			value="" />
        ...
        <tr class="hover">
					<td class="w24"><input type="checkbox"
						...
						value="<?php echo $v['inform_type_id'];?>" class="checkitem"></td>
					<td><?php echo $v['inform_type_name'];?></td>
					<td><?php echo $v['inform_type_desc'];?></td>
					<td class="w72 align-center"><a href="JavaScript:void(0);"
						onclick="submit_delete('<?php echo $v['inform_type_id'];?>')"><?php echo $lang['nc_del'];?></a></td>
          <?php } ?>
          <?php }else { ?>
