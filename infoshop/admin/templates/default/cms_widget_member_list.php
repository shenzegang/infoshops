        ...
        <li>
			<dl class="member-info">
				<dt class="member-name">
					<a
						href="<?php echo SHOP_SITE_URL.DS;?>index.php?act=member_snshome&mid=<?php echo $value['member_id'];?>"
						target="_blank">
				...
				<dd nctype="btn_member_select" class="handle-button"
					title="<?php echo $lang['cms_text_add'];?>"></dd>
			</dl>
		</li>
        <?php } ?>
    </ul>
