...
<table class="table tb-type2 order mtw">
    ...
    <tr>
		...
		<tr>
			<td><a href="JavaScript:void(0);" id="btn_refresh" class="btn"><span><?php echo $lang['talk_refresh'];?></span></a><a
				href="JavaScript:void(0);" id="btn_publish" class="btn"><span><?php echo $lang['talk_send'];?></span></a></td>
		</tr>
    <?php } ?>
  </tbody>
</table>
