...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a
					href="index.php?act=adv&op=adv&ap_id=<?php echo $output['adv_list'][0]['ap_id'];?>"><span><?php echo $lang['adv_manage'];?></span></a></li>
	...
	<form id="adv_form" enctype="multipart/form-data" method="post"
		...
		<input type="hidden" name="ref_url"
			value="<?php echo $output['ref_url'];?>" /> <input type="hidden"
			name="form_submit" value="ok" />
		<table class="table tb-type2">
			<tbody>
        <?php foreach($output['adv_list'] as $k => $v){ ?>
        <tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="adv_name"><?php echo $lang['adv_name'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_name"
						id="adv_name" class="txt" value="<?php echo $v['adv_title']; ?>"></td>
        ...
        <tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_start_date"
						id="adv_start_date" class="txt date"
						value="<?php echo date('Y-m-d',$v['adv_start_date']); ?>"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_end_date"
						id="adv_end_date" class="txt date"
						value="<?php echo date('Y-m-d',$v['adv_end_date']); ?>"></td>
					<td class="vatop tips"></td>
				</tr>
        ...
        <tr id="adv_pic">
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><img
							...
							<div class="type-file-preview">
								<img src="<?php echo UPLOAD_SITE_URL."/".ATTACH_ADV."/".$pic;?>"
									onload="javascript:DrawImage(this,500,500);">
							</div> </span><span class="type-file-box"> <input type="file"
							class="type-file-file" id="file_adv_pic" name="adv_pic" size="30" />
					</span> <input type="hidden" name="pic_ori"
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="adv_pic_url"
						name="adv_pic_url" value="<?php echo $url; ?>" class="txt"></td>
        ...
        <tr id="adv_word">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_word"
						id="adv_word" class="txt" value="<?php echo $word; ?>"></td>
					<td class="vatop tips"><?php echo $lang['adv_max'];?><?php echo $ap_v['ap_width'];?><?php echo $lang['adv_byte'];?>
            <input type="hidden" name="adv_word_len"
						value="<?php echo $ap_v['ap_width'];?>"></td>
				</tr>
				<tr id="adv_word_url">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_word_url"
						class="txt" id="adv_word_url" value="<?php echo $url; ?>"></td>
        ...
        <tr id="adv_flash_swf">
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-box"> <input
							type="file" name="flash_swf" class="type-file-file"
							id="file_flash_swf" size="30" />
					</span></td>
					...
					<td><a href="http://<?php echo $url; ?>" target='_blank'>
							<button style="width:<?php echo $ap_v['ap_width']; ?>px; height:<?php echo $ap_v['ap_height']; ?>px; border:none; padding:0; background:none;" disabled >
								<object id="FlashID"
									...
									width="<?php echo $ap_v['ap_width']; ?>"
									height="<?php echo $ap_v['ap_height']; ?>">
									<param name="movie"
										value="<?php echo UPLOAD_SITE_URL."/".ATTACH_ADV."/".$flash;?>" />
									<param name="quality" value="high" />
									<param name="wmode" value="opaque" />
									<param name="swfversion" value="9.0.45.0" />
									<!-- 此 param 标签提示使用 Flash Player 6.0 r65 和更高版本的用户下载最新版本的 Flash Player。如果您不想让用户看到该提示，请将其删除。 -->
									<param name="expressinstall"
										value="<?php echo RESOURCE_SITE_URL;?>/js/expressInstall.swf" />
									<!-- 下一个对象标签用于非 IE 浏览器。所以使用 IECC 将其从 IE 隐藏。 -->
									<object type="application/x-shockwave-flash"
										data="<?php echo UPLOAD_SITE_URL."/".ATTACH_ADV."/".$flash;?>"
										width="<?php echo $ap_v['ap_width']; ?>"
										height="<?php echo $ap_v['ap_height']; ?>">
										<param name="quality" value="high" />
										<param name="wmode" value="opaque" />
							...
							</button> <input type="hidden" name="flash_ori"
							value="<?php echo $flash;?>">
...
//--></script></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="flash_url"
						id="flash_url" class="txt" value="<?php echo $url; ?>"></td>
					<td class="vatop tips"><?php echo $lang['adv_url_donotadd'];?></td>
				</tr>
        <?php }?>
        <?php }?>
			...
			<tfoot>
				<tr class="tfoot">
					<td colspan="15"><a href="JavaScript:void(0);" class="btn"
						onclick="document.advForm.submit()"><span><?php echo $lang['nc_submit'];?></span></a></td>
				</tr>
			</tfoot>
		</table>
	</form>
...
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/swfobject_modified.js"
	charset="utf-8"></script>
<script type="text/javascript">
$(function(){
