...
<div class="page">
	...
	<form id="handle_form" method="post"
		action="index.php?act=inform&op=inform_handle" name="form1">
		<input id="inform_id" name="inform_id" type="hidden"
			value="<?php echo $output['inform_id'];?>" />
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea"
							name="inform_handle_message" rows="6" id="inform_handle_message"></textarea></td>
					<td class="vatop tips"></td>
				</tr>
			...
			<tfoot>
				<tr class="tfoot">
					<td colspan="2"><a href="JavaScript:void(0);" class="btn"
						id="btn_handle_submit"><span><?php echo $lang['nc_submit'];?></span></a></td>
				</tr>
			</tfoot>
		</table>
	</form>
