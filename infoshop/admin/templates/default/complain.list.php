...
<div class="page">
	...
	<form id="search_form" method="get" name="formSearch">
		<input type="hidden" id="act" name="act" value="complain" /> <input
			type="hidden" id="op" name="op" value="<?php echo $output['op'];?>" />
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><label for="input_complain_accuser"><?php echo $lang['complain_accuser'];?></label></th>
					<td><input class="txt" type="text" name="input_complain_accuser"
						id="input_complain_accuser"
						value="<?php echo $_GET['input_complain_accuser'];?>"></td>
					<th><label for="input_complain_subject_content"><?php echo $lang['complain_subject_content'];?></label></th>
					<td colspan="2"><input class="txt2" type="text"
						name="input_complain_subject_content"
						id="input_complain_subject_content"
						value="<?php echo $_GET['input_complain_subject_content'];?>"></td>
				</tr>
				<tr>
					<th><label for="input_complain_accused"><?php echo $lang['complain_accused'];?></label></th>
					<td><input class="txt" type="text" name="input_complain_accused"
						id="input_complain_accused"
						value="<?php echo $_GET['input_complain_accused'];?>"></td>
					<th><label for="time_from"><?php echo $lang['complain_datetime'];?></label></th>
					<td><input id="time_from" class="txt date" type="text"
						name="input_complain_datetime_start"
						value="<?php echo $_GET['input_complain_datetime_start'];?>"> <label
						for="time_to">~</label> <input id="time_to" class="txt date"
						type="text" name="input_complain_datetime_end"
						value="<?php echo $_GET['input_complain_datetime_end'];?>"></td>
            ...
            <a class="btns "
						href="index.php?act=complain&op=<?php echo $output['op'];?>"
	...
	<form method='post' id="list_form"
        ...
        <tr class="hover">
					...
					<td class="align-center"><a
						href="index.php?act=complain&op=complain_progress&complain_id=<?php echo $v['complain_id'];?>"><?php echo $lang['complain_text_detail'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
