...
<div class="page">
	...
	<form method="post" enctype="multipart/form-data" name="form1">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="charset" value="gbk" />
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-box"> <input
							type="file" name="csv" id="csv" class="type-file-file" size="30" />
					</span></td>
				...
				<tr>
					<td colspan="2" class="required"><label><?php echo $lang['goods_class_import_file_type'];?>:</label>
						<a href="<?php echo RESOURCE_SITE_URL;?>/examples/goods_class.csv"
						class="btns"><span><?php echo $lang['goods_class_import_example_tip'];?></span></a></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><table border="1" cellpadding="3"
							cellspacing="3" bordercolor="#CCC">
							<tbody>
								<tr>
			...
			<tfoot>
				<tr class="tfoot">
					<td colspan="2"><a href="JavaScript:document.form1.submit();"
						class="btn"><span><?php echo $lang['goods_class_import_import'];?></span></a></td>
				</tr>
			</tfoot>
		</table>
	</form>
