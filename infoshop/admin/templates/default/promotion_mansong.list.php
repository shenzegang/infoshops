...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" name="act" value="promotion_mansong"> <input
			type="hidden" name="op" value="mansong_list">
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><label for="mansong_name"><?php echo $lang['mansong_name'];?></label></th>
					<td><input type="text" value="<?php echo $_GET['mansong_name'];?>"
						name="mansong_name" id="mansong_name" class="txt"
	...
	<form id="list_form" method="post">
        ...
        <tr class="hover">
					...
					<td class="align-left"><a
						href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_store&store_id=<?php echo $val['store_id'];?>"
					...
					<td class="nowrap align-center">
						<!-- 详细按钮 --> <a
						href="index.php?act=promotion_mansong&op=mansong_detail&mansong_id=<?php echo $val['mansong_id'];?>"><?php echo $lang['nc_detail'];?></a>
                <?php if($val['editable']) { ?>
                <a nctype="btn_cancel"
						data-mansong-id="<?php echo $val['mansong_id'];?>"
						href="javascript:;"><?php echo $lang['nc_cancel'];?></a>
                <?php } ?>
                <a nctype="btn_del"
						data-mansong-id="<?php echo $val['mansong_id'];?>"
						href="javascript:;"><?php echo $lang['nc_del'];?></a>
					</td>
				</tr>
        <?php } ?>
        <?php }else { ?>
