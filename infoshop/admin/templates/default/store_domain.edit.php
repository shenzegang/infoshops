			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['store_array']['store_domain'];?>"
						id="store_domain" name="store_domain" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['store_array']['store_domain_times'];?>"
						id="store_domain_times" name="store_domain_times" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tfoot>
