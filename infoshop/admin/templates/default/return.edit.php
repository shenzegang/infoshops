...
<div class="page">
	...
	<form id="post_form" method="post"
		action="index.php?act=return&op=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea id="admin_message"
							name="admin_message" class="tarea"></textarea></td>
					<td class="vatop tips"></td>
				</tr>
