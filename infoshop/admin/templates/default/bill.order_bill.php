...
<div class="page">
	<div class="fixed-bar">
      ...
      <?php //echo $output['top_link'];?>
		<ul class="tab-base">
				<li><a class="current" href="JavaScript:void(0);"> <span>结算管理</span>
				</a></li>
			</ul>
		</div>
	</div>
	...
	<form method="get" action="index.php" target="" name="formSearch"
		...
		<table class="tb-type1 noborder search">
			...
			<option value="<?php echo $v;?>"
								<?php if($_GET['query_month'] == $v){?> selected <?php }?>><?php echo $v;?></option>
			<?php }?>
			</select></td>
      ...
      <tr class="hover">
        ...
        <?php echo str_replace(array('0','1','2','3','4'),array('未出账','已出账','店铺已确认','平台已审核','结算完成'),$order['ob_state']);?>
				...
				<td class="align-center"><a
					href="index.php?act=bill&op=show_store_month_order&bill_id=<?php echo $order['ob_no'];?>"><?php echo $lang['nc_view'];?></a>
				</td>
			</tr>
      <?php }?>
      <?php }else{?>
