...
<div style="border: 1px #D9D9D9 solid; padding: 10px; width: 98%;">
	<div style="text-align: right;">
		<input class="txt" type="text"
			value="<?php echo $output['search_arr']['gname'];?>" id="gname"
			name="gname"> <a
			href="index.php?act=stat_marketing&op=grouplist&t=<?php echo $output['searchtime'];?>"
			id="glistsearchbtn" class="btn-search tooltip"
			...
			<tr nc_type="ginfo" class="hover ginfo" style="display: none;">
				<td colspan="3">
					<div class="size-106x106 left img">
						<span class="thumb size-106x106"><i></i><a target="_blank"
							href="<?php echo SHOP_SITE_URL."/index.php?act=show_groupbuy&op=groupbuy_detail&group_id=".$v['groupbuy_id'];?>"><img
								src="<?php echo gthumb($v['groupbuy_image'], 'small');?>"
								style="max-width: 106px; max-height: 106px;" /></a></span>
					</div>
					<div class="left">
						...
						<div class="close_float">
							...
							<span class="infoitem left" style="width: 200px;">总金额：<em
								class="red_common"><?php echo ncPriceFormat($v['buy_quantity']*$v['groupbuy_price']).$lang['currency_zh'];?></em></span>
							<span class="infoitem left" style="width: 300px;">下单转化率：<em
								class="red_common"><?php echo $v['views']>0?round($v['buyer_count']/$v['views']*100,2):0;?>%</em></span>
						</div>
					</div>
				</td>
			</tr>
