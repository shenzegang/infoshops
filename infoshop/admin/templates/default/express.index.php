...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				<li><a class="current"><span><?php echo $lang['express_name'];?></span></a></li>
			</ul>
		</div>
	</div>
	...
	<table class="table tb-type2">
        ...
        <tr class="hover">
            ...
            <a href="JavaScript:void(0);" class=" enabled"
					ajax_branch='order' nc_type="inline_edit" fieldname="e_order"
					fieldid="<?php echo $v['id']?>" fieldvalue="1"
					title="<?php echo $lang['nc_editable'];?>"><img
						src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php }else{ ?>
            <a href="JavaScript:void(0);" class=" disabled"
					ajax_branch='order' nc_type="inline_edit" fieldname="e_order"
					fieldid="<?php echo $v['id']?>" fieldvalue="0"
					title="<?php echo $lang['nc_editable'];?>"><img
						src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php } ?></td>
				<td class="align-center yes-onoff"><?php if($v['e_state'] == '0'){ ?>
            <a href="JavaScript:void(0);" class=" disabled"
					ajax_branch='state' nc_type="inline_edit" fieldname="e_state"
					fieldid="<?php echo $v['id']?>" fieldvalue="0"
					title="<?php echo $lang['nc_editable'];?>"><img
						src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php }else{ ?>
