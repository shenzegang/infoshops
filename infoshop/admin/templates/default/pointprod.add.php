	...
	<form id="pointprod_form" method="post" enctype="multipart/form-data">
		...
		<table class="table tb-type2">
			...
			<tbody>
				<tr>
					<th class="required"
						style="line-height: normal; border-top: 1px dotted #CBE9F3;"><label
						for=""><?php echo $lang['admin_pointprod_goods_image'];?>:</label></th>
					<td colspan="2" class="required"><label class="validation"
						for="goodsname"><?php echo $lang['admin_pointprod_goods_name']; ?>:</label></td>
				</tr>
				<tr class="noborder">
					<th rowspan="6" class="picture"><div class="size-200x200">
							<span class="thumb size-200x200"><i></i><img
								src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.C('default_goods_image'); ?>"
								onload="javascript:DrawImage(this,200,200);"
								nc_type="goods_image" /></span>
						</div></th>
					<td class="vatop rowform"><input type="text" name="goodsname"
						id="goodsname" class="txt" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="goodsprice"><?php echo $lang['admin_pointprod_goods_price']; ?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="goodsprice"
						id="goodsprice" class="txt" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="goodspoints"><?php echo $lang['admin_pointprod_goods_points']; ?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="goodspoints"
						id="goodspoints" class="txt" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="goodsserial"><?php echo $lang['admin_pointprod_goods_serial']; ?>:</label></td>
				</tr>
				<tr class="noborder">
					<th style="line-height: normal;"><span class="type-file-box"> <input
							name="goods_images" type="file" class="type-file-file"
							id="goods_images" size="30" hidefocus="true"
							nc_type="change_goods_image">
					</span></th>
					<td class="vatop rowform"><input type="text" name="goodsserial"
						id="goodsserial" class="txt" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<th class="required"
						style="line-height: normal; border-top: 1px dotted #CBE9F3;"><label
						for="goodstag"><?php echo $lang['admin_pointprod_goods_tag']; ?>:</label></th>
					<td colspan="2" class="required"><label class="validation"
						for="goodsstorage"><?php echo $lang['admin_pointprod_goods_storage']; ?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="goodstag"
						id="goodstag" class="txt" /></td>
					<td class="vatop rowform"><input type="text" name="goodsstorage"
						id="goodsstorage" class="txt" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="space">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="radio" name="islimit"
						id="islimit_1" value="1" onclick="showlimit();" />
            &nbsp;<?php echo $lang['admin_pointprod_limit_yes']; ?>&nbsp;
            <input type="radio" name="islimit" id="islimit_0" value="0"
						checked="checked" onclick="showlimit();" />
			...
			<tbody id="limitnum_div">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="limitnum"
						id="limitnum" class="txt" value="1" /></td>
					<td colspan="2" class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="radio" name="islimittime"
						id="islimittime_1" value="1" onclick="showlimittime();" />
            &nbsp;<?php echo $lang['admin_pointprod_limittime_yes']; ?>&nbsp;
            <input type="radio" name="islimittime" id="islimittime_0"
						value="0" checked="checked" onclick="showlimittime();" />
			...
			<tbody name="limittime_div">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="starttime"
						id="starttime" class="txt date" style="width: 100px;"
						value="<?php echo @date('Y-m-d',time()); ?>" /><?php echo $lang['admin_pointprod_time_day']; ?>
            <select id="starthour" name="starthour"
						style="margin-left: 8px; _margin-left: 4px; width: 50px;">
              <?php foreach ($output['hourarr'] as $item){ ?>
              <option value="<?php echo $item; ?>"><?php echo $item; ?></option>
              <?php }?>
            </select>
            <?php echo $lang['admin_pointprod_time_hour']; ?></td>
					<td class="vatop rowform"><input type="text" name="endtime"
						id="endtime" class="txt date" style="width: 100px;"
          ...
          <?php echo $lang['admin_pointprod_time_hour']; ?></td>
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="showstate_1"
						class="cb-enable selected"><span><?php echo $lang['admin_pointprod_yes']; ?></span></label>
						<label for="showstate_0" class="cb-disable"><span><?php echo $lang['admin_pointprod_no']; ?></span></label>
						<input id="showstate_1" name="showstate" checked="checked"
						value="1" type="radio"> <input id="showstate_0" name="showstate"
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="commendstate_1"
						class="cb-enable"><span><?php echo $lang['admin_pointprod_yes']; ?></span></label>
						<label for="commendstate_0" class="cb-disable  selected"><span><?php echo $lang['admin_pointprod_no']; ?></span></label>
						<input id="commendstate_1" name="commendstate" value="1"
						type="radio"> <input id="commendstate_0" name="commendstate"
						checked="checked" value="0" type="radio"></td>
					<td colspan="2" class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody id="forbidreason_div">
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="forbidreason"
							id="forbidreason" rows="6" class="tarea"></textarea></td>
					<td colspan="2" class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="keywords"
						id="keywords" class="txt" /></td>
					<td colspan="2" class="vatop tips"></td>
				</tr>
				<tr>
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="sort" id="sort"
						class="txt" value="0" /></td>
              ...
              <li id="<?php echo $v['upload_id'];?>" class="picture"><input
								...
								<p>
									<span><a
										href="javascript:insert_editor('<?php echo $v['upload_path'];?>');"><?php echo $lang['admin_pointprod_uploadimg_add'];?></a></span><span><a
										href="javascript:del_file_upload('<?php echo $v['upload_id'];?>');"><?php echo $lang['nc_del'];?></a></span>
								</p></li>
              <?php } ?>
              <?php } ?>
            </ul></td>
			...
			<tfoot>
				<tr class="tfoot">
					<td colspan="3"><a href="JavaScript:void(0);" class="btn"
