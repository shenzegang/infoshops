...
<div class="page">
	...
	<form id="doc_form" method="post">
		<input type="hidden" name="form_submit" value="ok" /> <input
			...
			value="<?php echo $output['doc']['doc_id'];?>" />
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['doc']['doc_title'];?>" name="doc_title"
						id="doc_title" class="infoTableInput"></td>
				...
				<tr>
                  ...
                  <tr id="<?php echo $v['upload_id'];?>" class="tatr2">
										...
										<td><img width="40px" height="40px"
											src="<?php echo $v['upload_path'];?>" /></td>
										<td><?php echo $v['file_name'];?></td>
										<td><a
											href="javascript:insert_editor('<?php echo $v['upload_path'];?>');"><?php echo $lang['document_index_insert'];?></a>
											| <a
											href="javascript:del_file_upload('<?php echo $v['upload_id'];?>');"><?php echo $lang['nc_del'];?></a></td>
									</tr>
                  <?php } ?>
                  <?php } ?>
                </tbody>
