	...
	<form id="list_form" method="post">
        ...
        <tr class="hover">
					...
					<td class="align-left"><a
						href="<?php echo urlShop('show_store','index', array('store_id'=>$val['quota_storeid']));?>"
						target="_blank"><span><?php echo $val['quota_storename'];?></span></a></td>
