...
<div class="page">
	...
	<form method='post' id="list_form"
		action="index.php?act=voucher&op=pricedrop">
		<input type="hidden" id="voucher_price_id" name="voucher_price_id"
			value="" />
        ...
        <tr class="hover">
					<td><input type="checkbox" name='voucher_price_checkbox'
						value="<?php echo $v['voucher_price_id'];?>" class="checkitem"></td>
					...
					<td class="w96 align-center"><a
						href="index.php?act=voucher&op=priceedit&priceid=<?php echo $v['voucher_price_id'];?>"><?php echo $lang['nc_edit'];?></a>
						<a href="JavaScript:void(0);"
						onclick="submit_delete('<?php echo $v['voucher_price_id'];?>')"><?php echo $lang['nc_del'];?></a>
					</td>
          <?php } ?>
          <?php }else { ?>
