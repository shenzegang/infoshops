...
<div class="page">
	<table class="table tb-type2 order">
		<tbody>
			...
			<tr>
				<td><ul>
						...
						<li><strong><?php echo $lang['admin_pointorder_exchangepoints'];?>:</strong><span
							class="red_common"><?php echo $output['order_info']['point_allpoint'];?></span></li>
            ...
            <?php } ?>
            <li><strong><?php echo $lang['admin_pointorder_addtime'];?>:</strong><span
							class="red_common"><?php echo @date('Y-m-d H:i:s',$output['order_info']['point_addtime']);?></span></li>
					</ul></td>
			</tr>
			<tr class="space">
      ...
      <tr>
              ...
              <tr>
								<td class="w60 picture"><div class="size-56x56">
										<span class="thumb size-56x56"><i></i><a
											...
											target="_blank" class="order_info_pic"> <img
								...
								<td class="w50pre"><a
									href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['point_goodsid']));?>"
									target="_blank"><?php echo $v['point_goodsname'];?></a></td>
		...
		<tfoot>
			<tr class="tfoot">
				<td><a href="index.php?act=pointorder&op=pointorder_list"
					class="btn"><span><?php echo $lang['admin_pointorder_gobacklist'];?></span></a></td>
			</tr>
		</tfoot>
	</table>
</div>
