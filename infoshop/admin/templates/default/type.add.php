	...
	<form id="type_form" method="post">
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform" id="gcategory"><input type="hidden"
						value="" class="mls_id" name="class_id" /> <input type="hidden"
						value="" class="mls_name" name="class_name" /> <select
						class="class-select">
              ...
              <?php } ?>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="txt"
						name="t_sort" id="t_sort" value="0" /></td>
		...
		<div
			...
			<div style="position: relative; max-height: 240px; overflow: hidden;"
				id="spec_div" class="scrollbar-box">
		...
		<div
			...
			<div style="position: relative; max-height: 240px; overflow: hidden;"
				id="brand_div" class="scrollbar-box">
          ...
          <tbody>
            ...
            <tr class="hover">
                  ...
                  <li class="left w33pre h36"><input type="checkbox"
										name="brand_id[]" value="<?php echo $bval['brand_id']?>"
		...
		<table class="table tb-type2 mtw">
			...
			<tbody id="tr_model">
				<tr></tr>
				<tr class="hover edit">
					<td class="w48 sort"><input type="text" name="at_value[key][sort]"
						value="0" /></td>
					<td class="w25pre name"><input type="text"
						name="at_value[key][name]" value="" /></td>
					<td class="w50pre name"><textarea rows="10" cols="80"
							name="at_value[key][value]"></textarea></td>
					<td class="align-center power-onoff"><input type="checkbox"
						checked="checked" nc_type="checked_show" /> <input type="hidden"
						name="at_value[key][show]" value="1" /></td>
					<td class="align-center w60"><a onclick="remove_tr($(this));"
						href="JavaScript:void(0);"><?php echo $lang['type_add_remove'];?></a></td>
				</tr>
			</tbody>
			<tbody>
				<tr>
