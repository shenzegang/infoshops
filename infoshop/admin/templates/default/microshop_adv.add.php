...
<div class="page">
	...
	<form id="add_form" method="post" enctype="multipart/form-data"
		action="index.php?act=microshop&op=adv_save">
		<input name="adv_id" type="hidden"
			value="<?php echo $output['adv_info']['adv_id'];?>" />
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><select name="adv_type">
                            <?php if(!empty($output['adv_type_list']) && is_array($output['adv_type_list'])) {?>
                            <?php foreach($output['adv_type_list'] as $key=>$value) {?>
                            <option value="<?php echo $key;?>"
								<?php if($key==$output['adv_info']['adv_type']) {echo 'selected';}?>><?php echo $value;?></option>
                            <?php } ?>
                            <?php } ?>
                        </select></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php if(isset($output['adv_info']['adv_name'])) echo $output['adv_info']['adv_name'];?>"
						name="adv_name" id="adv_name" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="adv_image"><?php echo $lang['microshop_adv_image'];?><?php echo $lang['nc_colon'];?></label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show">
							...
							<div class="type-file-preview">
								<img
									src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MICROSHOP.DS.'adv'.DS.$output['adv_info']['adv_image'];?>">
							</div>
                            <?php } ?>
                        </span> <span class="type-file-box"> <input
							name="old_adv_image" type="hidden"
							value="<?php echo $output['adv_info']['adv_image'];?>" /> <input
							name="adv_image" type="file" class="type-file-file"
							id="adv_image" size="30" hidefocus="true"
							nc_type="microshop_goods_adv_image">
					</span></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php if(isset($output['adv_info']['adv_url'])) echo $output['adv_info']['adv_url'];?>"
						name="adv_url" id="adv_url" class="txt"></td>
					<td class="vatop tips"><?php echo $lang['microshop_adv_url_explain'];?></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label for="adv_sort"
						class="validation"><?php echo $lang['nc_sort'].$lang['nc_colon'];?></label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input id="adv_sort" name="adv_sort"
						type="text" class="txt"
						value="<?php echo !isset($output['adv_info'])?'255':$output['adv_info']['adv_sort'];?>" />
					</td>
