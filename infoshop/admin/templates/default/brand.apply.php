	...
	<form method='post' id="form_brand">
        ...
        <tr class="hover edit">
					<td class="w24"><input type="checkbox" class="checkitem"
						name="del_id[]" value="<?php echo $v['brand_id'];?>"></td>
					<td class="name w270"><span><?php echo $v['brand_name']?></span></td>
					<td class="class"><?php echo $v['brand_class']?></td>
					<td><div class="brand-picture">
							<img src="<?php echo brandImage($v['brand_pic']);?>" />
						</div></td>
					<td class="w96 align-center"><a
						href="index.php?act=brand&op=brand_apply_set&state=pass&brand_id=<?php echo $v['brand_id']?>"><?php echo $lang['nc_pass'];?></a>
						| <a
						href="index.php?act=brand&op=brand_apply_set&state=refuse&brand_id=<?php echo $v['brand_id']?>"><?php echo $lang['nc_del'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
        ...
        <tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						onclick="submit_form('pass');" name="id"><span><?php echo $lang['nc_pass'];?></span></a><a
						href="JavaScript:void(0);" class="btn"
						onclick="submit_form('refuse');" name="id"><span><?php echo $lang['nc_refuse'];?></span></a>
