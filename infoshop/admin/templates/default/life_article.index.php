...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" value="life_article" name="act"> <input
			type="hidden" value="article" name="op">
		<table class="tb-type1 noborder search">
			<tbody>
              ...
              <option
								<?php if($output['search_ac_id'] == $v['ac_id']){ ?>
            ...
            <a href="index.php?act=life_article&op=article"
						class="btns " title="撤销检索"><span>撤销检索</span></a>
            <?php }?></td>
				</tr>
			</tbody>
		</table>
	...
	<form method="post" id="form_article">
        ...
        <tr class="hover">
					<td><input type="checkbox" name='del_id[]'
						value="<?php echo $v['article_id']; ?>" class="checkitem"></td>
					...
					<td class="align-center yes-onoff"><a href="JavaScript:void(0);"
						class="<?php echo empty($v['article_show']) ? ' disabled' : ' enabled'; ?>"
						ajax_branch="article_show" nc_type="inline_edit"
						fieldname="article_show" fieldid="<?php echo $v['article_id']?>"
						fieldvalue="<?php echo $v['article_show']?>"
						title="<?php echo $lang['nc_editable'];?>"><img
							src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
					</td>
					<td class="align-center yes-onoff"><a href="JavaScript:void(0);"
						class="<?php echo empty($v['is_head']) ? ' disabled' : ' enabled'; ?>"
						ajax_branch="is_head" nc_type="inline_edit" fieldname="is_head"
						fieldid="<?php echo $v['article_id']?>"
						fieldvalue="<?php echo $v['is_head']?>"
						title="<?php echo $lang['nc_editable'];?>"><img
							src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
					</td>
					<td class="align-center yes-onoff"><a href="JavaScript:void(0);"
					...
					<td class="align-center"><a
						href="index.php?act=life_article&op=article_edit&article_id=<?php echo $v['article_id']; ?>">编辑</a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
