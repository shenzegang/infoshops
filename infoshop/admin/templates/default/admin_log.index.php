...
<div class="page">
	...
	<form method="get" name="formSearch" id="formSearch">
		<input type="hidden" name="act" value="admin_log"> <input
			type="hidden" name="op" value="list"> <input type="hidden"
			name="delago" id="delago" value="">
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><?php echo $lang['admin_log_man'];?></th>
					<td><input class="txt" name="admin_name"
						value="<?php echo $_GET['admin_name'];?>" type="text"></td>
					<th><?php echo $lang['admin_log_dotime'];?></th>
					<td><input class="txt date" type="text"
						value="<?php echo $_GET['time_from'];?>" id="time_from"
						name="time_from"> <label for="time_to">~</label> <input
						class="txt date" type="text"
						value="<?php echo $_GET['time_to'];?>" id="time_to" name="time_to" /></td>
	...
	<form method="post" id='form_list'
		action="index.php?act=admin_log&op=list_del">
        ...
        <tr class="hover">
					<td class="w24"><input name="del_id[]" type="checkbox"
        ...
        <tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#form_list').submit();}"><span><?php echo $lang['nc_del'];?></span></a>
