...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" value="article" name="act"> <input type="hidden"
			value="article" name="op">
		<table class="tb-type1 noborder search">
            ...
            <a href="index.php?act=article&op=article" class="btns "
	...
	<form method="post" id="form_article">
        ...
        <tr class="hover">
					...
					<td class="align-center"><a
						href="index.php?act=article&op=article_edit&article_id=<?php echo $v['article_id']; ?>"><?php echo $lang['nc_edit'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
        ...
        <tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#form_article').submit();}"><span><?php echo $lang['nc_del'];?></span></a>
