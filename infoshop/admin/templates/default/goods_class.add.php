		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						name="gc_name" id="gc_name" maxlength="20" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-box"><input
							...
							name="pic" type="file" class="type-file-file" id="pic" size="30"
				...
				<tr class="noborder">
					<td class="vatop rowform"><select name="gc_parent_id"
						id="gc_parent_id">
							<option value="0"><?php echo $lang['nc_please_choose'];?>...</option>
              <?php if(!empty($output['parent_list']) && is_array($output['parent_list'])){ ?>
              <?php foreach($output['parent_list'] as $k => $v){ ?>
              <option
								<?php if($output['gc_parent_id'] == $v['gc_id']){ ?>
								selected='selected' <?php } ?> value="<?php echo $v['gc_id'];?>"><?php echo $v['gc_name'];?></option>
              <?php } ?>
              <?php } ?>
            </select></td>
            ...
            <dd style="display: inline-block; margin-right: 10px;">
										<input type="radio" name="t_id"
											value="<?php echo $v['type_id']?>" /> <span><?php echo $v['type_name'];?></span>
									</dd>
            <?php }?>
            </dl>
            <?php }?>
