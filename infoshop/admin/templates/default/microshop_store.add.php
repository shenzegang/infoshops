...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" value="microshop" name="act"> <input
			type="hidden" value="store_add" name="op">
		...
		<table class="table tb-type2">
			...
			<tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td></td>
					<td><a
						href="<?php echo urlShop('show_store','index', array('store_id' => $value['store_id']));?>"
						target="_blank">
					...
					<td>
                        ...
                        <?php } else { ?>
                        <a href="###"
						onclick="submit_add(<?php echo $value['store_id'];?>)"><?php echo $lang['nc_add'];?></a>
                        <?php } ?>
                    </td>
				</tr>
                <?php } ?>
