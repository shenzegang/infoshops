...
<div class="page">
	...
	<form method='post' id="list_form" action="">
		<input type="hidden" id="complain_subject_id"
			name="complain_subject_id" value="" />
        ...
        <tr class="hover">
					<td><input type="checkbox" name='voucher_price_checkbox'
						value="<?php echo $v['complain_subject_id'];?>" class="checkitem"></td>
					...
					<td class="align-center"><a href="JavaScript:void(0);"
						onclick="submit_delete('<?php echo $v['complain_subject_id'];?>')"><?php echo $lang['nc_del'];?></a></td>
          <?php } ?>
          <?php }else { ?>
        ...
        <tr class="tfoot">
            ...
            <?php } ?></td>
					<td colspan="16"><label for="checkall_1"><?php echo $lang['nc_select_all']; ?></label>
						&nbsp;&nbsp;<a href="JavaScript:void(0);" id="btn_batch_drop"
						class="btn" onclick="submit_delete_batch()"><span><?php echo $lang['nc_del'];?></span></a>
