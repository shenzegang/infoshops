	...
	<form id="points_form" method="post" name="form1">
		...
		<table class="table tb-type2 nobdb">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="member_name"
						id="member_name" class="txt" onchange="javascript:checkmember();">
				...
				<tr class="noborder">
					<td class="vatop rowform"><select id="operatetype"
						name="operatetype">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="pointsnum"
						name="pointsnum" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="pointsdesc" rows="6"
