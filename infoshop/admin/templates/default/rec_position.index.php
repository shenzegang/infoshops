...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" value="rec_position" name="act"> <input
			type="hidden" value="rec_list" name="op">
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><?php echo $lang['rec_ps_type'];?></th>
					<td><select name='pic_type'><option value=""><?php echo $lang['nc_please_choose'];?></option>
							<option value="1"><?php echo $lang['rec_ps_pic'];?></option>
							<option value="0"><?php echo $lang['rec_ps_txt'];?></option></select></td>
	...
	<form method='post' id="form_rec">
        ...
        <tr class="hover edit">
					<td class="w24"><input type="checkbox" name="rec_id[]"
						value="<?php echo $v['rec_id'];?>" class="checkitem"></td>
          ...
          <?php if ($v['pic_type'] != 0){echo count($v['content']['body']) == 1 ? $lang['rec_ps_picdan'] : $lang['rec_ps_picduo'];}?>
                ...
                ?></td>
					...
					<td class="w180 align-center"><a
						href="index.php?act=rec_position&op=rec_edit&rec_id=<?php echo $v['rec_id'];?>"><?php echo $lang['nc_edit'];?></a>
						| <a
						onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){return true;}else{return false;}"
						href="index.php?act=rec_position&op=rec_del&rec_id=<?php echo $v['rec_id'];?>"><?php echo $lang['nc_del'];?></a>
						| <a nctype="jscode" rec_id="<?php echo $v['rec_id'];?>"
						href="javascript:void(0)"><?php echo $lang['rec_ps_code']?></a> |
						<a target="_blank"
						href="index.php?act=rec_position&op=rec_view&rec_id=<?php echo $v['rec_id'];?>"><?php echo $lang['rec_ps_view'];?></a>
					</td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        ...
        <tr class="tfoot" id="dataFuncs">
					...
					<td colspan="16" id="batchAction"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#form_rec').submit();}"><span><?php echo $lang['nc_del'];?></span></a>
