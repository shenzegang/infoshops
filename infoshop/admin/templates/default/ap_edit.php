...
<div class="page">
	...
	<form id="link_form" enctype="multipart/form-data" method="post"
      ...
      <input type="hidden" name="ap_class"
				value="<?php echo $v['ap_class']; ?>" />
			<tbody>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="ap_name"
						id="ap_name" class="txt" value="<?php echo $v['ap_name'];?>"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea"
							id="sg_description" name="ap_intro"><?php echo $v['ap_intro'];?></textarea></td>
					<td class="vatop tips"></td>
				</tr>
        <?php
        switch ($v['ap_class']) {
        ...
        <tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul>
							<li><input type="radio" id="is_use_1" name="is_use" value="1"
								<?php if($v['is_use'] == '1'){echo "checked";}?>> <label
								for="is_use_1"><?php echo $lang['ap_use_s'];?></label></li>
							<li><input type="radio" id="is_use_0" name="is_use" value="0"
								<?php if($v['is_use'] == '0'){echo "checked";}?>> <label
								for="is_use_0"><?php echo $lang['ap_not_use_s'];?></label></li>
						</ul></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
      ...
      <tfoot>
				<tr class="tfoot">
					<td colspan="15"><a href="JavaScript:void(0);" class="btn"
						id="submitBtn" onclick="document.form1.submit()"><span><?php echo $lang['adv_change'];?></span></a>
					</td>
				</tr>
			</tfoot>
		</table>
