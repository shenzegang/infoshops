...
<div class="page">
	...
	<form id="list_form" method='post'>
        ...
        <tr class="hover edit">
              ...
              <a
						href="<?php echo getCMSSpecialUrl($val['special_id']);?>"
						target="_blank"><?php echo $lang['cms_text_see'];?></a>
              <?php } else { ?>
              <a
						href="index.php?act=cms_special&op=cms_special_detail&special_id=<?php echo $val['special_id'];?>"
						target="_blank"><?php echo $lang['cms_text_view'];?></a>
              <?php } ?>
              <a
						href="index.php?act=cms_special&op=cms_special_edit&special_id=<?php echo $val['special_id'];?>"><?php echo $lang['nc_edit'];?></a>
						<a
