      ...
      <tr class="hover">
        	...
        	<?php if($v['isuse'] == '1'){ ?>
        		<a href="javascript:void(0)"
					onclick="if(confirm('<?php echo $lang['shareset_list_closeprompt'];?>')){location.href='index.php?act=sns_sharesetting&op=set&state=0&key=<?php echo $k;?>'}"> <?php echo $lang['nc_close'];?></a>
        	<?php }else { ?>
        		<a
					href="index.php?act=sns_sharesetting&op=set&state=1&key=<?php echo $k;?>"><?php echo $lang['nc_open'];?></a>
        	<?php } ?>
        	| <a
					href="index.php?act=sns_sharesetting&op=edit&state=1&key=<?php echo $k; ?>"><?php echo $lang['nc_edit']?></a>
				</td>
			</tr>
      <?php } } ?>
    </tbody>
