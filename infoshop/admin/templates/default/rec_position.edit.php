...
<div class="page">
	...
	<form id="rec_form" enctype="multipart/form-data" method="post"
		action="index.php?act=rec_position&op=rec_edit_save">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="rec_id"
			value="<?php echo $output['info']['rec_id'];?>" /> <input
			type="hidden" name="opic_type"
			value="<?php echo $output['info']['pic_type'];?>" />
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="rtitle"
						value="<?php echo $output['info']['title'];?>" id="rtitle"
						class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><select name="rec_type" id="rec_type">
							<option value="2"
								<?php if ($output['info']['pic_type'] !=0) echo 'selected';?>><?php echo $lang['rec_ps_pic'];?></option>
							<option value="1"
								<?php if ($output['info']['pic_type'] ==0) echo 'selected';?>><?php echo $lang['rec_ps_txt'];?></option>
					</select></td>
			...
			<tbody>
				<tr class="noborder" id="tr_pic_type" style="display: none">
					<td class="vatop rowform"><ul>
							<li><label> <input name="pic_type" id="pic_type_1" type="radio"
									value="1"
									<?php if ($output['info']['pic_type'] ==1 || $output['info']['pic_type'] ==0) echo 'checked="checked"';?>>
                  <?php echo $lang['rec_ps_local'];?></label></li>
							<li><label> <input type="radio" name="pic_type" id="pic_type_2"
									value="2"
									<?php if ($output['info']['pic_type'] ==2) echo 'checked="checked"';?>>
                  <?php echo $lang['rec_ps_remote'];?></label></li>
						</ul></td>
		...
		<table id="local_txt" class="table tb-type2" style="display: none">
			...
			<tbody id="RemoteBoxTxt">
				<tr>
					<td class="name w270"><input type="text" value="" name="txt[]"
						size="30" hidefocus="true"></td>
					<td class="name w270"><input type="text" value="http://"
						name="urltxt[]"></td>
					<td></td>
					<td class="w150 align-center"></td>
				</tr>
				<tr>
					<td colspan="4"><a id="addRemoteTxt" class="btn-add marginleft"
						href="javascript:void(0);"><span><?php echo $lang['rec_ps_addjx'];?></span></a></td>
				</tr>
			</tbody>
		</table>
		<table id="local_pic" class="table tb-type2" style="display: none">
			...
			<tbody id="UpFileBox">
				<tr>
					<td class="vatop rowform w300"><span class="type-file-box"> <input
							type="text" name="textfield" class="type-file-text" /> <input
							type="button" name="button" value="" class="type-file-button" />
							<input class="type-file-file" type="file" title=""
							nc_type="change_default_goods_image" hidefocus="true" size="30"
							name="pic[]">
					</span></td>
					<td class="name w270"><input type="text" value="http://"
						name="urlup[]"></td>
				...
				<tr>
					<td colspan="4"><a id="addUpFile" href="javascript:void(0);"
						class="btn-add marginleft"><span><?php echo $lang['rec_ps_addjx'];?></span></a></td>
				</tr>
			</tbody>
		</table>
		<table id="remote_pic" class="table tb-type2" style="display: none">
			...
			<tbody id="RemoteBox">
				<tr>
					<td class="name w300"><input type="text" value="http://"
						name="pic[]" size="30" hidefocus="true"></td>
					<td class="name w270"><input type="text" value="http://"
						name="urlremote[]"></td>
					<td></td>
					<td class="w150 align-center"></td>
				...
				<tr>
					<td colspan="4"><a id="addRemote" class="btn-add marginleft"
						href="javascript:void(0);"><span><?php echo $lang['rec_ps_addjx'];?></span></a></td>
				</tr>
			</tbody>
		</table>
		<table class="table tb-type2" id="rec_width">
            ...
            <input type="text" style="width: 30px" name="rwidth"
						value="<?php echo $output['info']['content']['width'];?>">
            px&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $lang['rec_ps_image_height'];?>:
            <input type="text"
						value="<?php echo $output['info']['content']['height'];?>"
						style="width: 30px" name="rheight"> px</td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul>
							<li><label> <input name="rtarget" type="radio" value="1"
									<?php if($output['info']['content']['target']==1) echo 'checked="checked"'?>>
                  <?php echo $lang['rec_ps_tg1'];?></label></li>
							<li><label> <input type="radio" name="rtarget" value="2"
									<?php if($output['info']['content']['target']==2) echo 'checked="checked"'?>>
                  <?php echo $lang['rec_ps_tg2'];?></label></li>
						</ul></td>
