...
<div class="page">
	<table class="table tb-type2 order">
		<tbody>
			...
			<tr>
				<td colspan="2"><ul>
						<li><strong><?php echo $lang['order_number'];?>:</strong><?php echo $output['order_info']['order_sn'];?>
            ( 支付单号 <?php echo $lang['nc_colon'];?> <?php echo $output['order_info']['pay_sn'];?> )
						...
						<li><strong><?php echo $lang['order_total_price'];?>:</strong><span
							class="red_common"><?php echo $lang['currency'].$output['order_info']['order_amount'];?> </span>
    ...
    <?php } ?>
			...
			<tr>
              ...
              <tr>
								...
								<td class="w50pre"><p><?php if(!empty($goods['is_gift'])){ ?><span
											style="line-height: 16px; color: #FFF; background-color: #DA542E; display: inline-block; height: 16px; padding: 1px 3px; border-radius: 2px; margin-right: 4px; zoom: 1; cursor: default;"
		...
		<tfoot>
			<tr class="tfoot">
				<td><a href="JavaScript:void(0);" class="btn"
					onclick="history.go(-1)"><span><?php echo $lang['nc_back'];?></span></a></td>
			</tr>
		</tfoot>
	</table>
</div>
