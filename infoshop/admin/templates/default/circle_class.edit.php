			...
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="class_name"><?php echo $lang['circle_class_name'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="class_name"
						id="class_name" class="txt"
						value="<?php echo $output['class_info']['class_name'];?>" /></td>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="recommend1"
						class="cb-enable <?php if($output['class_info']['is_recommend'] == '1'){?>selected<?php }?>"><span><?php echo $lang['nc_yes'];?></span></label>
						<label for="recommend0"
						class="cb-disable <?php if($output['class_info']['is_recommend'] == '0'){?>selected<?php }?>"><span><?php echo $lang['nc_no'];?></span></label>
						<input id="recommend1" name="recommend"
						<?php if($output['class_info']['is_recommend'] == '1'){?>
						checked="checked" <?php }?> value="1" type="radio"> <input
						id="recommend0" name="recommend"
						<?php if($output['class_info']['is_recommend'] == '0'){?>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="site_status1"
						class="cb-enable <?php if($output['class_info']['class_status'] == '1'){?>selected<?php }?>"><span><?php echo $lang['open'];?></span></label>
						<label for="site_status0"
						class="cb-disable <?php if($output['class_info']['class_status'] == '0'){?>selected<?php }?>"><span><?php echo $lang['close'];?></span></label>
						<input id="site_status1" name="status"
						<?php if($output['class_info']['class_status'] == '1'){?>
						checked="checked" <?php }?> value="1" type="radio"> <input
						id="site_status0" name="status"
						<?php if($output['class_info']['class_status'] == '0'){?>
						checked="checked" <?php }?> value="0" type="radio"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="class_sort"
						id="class_sort" class="txt"
						value="<?php echo $output['class_info']['class_sort'];?>"></td>
