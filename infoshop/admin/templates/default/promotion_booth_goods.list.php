...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a
					href="<?php echo urlAdmin('promotion_booth', 'booth_quota_list');?>"><span>套餐列表</span></a></li>
				<li><a
					href="<?php echo urlAdmin('promotion_booth', 'booth_setting');?>"><span><?php echo $lang['nc_config'];?></span></a></li>
			</ul>
		</div>
	</div>
	<div class="fixed-empty"></div>
	<form method="get" name="formSearch" id="formSearch">
		<input type="hidden" name="act" value="promotion_booth"> <input
			type="hidden" name="op" value="goods_list">
	...
	<form method='post' id="form_goods"
		action="<?php echo urlAdmin('promotion_booth', 'del_goods');?>">
        ...
        <tr class="hover edit">
					<td><input type="checkbox" name="goods_id[]"
					...
					<td class="align-center">
						...
						<p>
							<a href="javascript:void(0);"
								onclick="ajaxget('<?php echo urlAdmin('promotion_booth', 'del_goods', array('goods_id' => $v['goods_id']));?>');">删除</a>
						</p>
					</td>
				</tr>
        <?php } ?>
