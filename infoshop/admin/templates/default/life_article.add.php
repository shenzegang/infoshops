	...
	<form id="article_form" method="post" name="articleForm">
		...
		<table class="table tb-type2 nobdb">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="" name="tag"
						id="tag" class="txt"></td>
              ...
              <?php } ?>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="article_show1"
						...
						<label for="article_show0" class="cb-disable"><span><?php echo '否';?></span></label>
				...
				<tr class="noborder">
					<td colspan="2" class="vatop rowform"><?php showEditor('article_content', '', '700px', '300px', 'visibility:hidden;', true, true);?></td>
				</tr>
				<tr>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?act=life_article&op=article_pic_upload',
