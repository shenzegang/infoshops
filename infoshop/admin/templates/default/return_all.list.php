...
<div class="page">
	...
	<form method="get" action="index.php" name="formSearch" id="formSearch">
		<input type="hidden" name="act" value="return" /> <input type="hidden"
			name="op" value="return_all" />
				...
				<tr>
					<th><select name="type">
							...
							<option value="refund_sn"
								<?php if($_GET['type'] == 'refund_sn'){?> selected <?php }?>><?php echo $lang['return_order_returnsn']; ?></option>
	...
	<table class="table tb-type2 nobdb">
      ...
      <tr class="bd-line">
				...
				<td class="align-center"><a
					href="index.php?act=return&op=view&return_id=<?php echo $val['refund_id']; ?>"> <?php echo $lang['nc_view'];?> </a></td>
			</tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
