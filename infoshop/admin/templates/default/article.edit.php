			...
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="article_title"><?php echo $lang['article_index_title'];?>:</label></td>
				</tr>
				<tr class="noborder">
				...
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="cate_id"><?php echo $lang['article_add_class'];?>:</label></td>
				</tr>
				<tr class="noborder">
              ...
              <?php } ?>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="article_show1"
						class="cb-enable <?php if($output['article_array']['article_show'] == '1'){ ?>selected<?php } ?>"><span><?php echo $lang['nc_yes'];?></span></label>
						<label for="article_show0"
						class="cb-disable <?php if($output['article_array']['article_show'] == '0'){ ?>selected<?php } ?>"><span><?php echo $lang['nc_no'];?></span></label>
              ...
              <li id="<?php echo $v['upload_id'];?>" class="picture"><input
								...
								<p>
									<span><a
										href="javascript:insert_editor('<?php echo $v['upload_path'];?>');"><?php echo $lang['article_add_insert'];?></a></span><span><a
