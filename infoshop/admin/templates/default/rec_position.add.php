...
<div class="page">
	...
	<form id="rec_form" enctype="multipart/form-data" method="post"
		action="index.php?act=rec_position&op=rec_save">
		<table class="table tb-type2">
			...
			<tbody id="tr_pic_type" style="display: none">
				<tr>
					<td colspan="2" class="required"><?php echo $lang['rec_ps_select_pic'].$lang['nc_colon']?></td>
				</tr>
				<tr class="noborder">
		...
		<table id="local_pic" class="table tb-type2" style="display: none">
			...
			<tbody id="UpFileBox">
				<tr>
					<td class="vatop rowform w270"><span class="type-file-box"> <input
				...
				<tr>
					<td colspan="4"><a id="addUpFile" class="btn-add marginleft"
						href="javascript:void(0);"><span><?php echo $lang['rec_ps_addjx'];?></span></a></td>
				</tr>
			</tbody>
		</table>
		...
		<table class="table tb-type2" id="rec_width">
            ...
            <input type="text" class="txt" value="" style="width: 30px"
						name="rwidth">
