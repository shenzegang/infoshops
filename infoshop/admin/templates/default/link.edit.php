...
<div class="page">
	...
	<form id="link_form" enctype="multipart/form-data" method="post">
		<input type="hidden" name="form_submit" value="ok" /> <input
			...
			value="<?php echo $output['link_array']['link_id'];?>" /> <input
			type="hidden" name="old_link_pic"
			value="<?php echo $output['link_array']['link_pic'];?>" />
		<table class="table tb-type2">
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="link_title">合作伙伴:</label></td>
				</tr>
				<tr class="noborder">
				...
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="link_url">合作连接:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['link_array']['link_url'];?>"
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><img
							...
							<div class="type-file-preview">
								<img
									src="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_PATH.'/common/'.$output['link_array']['link_pic']);?>">
