	...
	<table class="table tb-type2 nobdb">
        ...
        <tr class="hover">
				...
				<td class="w150 align-center"><a
					href="index.php?act=web_food&op=web_edit&web_id=<?php echo $v['web_id'];?>"><?php echo $lang['web_config_web_edit'];?></a>
					| <a
					href="index.php?act=web_food&op=code_edit&web_id=<?php echo $v['web_id'];?>"><?php echo $lang['web_config_code_edit'];?></a></td>
			</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
