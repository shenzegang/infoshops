...
<script type="text/javascript"
	src="<?php echo CMS_SITE_URL;?>/resource/js/common.js" charset="utf-8"></script>
<link href="<?php echo CMS_SITE_URL.DS;?>templates/default/css/base.css"
...
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/slidesjs/jquery.slides.min.js"
	charset="utf-8"></script>
<link
	href="<?php echo RESOURCE_SITE_URL;?>/js/jcarousel/skins/personal/skin.css"
	rel="stylesheet" type="text/css">
<script type="text/javascript">
...
<textarea class="lazyload_container" rows="10" cols="30"
		style="display: none;">
<?php } ?>
