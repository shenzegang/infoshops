...
<div class="page">
	...
	<form id="search_form" method="get" name="formSearch">
		<input type="hidden" id="act" name="act" value="inform" /> <input
			type="hidden" id="op" name="op" value="inform_subject_list" />
		<table class="tb-type1 noborder search">
			<tbody>
              ...
              <option value="<?php echo $type['inform_type_id'];?>"
								<?php if ($_GET['inform_subject_type_id'] == $type['inform_type_id']){echo 'selected=true';}?>> <?php echo $type['inform_type_name'];?> </option>
              <?php } ?>
            </select></td>
	...
	<form method='post' id="list_form" action="">
		<input type="hidden" id="inform_subject_id" name="inform_subject_id"
			value="" />
        ...
        <tr class="hover">
					<td class="w24"><input type="checkbox"
						name='voucher_price_checkbox'
						value="<?php echo $v['inform_subject_id'];?>" class="checkitem"></td>
					<td><?php echo $v['inform_subject_content'];?></td>
					<td><?php echo $v['inform_subject_type_name'];?></td>
					<td class="w72 align-center"><a href="JavaScript:void(0);"
						onclick="submit_delete('<?php echo $v['inform_subject_id'];?>')"><?php echo $lang['nc_del'];?></a></td>
          <?php } ?>
          <?php }else { ?>
