	...
	<form name='form1' method='post'>
        ...
        <tr class="hover">
					<td class="w24"><input type="checkbox" name="del_id[]"
						value="<?php echo $v['code'];?>" class="checkitem"></td>
					...
					<td class="w60 align-center"><a
						href="index.php?act=message&op=email_tpl_edit&code=<?php echo $v['code']; ?>"><?php echo $lang['nc_edit'];?></a></td>
				</tr>
        <?php } ?>
        <?php } ?>
      </tbody>
			<tfoot>
				<tr>
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						onclick="$('#submit_type').val('mail_switchON');go();"><span><?php echo $lang['open'];?></span></a><a
						href="JavaScript:void(0);" class="btn"
						onclick="$('#submit_type').val('mail_switchOFF');go();"><span><?php echo $lang['close'];?></span></a></td>
				</tr>
			</tfoot>
		</table>
	</form>
