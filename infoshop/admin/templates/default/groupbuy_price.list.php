	...
	<form id="list_form" method='post'>
        ...
        <tr class="hover">
					<td class="w36"><input type="checkbox"
						value="<?php echo $val['range_id'];?>" class="checkitem"></td>
					...
					<td class="w156 align-center"><a
						href="index.php?act=groupbuy&op=price_edit&range_id=<?php echo $val['range_id'];?>"><?php echo $lang['nc_edit'];?></a>
						| <a href="JavaScript:void(0);"
						onClick="submit_delete('<?php echo $val['range_id'];?>')"><?php echo $lang['nc_del'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
        ...
        <tr>
					<td colspan="20"><a
						href="<?php echo urlAdmin('groupbuy', 'price_add');?>"
						class="btn-add marginleft"><?php echo $lang['groupbuy_price_add'];?></a></td>
				</tr>
			</tbody>
      <?php if(!empty($output['list']) && is_array($output['list'])){ ?>
      <tfoot>
