			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="mtag_recommend1"
						class="cb-enable"><span><?php echo $lang['nc_yes'];?></span></label>
						<label for="mtag_recommend0" class="cb-disable selected"><span><?php echo $lang['nc_no'];?></span></label>
						<input id="mtag_recommend1" name="membertag_recommend" value="1"
						type="radio"> <input id="mtag_recommend0"
						name="membertag_recommend" checked="checked" value="0"
						type="radio"></td>
				...
				<tr class="noborder"
					...
					<td class="vatop rowform"><textarea class="tarea" rows="6"
							name="membertag_desc" id="membertag_desc"></textarea></td>
