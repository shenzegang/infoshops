	...
	<form id="article_form" method="post" name="articleForm">
		...
		<table class="table tb-type2 nobdb">
			<tbody>
              ...
              <option <?php if($output['ac_id'] == $v['ac_id']){ ?>
              ...
              <?php } ?>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="article_show1"
						...
						<input id="article_show1" name="article_show" checked="checked"
						value="1" type="radio"> <input id="article_show0"
						name="article_show" value="0" type="radio"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
