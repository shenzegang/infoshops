...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" name="act" value="promotion_xianshi"> <input
			type="hidden" name="op" value="xianshi_list">
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><label for="xianshi_name"><?php echo $lang['xianshi_name'];?></label></th>
					<td><input type="text" value="<?php echo $_GET['xianshi_name'];?>"
						name="xianshi_name" id="xianshi_name" class="txt"
	...
	<form id="list_form" method="post">
        ...
        <tr class="hover">
					...
					<td class="nowrap align-center"><a
						href="index.php?act=promotion_xianshi&op=xianshi_detail&xianshi_id=<?php echo $val['xianshi_id'];?>"><?php echo $lang['nc_detail'];?></a>
                <?php if($val['editable']) { ?>
                <a nctype="btn_cancel"
						data-xianshi-id="<?php echo $val['xianshi_id'];?>"
						href="javascript:;"><?php echo $lang['nc_cancel'];?></a>
                <?php } ?>
                <a nctype="btn_del"
						data-xianshi-id="<?php echo $val['xianshi_id'];?>"
						href="javascript:;"><?php echo $lang['nc_del'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
