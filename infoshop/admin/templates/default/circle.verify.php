        ...
        <tr class="hover edit">
            ...
            <?php } ?></td>
					<td class="align-center yes-onoff"><a href="JavaScript:void(0);"
						class=" disabled" fieldvalue="0"
						fieldid="<?php echo $v['circle_id'];?>" ajax_branch="status"
						fieldname="circle_status" nc_type="inline_edit"
					...
					<td class="w72"><a
						...
						| <a
						href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?act=circle_manage&op=circle_del&c_id=<?php echo $v['circle_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
      ...
      <tfoot>
				<tr class="tfoot">
					...
					<td id="batchAction" colspan="15"><span class="all_checkbox"> <label
						...
						onclick="$('#submit_type').val('pass');$('form:first').submit();"><span><?php echo $lang['nc_pass'];?></span></a>
						<a href="JavaScript:void(0);" class="btn"
						onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#submit_type').val('batchdel');$('form:first').submit();}"><span><?php echo $lang['nc_del'];?></span></a>
