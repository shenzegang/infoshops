...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" name="act" value="evaluate" /> <input
			type="hidden" name="op" value="evalgoods_list" />
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><label for="goods_name"><?php echo $lang['admin_evaluate_goodsname']?></label></th>
					<td><input class="txt" type="text" name="goods_name"
						id="goods_name" value="<?php echo $_GET['goods_name'];?>" /></td>
    ...
    <?php if(!empty($output['evalgoods_list'])){?>
      ...
      <tr class="hover">
				<td><a
					...
					target="_blank"><?php echo $v['geval_goodsname'];?></a></td>
				<td class="evaluation"><div>
						商品评分：<span class="raty"
          ...
          <?php }?></td>
				...
				<td class="align-center"><a nctype="btn_del"
					...
					data-geval-id="<?php echo $v['geval_id']; ?>"><?php echo $lang['nc_del']; ?></a></td>
			</tr>
      <?php }?>
      <?php }else{?>
      <tr class="no_data">
...
<form id="submit_form"
	action="<?php echo urlAdmin('evaluate', 'evalgoods_del');?>"
	method="post">
