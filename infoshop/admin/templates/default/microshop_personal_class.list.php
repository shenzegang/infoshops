	...
	<form id="list_form" method='post'>
        ...
        <tr class="hover edit">
					<td class="w48"><input type="checkbox"
						value="<?php echo $val['class_id'];?>" class="checkitem"></td>
					<td class="w48 sort"><span nc_type="class_sort"
						column_id="<?php echo $val['class_id'];?>"
						title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $val['class_sort'];?></span>
					
					<td class="name"><span nc_type="class_name"
						column_id="<?php echo $val['class_id'];?>"
						title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $val['class_name'];?></span></td>
					<td class="w72 align-center"><a
						href="index.php?act=microshop&op=personalclass_edit&class_id=<?php echo $val['class_id'];?>"><?php echo $lang['nc_edit'];?></a>
						<a href="javascript:submit_delete(<?php echo $val['class_id'];?>)"><?php echo $lang['nc_del'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
