...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a
					href="index.php?act=circle_theme&op=theme_info&t_id=<?php echo $output['t_id'];?>"><span><?php echo $lang['circle_theme_info'];?></span></a></li>
	...
	<form method='post'>
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="t_id" value="<?php echo $output['t_id'];?>" /> <input
        ...
        <tr class="hover edit">
					<td class="w24"><input type="checkbox" name="check_reply_id[]"
						value="<?php echo $val['reply_id'];?>" class="checkitem"></td>
					...
					<td class="w84"><a href="javascript:void(0);" nctype="replyDetail"><?php echo $lang['circle_reply_check_info'];?></a>
						| <a href="javascript:void(0);"
						onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=circle_theme&op=theme_replydel&t_id=<?php echo $output['t_id'];?>&r_id=<?php echo $val['reply_id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
				</tr>
