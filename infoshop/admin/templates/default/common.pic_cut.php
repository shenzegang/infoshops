...
<div class="page">
	<form action="index.php?act=common&op=pic_cut" id="form_cut"
		method="post">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" id="x" name="x" value="<?php echo $_GET['x'];?>" /> <input
			type="hidden" id="x1" name="x1" /> <input type="hidden" id="y1"
			name="y1" /> <input type="hidden" id="x2" name="x2" /> <input
			type="hidden" id="y2" name="y2" /> <input type="hidden" id="w"
			name="w" /> <input type="hidden" id="h" name="h" /> <input
			type="hidden" id="url" name="url" value="<?php echo $_GET['url'];?>" />
		...
		<div class="pic-cut-<?php echo $_GET['x'].$_GET['type'];?>">
			...
			<div class="work-layer">
				<p>
					<img id="nccropbox" src="<?php echo $_GET['url'];?>" />
				</p>
			</div>
			<div class="thumb-title"><?php echo $lang['nc_comm_cut_view'];?></div>
			<div class="thumb-layer">
				<p>
					<img id="preview" src="<?php echo $_GET['url'];?>" />
				</p>
			</div>
			<div class="cut-help">
			...
			<div class="cut-btn">
				<a href="JavaScript:void(0);" class="btn" id="pic_submit"><span><?php echo $lang['nc_submit'];?></span></a>
				<a href="JavaScript:void(0);" class="btn" id="no_cut"><span>不剪裁</span></a>
			</div>
		</div>
	</form>
</div>
...
$(function(){
    ...
    $('#no_cut').click(function(){
		call_back('<?php echo basename($_GET['url']);?>');
