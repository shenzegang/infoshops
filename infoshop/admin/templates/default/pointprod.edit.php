          ...
          <td colspan="10" class="vatop tips"></td>
			...
			<tbody id="limitnum_div">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="limitnum"
						id="limitnum" class="txt"
						value="<?php echo $output['prod_info']['pgoods_limitnum']; ?>" /></td>
					<td colspan="10" class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="radio" name="islimittime"
						id="islimittime_1" value="1"
						<?php if ($output['prod_info']['pgoods_islimittime'] == 1){echo 'checked=checked';} ?>
						onclick="showlimittime();" /> <label for="islimittime_1"><?php echo $lang['admin_pointprod_limittime_yes']; ?></label>
						<input type="radio" name="islimittime" id="islimittime_0"
						value="0"
						<?php if ($output['prod_info']['pgoods_islimittime'] == 0){echo 'checked=checked';} ?>
						onclick="showlimittime();" /> <label for="islimittime_0"><?php echo $lang['admin_pointprod_limittime_no']; ?></label></td>
			...
			<tbody name="limittime_div">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="starttime"
						...
						value="<?php echo $output['prod_info']['pgoods_starttime']? @date('Y-m-d',$output['prod_info']['pgoods_starttime']):@date('Y-m-d',time());?>" />
            <?php echo $lang['admin_pointprod_time_day']; ?>
            <select id="starthour" name="starthour"
						style="width: 50px; margin-left: 8px; _margin-left: 4px;">
              <?php foreach ($output['hourarr'] as $item){ ?>
              <option value="<?php echo $item; ?>"
								<?php if ($item == @date('H',$output['prod_info']['pgoods_starttime'])){ echo 'selected'; } ?>><?php echo $item; ?></option>
              <?php }?>
            </select>
            <?php echo $lang['admin_pointprod_time_hour']; ?></td>
					<td class="vatop rowform"><input type="text" name="endtime"
						...
						value="<?php echo $output['prod_info']['pgoods_endtime']? @date('Y-m-d',$output['prod_info']['pgoods_endtime']):@date('Y-m-d',time()); ?>" />
            <?php echo $lang['admin_pointprod_time_day']; ?>
            <select id="endhour" name="endhour"
						style="width: 50px; margin-left: 8px; _margin-left: 4px;">
              <?php foreach ($output['hourarr'] as $item){ ?>
              <option value="<?php echo $item; ?>"
								<?php if ($item == @date('H',$output['prod_info']['pgoods_endtime'])){ echo 'selected'; } ?>><?php echo $item; ?></option>
              <?php }?>
            </select>
            <?php echo $lang['admin_pointprod_time_hour']; ?></td>
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="showstate_1"
						class="cb-enable <?php if ($output['prod_info']['pgoods_show'] == '1'){ ?>selected<?php } ?>"><span><?php echo $lang['admin_pointprod_yes']; ?></span></label>
						<label for="showstate_0"
						class="cb-disable <?php if ($output['prod_info']['pgoods_show'] == '0'){ ?>selected<?php } ?>"><span><?php echo $lang['admin_pointprod_no']; ?></span></label>
						<input id="showstate_1" name="showstate"
						<?php if ($output['prod_info']['pgoods_show'] == '1'){echo 'checked=checked';}?>
						value="1" type="radio"> <input id="showstate_0" name="showstate"
						<?php if ($output['prod_info']['pgoods_show'] == '0'){echo 'checked=checked';}?>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="commendstate_1"
						class="cb-enable <?php if ($output['prod_info']['pgoods_commend'] == '1'){ ?>selected<?php } ?>"><span><?php echo $lang['admin_pointprod_yes']; ?></span></label>
						<label for="commendstate_0"
						class="cb-disable <?php if ($output['prod_info']['pgoods_commend'] == '0'){ ?>selected<?php } ?>"><span><?php echo $lang['admin_pointprod_no']; ?></span></label>
						<input id="commendstate_1" name="commendstate"
						<?php if ($output['prod_info']['pgoods_commend'] == '1'){echo 'checked=checked';}?>
						value="1" type="radio"> <input id="commendstate_0"
						name="commendstate"
						<?php if ($output['prod_info']['pgoods_commend'] == '0'){echo 'checked=checked';}?>
						value="0" type="radio"></td>
					<td colspan="10" class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody id="forbidreason_div">
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="forbidreason"
							id="forbidreason" rows="6"><?php echo $output['prod_info']['pgoods_close_reason']; ?></textarea></td>
					<td colspan="10" class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="keywords"
						id="keywords" class="txt"
						value="<?php echo $output['prod_info']['pgoods_keywords']; ?>" /></td>
					<td colspan="10" class="vatop tips"></td>
				</tr>
				<tr>
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="sort" id="sort"
						class="txt"
						value="<?php echo $output['prod_info']['pgoods_sort']; ?>" /></td>
