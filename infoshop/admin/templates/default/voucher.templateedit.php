...
<div class="page">
	...
	<form id="add_form" method="post"
		action="index.php?act=voucher&op=templateedit">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo $output['t_info']['voucher_t_storename'];?>"
						readonly></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo $output['t_info']['voucher_t_title'];?>"
						readonly></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo @date('Y-m-d',$output['t_info']['voucher_t_end_date']);?>"
						readonly></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo $output['t_info']['voucher_t_price'];?>"
						readonly></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo $output['t_info']['voucher_t_total'];?>"
						readonly></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo $output['t_info']['voucher_t_eachlimit'];?>"
						readonly></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo $output['t_info']['voucher_t_limit'];?>"
						readonly></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea rows="6" readonly="readonly"
							class="readonly tarea"><?php echo $output['t_info']['voucher_t_desc'];?></textarea></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
	      	...
	      	<?php }?>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo $output['t_info']['voucher_t_giveout'];?>"
						readonly></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="readonly txt"
						value="<?php echo $output['t_info']['voucher_t_used'];?>" readonly></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" class="txt"
						...
						value="<?php echo $output['t_info']['voucher_t_points'];?>"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
          	...
          	<?php foreach ($output['templatestate_arr'] as $k=>$v){?>
          		<input type="radio" value="<?php echo $v[0];?>"
						id="tstate_<?php echo $v[0];?>" name="tstate"
						<?php echo $v[0] == $output['t_info']['voucher_t_state']?'checked="checked"':'';?>><?php echo $v[1];?>
          	<?php }?>
          </td>
					<td class="vatop tips"></td>
				</tr>
