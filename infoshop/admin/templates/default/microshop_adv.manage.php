...
<div class="page">
	...
	<form id="list_form" method='post'>
        ...
        <tr class="hover edit">
					<td><input type="checkbox" value="<?php echo $val['adv_id'];?>"
						class="checkitem"></td>
					<td class="w48 sort"><span nc_type="adv_sort"
						column_id="<?php echo $val['adv_id'];?>"
						title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $val['adv_sort'];?></span>
					
					<td><?php echo $output['adv_type_list'][$val['adv_type']];?></td>
					<td><?php echo $val['adv_name'];?></td>
					<td class="align-center"><a
						href="index.php?act=microshop&op=adv_edit&adv_id=<?php echo $val['adv_id'];?>"><?php echo $lang['nc_edit'];?></a>
