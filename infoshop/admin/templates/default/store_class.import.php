...
<div class="page">
	...
	<form method="post" enctype="multipart/form-data" name="form1">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr>
					<td colspan="2" class="required"><label><?php echo $lang['file_format'];?>:</label>
						<a href="<?php echo RESOURCE_SITE_URL;?>/examples/store_class.csv"
						class="btns"><span><?php echo $lang['click_download_import_file'];?></span></a></td>
				</tr>
				<tr class="noborder">
			...
			<tfoot>
				<tr class="tfoot">
					<td colspan="15"><a href="JavaScript:document.form1.submit();"
