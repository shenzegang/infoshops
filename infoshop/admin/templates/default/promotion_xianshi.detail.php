...
<div class="page">
	...
	<form id="list_form" method="post">
        ...
        <tr class="hover">
					<td valign="middle" class="align2"><a
						href="<?php echo $val['goods_url'];?>" target="_blank"> <img
							src="<?php echo $val['image_url'];?>"
							onload="javascript:DrawImage(this,50,50);" />
					</a></td>
					<td class="align-left"><a href="<?php echo $val['goods_url'];?>"
						target="_blank"> <span><?php echo $val['goods_name']; ?></span>
					</a></td>
            ...
            <td class="yes-onoff align-center">
                ...
                <a href="JavaScript:void(0);" class=" enabled"
						...
						fieldname="xianshi_recommend"
						fieldid="<?php echo $val['xianshi_goods_id']?>" fieldvalue="1"
                ...
                <a href="JavaScript:void(0);" class=" disabled"
						ajax_branch='recommend' nc_type="inline_edit"
						fieldname="xianshi_recommend"
						fieldid="<?php echo $val['xianshi_goods_id']?>" fieldvalue="0"
						title="<?php echo $lang['nc_editable'];?>"><img
							src="<?php echo ADMIN_TEMPLATES_URL;?>/images/transparent.gif"></a>
                <?php } ?>
            </td>
