...
<div class="page">
	...
	<form id="add_form" method="post" enctype="multipart/form-data"
		action="index.php?act=inform&op=inform_subject_type_save" name="form1">
		<table class="table tb-type2 nobdb">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="inform_type_name"
						name="inform_type_name" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="inform_type_desc"
							rows="6" id="inform_type_desc" class="tarea"></textarea></td>
					<td class="vatop tips"></td>
				</tr>
