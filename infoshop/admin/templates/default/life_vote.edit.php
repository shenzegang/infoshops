	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a href="index.php?act=life_vote&op=add"><span>新增</span></a></li>
	...
	<form id="form" method="post">
		...
		<table class="table tb-type2">
            ...
            foreach ($output['item_list'] as $k => $v) {
                ?>
              <li class="fieldItem"><span class="t">投票项目<?php echo ($k + 1); ?></span>：<input
								name="item[]" type="text" class="text" style="width: 300px;"
								value="<?php echo $v['title']; ?>"> （<?php echo $v['num']; ?>）
                <a href="javascript:;" class="up">上移</a><a
								href="javascript:;" class="down">下移</a><a href="javascript:;"
								class="del">删除</a> <input type="hidden" name="s[]" class="s"
								value="<?php echo $v['sort']; ?>"> <input type="hidden"
								name="i[]" class="i" value="<?php echo $v['id']; ?>"></li>
              <?php
            }
            ?>
            </ul>
						<div id="addBox">
							<li class="fieldItem"><span class="t"></span>：<input
								...
								type="hidden" name="s[]" class="s"> <input type="hidden"
								name="i[]" class="i"></li>
