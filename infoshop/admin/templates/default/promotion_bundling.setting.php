...
<div class="page">
	...
	<form id="add_form" method="post"
		action="index.php?act=promotion_bundling&op=bundling_setting">
		<input type="hidden" id="form_submit" name="form_submit" value="ok" />
		<table class="table tb-type2">
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="promotion_bundling_price"><?php echo $lang['bundling_gold_price'].$lang['nc_colon'];?></label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						id="promotion_bundling_price" name="promotion_bundling_price"
						value="<?php echo $output['setting']['promotion_bundling_price'];?>"
						class="txt"></td>
					<td class="vatop tips"><?php echo $lang['bundling_price_prompt'];?></td>
				</tr>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="promotion_bundling_sum"><?php echo $lang['bundling_sum'].$lang['nc_colon'];?></label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						id="promotion_bundling_sum" name="promotion_bundling_sum"
						value="<?php echo $output['setting']['promotion_bundling_sum'];?>"
						class="txt"></td>
					<td class="vatop tips"><?php echo $lang['bundling_sum_prompt'];?></td>
				</tr>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="promotion_bundling_goods_sum"><?php echo $lang['bundling_goods_sum'].$lang['nc_colon'];?></label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						id="promotion_bundling_goods_sum"
						name="promotion_bundling_goods_sum"
						value="<?php echo $output['setting']['promotion_bundling_goods_sum'];?>"
						class="txt"></td>
