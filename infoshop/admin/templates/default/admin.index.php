	...
	<form method="post" id='form_admin'>
		...
		<table class="table tb-type2">
			<thead>
				...
				<tr class="thead">
					<th><input type="checkbox" class="checkall" id="checkallBottom"
						name="chkVal"></th>
        ...
        <tr class="hover">
            ...
            <input type="checkbox" name="del_id[]"
						value="<?php echo $v['admin_id']; ?>" class="checkitem"
						onclick="javascript:chkRow(this);">
            <?php }else { ?>
            <input name="del_id[]" type="checkbox"
						value="<?php echo $v['admin_id']; ?>" disabled="disabled">
            <?php }?></td>
            ...
            <a href="javascript:void(0)"
						onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=admin&op=admin_del&admin_id=<?php echo $v['admin_id']; ?>'}"><?php echo $lang['admin_index_del_admin'];?></a>
						| <a
						href="index.php?act=admin&op=admin_edit&admin_id=<?php echo $v['admin_id']; ?>"><?php echo $lang['nc_edit'];?></a>
            <?php }?></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        ...
        <tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#form_admin').submit();}"><span><?php echo $lang['nc_del'];?></span></a>
