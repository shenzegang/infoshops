...
<div class="page">
	...
	<form id="add_form" method="post" enctype="multipart/form-data"
		action="index.php?act=complain&op=complain_setting_save">
		<table class="table tb-type2 nobdb">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input name="complain_time_limit"
						id="complain_time_limit"
						value="<?php echo intval($output['list_setting']['complain_time_limit'])/86400;?>"
			...
			<tfoot>
				<tr class="tfoot">
					<td colspan="15"><a href="JavaScript:void(0);" class="btn"
						id="btn_add"><span><?php echo $lang['nc_submit'];?></span></a></td>
				</tr>
			</tfoot>
		</table>
	</form>
