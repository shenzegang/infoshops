...
<div class="page">
	...
	<form id="grade_form" method="post">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="sg_id"
			value="<?php echo $output['grade_array']['sg_id'];?>" />
		<table class="table tb-type2 nobdb">
			<tbody>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="sg_name"><?php echo $lang['store_grade_name'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['grade_array']['sg_name'];?>"
						id="sg_name" name="sg_name" class="txt"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['grade_array']['sg_goods_limit'];?>"
						id="sg_goods_limit" name="sg_goods_limit" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['grade_array']['sg_album_limit'];?>"
						id="sg_album_limit" name="sg_album_limit" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php echo $output['grade_array']['sg_template_number'];?> <span
						class="grey">(<?php echo $lang['in_store_grade_list_set'];?>)</span></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul class="nofloat">
							<li><input type="checkbox"
								<?php if(@in_array('editor_multimedia',$output['grade_array']['sg_function'])){ ?>
								checked="checked" <?php } ?> id="function_editor_multimedia"
								value="editor_multimedia" name="sg_function[]"> <label
								for="function_editor_multimedia"><?php echo $lang['editor_media_features'];?></label>
							</li>
						</ul></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="sg_price"><?php echo $lang['charges_standard'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['grade_array']['sg_price'];?>"
						id="sg_price" name="sg_price" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea id="sg_description" rows="6"
							class="tarea" name="sg_description"><?php echo $output['grade_array']['sg_description'];?></textarea></td>
            ...
            <input type="text"
						value="<?php echo $output['grade_array']['sg_sort'];?>"
						id="sg_sort" name="sg_sort" class="txt" readonly="readonly">
            <?php }else{?>
            <input type="text"
						value="<?php echo $output['grade_array']['sg_sort'];?>"
						id="sg_sort" name="sg_sort" class="txt">
            <?php }?></td>
