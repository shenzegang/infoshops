...
<div class="page">
	...
	<table class="table tb-type2">
		<tbody>
			...
			<tr class="noborder">
				<td class="vatop rowform"><input type="text" name="searchname"
					id="searchname" class="txt" style="width: 190px;" /> <input
					type="submit" nctype="cm_s"
			...
			<tr class="noborder">
				<td colspan="2" class="vatop rowform"><select id="searchresult"
					class="w300" style="height: 140px;" size="7" name="searchresult"></select>
				</td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
				<td colspan="2"><a href="JavaScript:void(0);" class="btn"
					id="confirmBtn"><span><?php echo $lang['nc_ok'];?></span></a></td>
			</tr>
		</tfoot>
	</table>
</div>
