...
<div class="page">
	...
	<form id="form_templates" method="post" name="form1">
		<input type="hidden" name="form_submit" value="ok" /> <input
			...
			value="<?php echo $output['templates_array']['code'];?>" />
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['templates_array']['title'];?>"
						name="title" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="link"><?php echo $lang['mailtemplates_edit_content']?>:</label></td>
				</tr>
				<tr class="noborder">
					<td colspan="2"><textarea name="content" cols="60" rows="20"
							style="width: 600px; height: 200px;"><?php  echo $output['templates_array']['content']; ?></textarea></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
