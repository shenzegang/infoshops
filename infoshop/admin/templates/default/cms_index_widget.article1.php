...
<div
	class="cms-index-module-article1 module-style-<?php echo $value['module_style'];?>">
	<div class="cms-index-module-article-title">
      ...
      <?php if($output['edit_flag']) { ?>
      <div class="cms-index-module-handle">
				<a id="btn_module_tag_edit" href="JavaScript:void(0);" class="tip-l"
					title="<?php echo $lang['cms_index_module_tag_edit'];?>"><?php echo $lang['cms_index_module_tag_edit'];?></a>
			</div>
      <?php } ?>
    </div>
	</div>
	...
	<div class="cms-index-module-article1-1">
      ...
      <?php if($output['edit_flag']) { ?>
      <div class="cms-index-module-handle">
				<a nctype="btn_module_image_edit" image_count="1"
					href="JavaScript:void(0);" class="tip-r"
					data-title="<?php echo $lang['cms_index_module_image_edit_title'];?>"
					title="<?php echo $lang['cms_index_module_image_edit_title'];?>"><?php echo $lang['cms_index_module_image_edit'];?></a>
			</div>
      <?php } ?>
    </div>
		<!-- 文章　-->
        ...
        <div class="cms-index-module-handle">
					<a nctype="btn_module_article_edit"
						save_function="article_type_1_save" limit_count="5"
						href="JavaScript:void(0);" class="tip-l"
						title="<?php echo $lang['cms_index_module_article_edit'];?>"><?php echo $lang['nc_edit'];?></a>
				</div>
        <?php } ?>
      </div>
		</div>
	...
	<div class="cms-index-module-article1-2">
      ...
      <div class="cms-index-module-handle">
				<a nctype="btn_module_article_edit"
					save_function="article_type_2_save" limit_count="6"
					href="JavaScript:void(0);" class="tip-l"
					title="<?php echo $lang['cms_index_module_article_edit'];?>"><?php echo $lang['nc_edit'];?></a>
			</div>
      <?php } ?>
	...
	<div class="cms-index-module-article1-3">
      ...
      <?php if($output['edit_flag']) { ?>
      <div class="cms-index-module-handle">
				<a nctype="btn_module_goods_edit" limit_count="6"
					href="JavaScript:void(0);" class="tip-l"
					title="<?php echo $lang['cms_index_module_goods_edit'];?>"><?php echo $lang['cms_index_module_goods_edit'];?></a>
			</div>
      <?php } ?>
    </div>
	</div>
