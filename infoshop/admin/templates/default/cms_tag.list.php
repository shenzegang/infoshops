	...
	<form id="list_form" method='post'>
        ...
        <tr class="hover edit">
					<td class="w24"><input type="checkbox"
						value="<?php echo $val['tag_id'];?>" class="checkitem"></td>
					<td class="w48 sort"><span nc_type="tag_sort"
						column_id="<?php echo $val['tag_id'];?>"
						title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $val['tag_sort'];?></span>
					
					<td class="name"><span nc_type="tag_name"
						column_id="<?php echo $val['tag_id'];?>"
						title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $val['tag_name'];?></span></td>
					<td class="w50pre align-center"><?php echo $val['tag_count'];?></td>
					<td class="w72 align-center"><a
						href="javascript:submit_delete(<?php echo $val['tag_id'];?>)"><?php echo $lang['nc_del'];?></a></td>
				</tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
