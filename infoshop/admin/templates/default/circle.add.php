			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="mastername"
						id="mastername" readonly="readonly" class="txt" /> <input
						type="hidden" name="masterid" id="masterid" /></td>
              ...
              <?php }?>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea" rows="6"
							name="c_desc" id="c_desc"></textarea></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea" rows="6"
							name="c_notice" id="c_notice"></textarea></td>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="c_status1"
						...
						<input id="c_status1" name="c_status" checked="checked" value="1"
						type="radio"> <input id="c_status0" name="c_status" value="0"
						type="radio"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="c_recommend1"
						...
						<input id="c_recommend1" name="c_recommend" checked="checked"
						value="1" type="radio"> <input id="c_recommend0"
						name="c_recommend" value="0" type="radio"></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tfoot>
