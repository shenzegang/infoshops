...
<div class="page">
  ...
  <form id="cfee_form" method="post" name="cfee_form"
		action="index.php?act=pointorder&op=order_changfee&id=<?php echo $_GET['id']; ?>">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="shippingfee"
						name="shippingfee" class="txt"
						value="<?php echo $output['order_info']['point_shippingfee']; ?>"></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
					<td colspan="15"><a href="JavaScript:void(0);" class="btn"
						id="submitBtn" onclick="document.cfee_form.submit()"><span><?php echo $lang['nc_submit'];?></span></a>
					</td>
				</tr>
			</tfoot>
