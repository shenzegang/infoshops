...
<meta http-equiv="Content-Type" content="text/html;"
	...
	<link href="<?php echo ADMIN_TEMPLATES_URL;?>/css/skin_0.css"
  ...
  <dl>
  	...
  	<dd>
					<a href="javascript:void(0)"
						onclick="openItem('<?php echo $value['args']?>')"><?php echo $value['text'];?></a>
				</dd>
  	<?php }?>
  	 </dl>
  <?php }?>
	...
	<table style="width: 100%;" id="frametable" height="100%" width="100%"
		...
		<tbody>
			<tr>
				<td colspan="2" height="90" class="mainhd"><div
						...
						<div id="topnav" class="top-nav">
							<ul>
								<li class="adminid"
									title="<?php echo $lang['nc_hello'];?>:<?php echo $output['admin_info']['name'];?>"><?php echo $lang['nc_hello'];?>&nbsp;:&nbsp;<strong><?php echo $output['admin_info']['name'];?></strong></li>
								...
								<li><a href="index.php?act=index&op=logout"
									title="<?php echo $lang['nc_logout'];?>"><span><?php echo $lang['nc_logout'];?></span></a></li>
								<li><a href="<?php echo SHOP_SITE_URL;?>" target="_blank"
									title="<?php echo $lang['nc_homepage'];?>"><span><?php echo $lang['nc_homepage'];?></span></a></li>
							</ul>
						</div>
           ...
           <?php echo $output['top_nav'];?>
						...
						<div class="loca">
							<strong><?php echo $lang['nc_loca'];?>:</strong>
							<div id="crumbs" class="crumbs">
								<span><?php echo $lang['nc_console'];?></span><span
									class="arrow">&nbsp;</span><span><?php echo $lang['nc_welcome_page'];?></span>
							</div>
						</div>
						<div class="toolbar">
							<ul id="skin" class="skin">
								...
								<li id="skin_0" class=""
									title="<?php echo $lang['nc_default_style'];?>"></li>
								<li id="skin_1" class=""
									title="<?php echo $lang['nc_mac_style'];?>"></li>
							</ul>
							<div class="sitemap">
							...
							<div class="toolmenu">
								...
								<ul class="bar-list">
									...
									<li><a href="<?php echo ADMIN_SITE_URL;?>"
										...
										rel="sidebar"
										onclick="addFavorite('<?php echo ADMIN_SITE_URL;?>', '<?php echo $lang['nc_admincp']; ?>-<?php echo $output['html_title'];?>');return false;"><?php echo $lang['nc_favorite']; ?><?php echo $lang['nc_admincp']; ?></a></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<tr>
				<td class="menutd" valign="top" width="161"><div id="mainMenu"
						class="main-menu">
          <?php echo $output['left_nav'];?>
        </div></td>
				<td valign="top" width="100%"><iframe src="" id="workspace"
						name="workspace" style="overflow: visible;" frameborder="0"
						width="100%" height="100%" scrolling="yes" onload="window.parent"></iframe></td>
			</tr>
		</tbody>
	</table>
</body>
