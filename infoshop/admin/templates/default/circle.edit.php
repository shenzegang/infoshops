...
<div class="page">
	...
	<form id="circle_form" method="post">
		<input type="hidden" name="form_submit" value="ok" /> <input
			...
			value="<?php echo $output['circle_info']['circle_id'];?>" /> <input
			type="hidden" name="c_oldimg"
			value="<?php echo $output['circle_info']['circle_img'];?>" />
		<table class="table tb-type2">
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="c_name"><?php echo $lang['circle_name'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_name"
						id="c_name" class="txt"
						value="<?php echo $output['circle_info']['circle_name'];?>" /></td>
					<td class="vatop tips"><?php echo $lang['circle_name_tips'];?></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="mastername"><?php echo $lang['circle_member_identity_master'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="mastername"
						id="mastername" class="txt" readonly="readonly"
						value="<?php echo $output['circle_info']['circle_mastername'];?>" />
						<input type="hidden" name="masterid" id="masterid"
						value="<?php echo $output['circle_info']['circle_masterid'];?>" />
					</td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><select name="classid">
							<option value="0"><?php echo $lang['nc_common_pselect'];?></option>
              <?php if(!empty($output['class_list'])){?>
              <?php foreach ($output['class_list'] as $val){?>
              <option value="<?php echo $val['class_id'];?>"
								<?php if($output['circle_info']['class_id'] == $val['class_id']){echo 'selected="selected"';}?>><?php echo $val['class_name'];?></option>
              <?php }?>
              <?php }?>
            </select></td>
					<td class="vatop tips"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea" rows="6"
							name="c_desc" id="c_desc"><?php echo $output['circle_info']['circle_desc'];?></textarea>
					</td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="c_tag"
						class="txt"
						value="<?php echo $output['circle_info']['circle_tag'];?>" /></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea" rows="6"
							name="c_notice" id="c_notice"><?php echo $output['circle_info']['circle_notice'];?></textarea>
					</td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"> <img
							...
							<div class="type-file-preview" style="display: none;">
								<img id="view_img"
									src="<?php echo circleLogo($output['circle_info']['circle_id']);?>?<?php echo microtime();?>">
							</div>
					</span> <span class="type-file-box"> <input type='text'
							name='c_img' id='c_img' class='type-file-text' /> <input
				...
				<tr class="noborder">
					<td class="vatop rowform"><label><input type="radio"
							name="c_status"
							<?php if($output['circle_info']['circle_status'] == 0){ echo 'checked="checked"';}?>
							value="0" /><?php echo $lang['nc_close'];?></label> <label><input
							type="radio" name="c_status"
							<?php if($output['circle_info']['circle_status'] == 1){ echo 'checked="checked"';}?>
							value="1" /><?php echo $lang['nc_open'];?></label> <label><input
							type="radio" name="c_status"
							<?php if($output['circle_info']['circle_status'] == 2){ echo 'checked="checked"';}?>
							value="2" /><?php echo $lang['circle_verifying'];?></label> <label><input
							type="radio" name="c_status"
							<?php if($output['circle_info']['circle_status'] == 3){ echo 'checked="checked"';}?>
							value="3" /><?php echo $lang['circle_verify_fail'];?></label></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody id="circle_statusinfo"
				<?php if($output['circle_info']['circle_status'] == 1 || $output['circle_info']['circle_status'] == 2){ echo 'style="display:none;"';}?>>
				<tr>
					<td colspan="2" class="required"><label for="c_statusinfo"><?php echo $lang['circle_verify_fail_reason'];?></label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><textarea class="tarea" rows="6"
							name="c_statusinfo" id="c_statusinfo"><?php echo $output['circle_info']['circle_statusinfo'];?></textarea>
					</td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="c_recommend1"
						class="cb-enable <?php if($output['circle_info']['is_recommend'] == 1) echo 'selected';?>"><span><?php echo $lang['nc_yes'];?></span></label>
						<label for="c_recommend0"
						class="cb-disable <?php if($output['circle_info']['is_recommend'] == 0) echo 'selected';?>"><span><?php echo $lang['nc_no'];?></span></label>
						<input id="c_recommend1" name="c_recommend"
						<?php if($output['circle_info']['is_recommend'] == 1) echo 'checked="checked"';?>
						value="1" type="radio"> <input id="c_recommend0"
						name="c_recommend"
						<?php if($output['circle_info']['is_recommend'] == 0) echo 'checked="checked"';?>
