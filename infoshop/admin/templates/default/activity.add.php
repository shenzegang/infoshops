			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="activity_title"
						name="activity_title" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						id="activity_start_date" name="activity_start_date"
						class="txt date" /></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="activity_end_date"
						name="activity_end_date" class="txt date" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform type-file-box"><input type="file"
						class="type-file-file" id="activity_banner" name="activity_banner"
						size="30" hidefocus="true" nc_type="upload_activity_banner"
						title="<?php echo $lang['activity_index_banner'];?>"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="activity_desc"
							id="activity_desc" rows="6" class="tarea"></textarea></td>
					<td class="vatop tips">&nbsp;</td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="activity_sort"
						name="activity_sort" class="txt" value="0"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="activity_state1"
						class="cb-enable selected"><span><?php echo $lang['activity_openstate_open'];?></span></label>
