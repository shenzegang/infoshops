...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a
					href="index.php?act=bill&op=show_statis&os_month=<?php echo $output['bill_info']['os_month'];?>"><span><?php echo $output['bill_info']['os_month'];?>期  商家账单列表</span></a></li>
	...
	<table class="table tb-type2 noborder search">
      ...
      <a class="btns"
					...
					href="index.php?act=bill&op=bill_check&ob_no=<?php echo $_GET['ob_no'];?>"><span><?php echo $lang['nc_exdport'];?>审核</span></a>
       <?php }elseif ($output['bill_info']['ob_state'] == BILL_STATE_SYSTEM_CHECK){?>
		<a class="btns"
					href="index.php?act=bill&op=bill_pay&ob_no=<?php echo $_GET['ob_no'];?>"><span><?php echo $lang['nc_exdport'];?>付款完成</span></a>
       <?php }elseif ($output['bill_info']['ob_state'] == BILL_STATE_SUCCESS){?>
      <a class="btns" target="_blank"
					href="index.php?act=bill&op=bill_print&ob_no=<?php echo $_GET['ob_no'];?>"><span><?php echo $lang['nc_exposrt'];?>打印</span></a>
      <?php }?>
      </td>
			</tr>
			<tr>
			...
			<tr>
				<td>起止日期<?php echo $lang['nc_colon'];?><?php echo date('Y-m-d',$output['bill_info']['ob_start_date']);?> &nbsp;至&nbsp; <?php echo date('Y-m-d',$output['bill_info']['ob_end_date']);?>
      	</td>
			</tr>
			<tr>
