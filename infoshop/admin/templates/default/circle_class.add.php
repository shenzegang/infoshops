			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="recommend1"
						...
						<input id="recommend1" name="recommend" checked="checked"
						value="1" type="radio"> <input id="recommend0" name="recommend"
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="site_status1"
						...
						<input id="site_status1" name="status" checked="checked" value="1"
						type="radio"> <input id="site_status0" name="status" value="0"
						type="radio"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="0"
						name="class_sort" id="class_sort" class="txt"></td>
