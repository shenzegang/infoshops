...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a
					href="index.php?act=adv&op=adv&ap_id=<?php echo $_GET['ap_id'];?>"><span><?php echo $lang['adv_manage'];?></span></a></li>
	...
	<form id="adv_form" enctype="multipart/form-data" method="post">
		...
		<table class="table tb-type2" id="main_table">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_name"
						id="adv_name" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="ap_id"><?php echo $lang['adv_ap_select'];?>:</label></td>
				</tr>
				<tr class="noborder">
            ...
            ?>
            </select> <input type="hidden" name="aptype_hidden"
						id="aptype_hidden" /></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="adv_start_time"><?php echo $lang['adv_start_time'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						name="adv_start_time" id="adv_start_time" class="txt date"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="adv_end_time"><?php echo $lang['adv_end_time'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						name="adv_end_time" id="adv_end_time" class="txt date"></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			<tbody id="adv_pic">
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-box"> <input
							type="file" class="type-file-file" id="file_adv_pic"
							name="adv_pic" size="30" />
					</span></td>
			...
			<tbody id="adv_pic_url">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_pic_url"
						class="txt" id="type_adv_pic_url"></td>
			...
			<tbody id="adv_word">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_word"
						id="type_adv_word" class="txt"></td>
					<td class="vatop tips"><?php echo $lang['adv_max'];?><span
						id="adv_word_len"></span><?php echo $lang['adv_byte'];?></td>
				</tr>
			</tbody>
			<tbody id="adv_word_url">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="adv_word_url"
						class="txt" id="type_adv_word_url"></td>
					<td class="vatop tips"><?php echo $lang['adv_url_donotadd'];?></td>
				</tr>
			</tbody>
			<tbody id="adv_flash_swf">
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-box"> <input
							type="file" class="type-file-file" id="file_flash_swf"
							name="flash_swf" size="30" />
					</span></td>
			...
			<tbody id="adv_flash_url">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="flash_url"
						class="txt" id="type_adv_flash_url"></td>
					<td class="vatop tips"><?php echo $lang['adv_url_donotadd'];?></td>
				</tr>
			</tbody>
			<tfoot>
