...
<div class="page">
	...
	<form id="link_form" enctype="multipart/form-data" method="post">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="h_id"
			value="<?php echo $output['home_array']['h_id'];?>" />
		<table class="table tb-type2">
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="h_title"><?php echo $lang['home_index_title'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['home_array']['h_title'];?>"
						name="h_title" id="h_title" class="txt"></td>
					<td class="vatop tips"><?php echo $lang['home_add_name'];?></td>
				</tr>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="h_desc"><?php echo $lang['home_index_desc'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['home_array']['h_desc'];?>"
						name="h_desc" id="h_desc" class="txt"></td>
          ...
          <?php } ?>
				...
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="h_keyword"><?php echo $lang['home_index_keyword'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['home_array']['h_keyword'];?>"
						name="h_keyword" id="h_keyword" class="txt"></td>
					<td class="vatop tips"><?php echo $lang['home_add_keyword'];?></td>
				</tr>
        <?php if($output['home_array']['h_type'] == 'type1') { ?>
        <tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="h_keyword">多关键词:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['home_array']['h_multi_keyword'];?>"
						name="h_multi_keyword" id="h_multi_keyword" class="txt"></td>
        ...
        <tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"><img
							...
							<div class="type-file-preview">
								<img
									src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MOBILE.'/home/'.$output['home_array']['h_img'];?>">
							</div> </span> <span class="type-file-box"> <input name="h_img"
							type="file" class="type-file-file" id="h_img" size="30">
					</span></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						value="<?php echo $output['home_array']['h_sort'];?>"
						name="h_sort" id="h_sort" class="txt"></td>
