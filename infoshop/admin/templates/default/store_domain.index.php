...
<div class="page">
	...
	<form method="get" name="formSearch">
		<input type="hidden" value="domain" name="act"> <input type="hidden"
			value="store_domain_list" name="op">
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo $_GET['store_domain'];?>"
						name="store_domain" id="store_domain" class="txt"></td>
	...
	<form method="post" id="store_form">
        ...
        <tr class="hover edit">
					...
					<td class="w150 align-center"><a
						href="index.php?act=domain&op=store_domain_edit&store_id=<?php echo $v['store_id']?>"><?php echo $lang['nc_edit'];?></a>
					</td>
				</tr>
        <?php } ?>
        <?php }else { ?>
