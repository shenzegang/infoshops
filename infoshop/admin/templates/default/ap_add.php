	...
	<form id="link_form" enctype="multipart/form-data" method="post">
		...
		<table class="table tb-type2">
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation"
						for="ap_name"><?php echo $lang['ap_name'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="ap_name"
						id="ap_name" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul>
							<li><input name="is_use" type="radio" value="1" checked="checked">
								<label><?php echo $lang['ap_use_s'];?></label></li>
							<li><input type="radio" name="is_use" value="0"> <label><?php echo $lang['ap_not_use_s'];?></label>
							</li>
						</ul></td>
					<td class="vatop tips"></td>
				</tr>
			...
			<tbody id="ap_display">
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul class="nofloat">
							<li><input type="radio" name="ap_display" value="1"> <label><?php echo $lang['ap_allow_mul_adv'];?></label>
							</li>
							<li><input type="radio" name="ap_display" value="2"
								checked="checked"> <label><?php echo $lang['ap_allow_one_adv'];?></label>
							</li>
						</ul></td>
					<td class="vatop tips"></td>
				</tr>
			...
			<tbody id="ap_width_media">
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="ap_width_media_input"><?php echo $lang['ap_width_l'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						name="ap_width_media" class="txt" id="ap_width_media_input"></td>
			...
			<tbody id="ap_width_word">
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="ap_width_word_input"><?php echo $lang['ap_word_num'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						name="ap_width_word" class="txt" id="ap_width_word_input"></td>
			...
			<tbody id="ap_height">
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="ap_height_input"><?php echo $lang['ap_height_l'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value=""
						name="ap_height" class="txt" id="ap_height_input"></td>
					<td class="vatop tips"><?php echo $lang['adv_pix'];?></td>
				</tr>
			</tbody>
			<tbody id="default_pic">
				<tr>
					<td colspan="2" class="required"><label class="validation"
						for="change_default_pic"><?php echo $lang['ap_default_pic']; ?></label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform type-file-box"><input type="file"
						name="default_pic" id="change_default_pic" size="30"
						hidefocus="true" nc_type="change_default_pic"></td>
			...
			<tbody id="default_word">
				<tr>
					<td colspan="2" class="required"><label for="default_word"
						class="validation"><?php echo $lang['ap_default_word']; ?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="default_word"
						value="" name="default_word" class="txt"></td>
