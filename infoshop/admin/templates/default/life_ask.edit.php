			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text"
						...
						id="url" class="txt"></td>
					<td class="vatop tips">当填写&quot;链接&quot;后点击问题标题将直接跳转至链接地址，不显示问题内容。链接格式请以http://开头</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" class="required"><label class="validation">问题内容:</label></td>
				</tr>
				<tr class="noborder">
					<td colspan="2" class="vatop rowform"><?php showEditor('content',$output['article_array']['content']);?></td>
				</tr>
				<tr>
...
$(document).ready(function(){
    ...
    $('#fileupload').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: 'index.php?act=life_ask&op=pic_upload&item_id=<?php echo $output['article_array']['id'];?>',
