	...
	<tbody>
		...
		<tr class="noborder hover">
            ...
            <?php } ?>
					...
					<li><strong><?php echo $lang['buyer_apply_refund_type'];?>:</strong>
						<?php if($output['complain_info']['refund_type']=='1'){?>
							仅退款
						<?php } else {?>
							退款退货
						<?php } ?>
				...
				<ul>
					<li><strong><?php echo $lang['seller_apply_refund_type'];?>:</strong>
						<?php if($output['complain_info']['return_type']=='1'){?>
							仅退款
						<?php } else {?>
							退款退货
						<?php } ?>
		...
		<tr class="noborder">
          ...
          <tr>
						<td width="65" align="center" valign="middle"><a
							...
							href="<?php echo urlShop('goods','index',array('goods_id'=> $complain_goods['goods_id']));?>"
							target="_blank"> <img width="50"
								src="<?php echo cthumb($complain_goods['goods_image'], 60,$output['order_info']['store_id']);?>" />
						</a></td>
						<td class="intro">
							<p>
								<a
									href="<?php echo urlShop('goods','index',array('goods_id'=> $complain_goods['goods_id']));?>"
									target="_blank"><?php echo $complain_goods['goods_name'];?> </a>
							</p>
					...
					<tr class="problem_desc">
						<td colspan="4"><div class="complain-tit">
								<span><?php echo $lang['complain_text_problem'];?>:</span><?php echo $complain_goods['complain_message'];?></div></td>
					</tr>
          <?php } ?>
        </table></td>
		</tr>
		...
		<tr class="noborder">
			<td><div class="complain-intro"
					style="color: #06C; border-color: #A7CAED;"><?php echo $output['complain_info']['complain_content'];?></div></td>
		</tr>
	</tbody>
</table>
...
<table class="table tb-type2 order mtw">
	...
	<tbody>
        ...
        <p><?php echo $lang['refund_order_refund'];?>:<b><?php echo $lang['currency'].$output['order_info']['refund_amount'];?></b>
				</p>
        <?php } ?>
