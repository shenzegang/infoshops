	...
	<form id="list_form" method="post">
        ...
        <tr class="hover">
					<td class="align-left"><a
						href="<?php echo urlShop('show_store','index', array('store_id'=>$val['apply_storeid']));?>"
						target="_blank"> <span><?php echo $val['apply_storename'];?></span></a>
					</td>
              ...
              <!-- 审核按钮 --> <a href="javascript:void(0)"
						onclick="submit_verify('<?php echo $val['apply_id'];?>')"><?php echo $lang['nc_verify'];?></a>
						| <!-- 取消按钮 --> <a href="javascript:void(0)"
						onclick="submit_cancel('<?php echo $val['apply_id'];?>');"><?php echo $lang['nc_cancel'];?></a> 
              <?php } ?>
          </td>
				</tr>
        <?php } ?>
