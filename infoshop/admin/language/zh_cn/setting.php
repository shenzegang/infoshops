...
$lang['site_bank_account_notice'] = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:Corshop,开户行:中国银行深圳分行"';
...
$lang['if_smtp_authentication'] = '使用SMTP协议发送的邮件地址，如 corshop@163.com';
$lang['smtp_user_name'] = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip'] = '如 B2B2C';
$lang['smtp_user_pwd'] = 'SMTP 身份验证密码';
$lang['smtp_user_pwd_tip'] = 'corshop@163.com邮件的密码，如 123456';
...
$lang['points_number_buyrate'] = '积分与现金兑换比例';
$lang['points_number_orderrate_tip'] = '例:设置为10，表明消费10单位货币赠送1积分';
$lang['points_number_buyrate_tip'] = '例:设置为200，表明200个积分可抵现金2元';
$lang['points_number_ordermax'] = '每订单最多赠送积分';
$lang['points_number_buymax'] = '抵现最多可使用的积分';
$lang['points_number_ordermax_tip'] = '例:设置为100，表明每订单赠送积分最多为100积分';
$lang['points_number_buymax_tip'] = '例:设置为78，表明前台购买商品最多可使用78点积分';
...
$lang['ftp_access_url_tip'] = '支持 HTTP 和 FTP 协议，结尾不要加斜杠“/”；如果使用 FTP 协议，FTP 服务器必需支持 PASV 模式，为了安全起见，使用 FTP 连接的帐号不要设置可写权限和列表权限。如果是根目录，直接输入域名即可，如“http://www.infol.com.cn”，如果非根目录，需要填写域名+目录形式，如“http://www.infol.com.cn/upload/b2b2c';
