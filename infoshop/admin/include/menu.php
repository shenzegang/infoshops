    ...
    'left' => array(
        ...
        1 => array(
            ...
            'list' => array(
                ...
                array(
                    'args' => 'sms,message,setting',
                    'text' => $lang['nc_sms_set']
                ),
                array(
                    'args' => 'system,payment,setting',
        ...
        3 => array(
            ...
            'list' => array(
                ...
                //增加保证金
                array(
                    'args' => 'store_deposit,store_deposit,store',
                    'text' => $lang['nc_deposit_shop']
                ),
                //增加商家保证金
                array(
                    'args' => 'seller_deposit,seller_deposit,store',
                    'text' => $lang['nc_seller_deposit_shop']
                ),
                //20150824 tjz 增加 类目审核选项
                array(
                    'args' => 'category_apply_check,store,store',
                    'text' => $lang['store_category_apply_check']
                ),
                //20150825 sj 增加 合同附件审核选项
                array(
                    'args' => 'agreement_check,store,store',
                    'text' => $lang['store_agreement_check']
                )
            )
        ),
        4 => array(
        ...
        5 => array(
            ...
            'list' => array(
                ...
                array(
                    'args' => 'return_manage,return,trade',
                    'text' => '退货管理'
                ),
                array(
        ...
        6 => array(
            ...
            'list' => array(
                ...
                array(
                    'args' => 'web_config,web_food,website',
                    'text' => '美食首页'
                ),
                array(
                ...
                array(
                    'args' => 'web_special_list,web_special,website',
        ...
        7 => array(
            ...
            'list' => array(
                ...
                //sj 20150915 修复左侧留言反馈打不开
                array(
                    'args' => 'list,feedback,operation',
                    'text' => '留言反馈'
                )
            )
        ),
...
if (C('mobile_isuse')) {
    ...
    $arr['left'][] = array(
        ...
        'list' => array(
            array(
                'args' => 'mb_home_list,mb_home,mobile',
                'text' => $lang['nc_mobile_homeset']
            ),
            array(
                'args' => 'mb_ad_list,mb_ad,mobile',
                'text' => $lang['nc_mobile_adset']
            ),
            array(
...
$arr['left'][] = array(
    ...
    'list' => array(
        1 => array(
            'args' => 'article,life_article,life',
            'text' => '文章管理'
        ),
        2 => array(
            'args' => 'article_class,life_article_class,life',
            'text' => '文章分类'
        ),
        3 => array(
            'args' => 'list,life_tag,life',
            'text' => 'TAG管理'
        ),
        4 => array(
            'args' => 'list,life_magazine,life',
            'text' => '杂志'
        ),
        5 => array(
            'args' => 'list,life_ask,life',
            'text' => '问吧'
        ),
        6 => array(
            'args' => 'list,life_info,life',
            'text' => '便民信息'
        ),
        7 => array(
            'args' => 'list,life_vote,life',
            'text' => '投票管理'
        )
    )
);
