...
class goodsControl extends SystemControl
{
    ...
    public function goodsOp()
    {
        ...
        if ($_GET['search_store_name'] != '') {
            $where['store_name'] = array(
                'like',
                '%' . trim($_GET['search_store_name']) . '%'
            );
        }
        ...
        if (in_array($_GET['search_state'], array(
            '0',
            '1',
            '10'
        ))) {
        ...
        if (in_array($_GET['search_verify'], array(
            '0',
            '1',
            '10'
        ))) {
