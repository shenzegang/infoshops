...
class web_specialControl extends SystemControl
{
    ...
    public function web_special_editOp()
    {
        ...
        $model_special = Model('web_special');
        $special_detail = $model_special->getOne(array(
    ...
    public function web_special_saveOp()
    {
        ...
        if (empty($_POST['special_id'])) {
            ...
            $model_special->modify($param, array(
    ...
    private function show_menu($menu_key)
    {
        $menu_array = array(
            'special_list' => array(
                ...
                'menu_url' => 'index.php?act=web_special&op=web_special_list'
            ),
            'special_add' => array(
                'menu_type' => 'link',
                'menu_name' => Language::get('nc_new'),
                'menu_url' => 'index.php?act=web_special&op=web_special_add'
            ),
            'special_edit' => array(
                'menu_type' => 'link',
