        ...
        if ($_POST['form_submit'] == 'ok') {
            ...
            $obj_validate->validateparam = array(
                array(
                    ...
                    "require" => "true",
                    "message" => L('link_add_title_null')
                ),
                array(
                    "input" => $_POST["link_keyword"],
                    "require" => "true",
                    "message" => L('link_add_url_wrong')
                ),
                array(
                    "input" => $_POST["link_sort"],
                    "require" => "true",
                    'validator' => 'Number',
                    "message" => L('link_add_sort_int')
                )
            );
    ...
    public function mb_ad_editOp()
    {
        ...
        if ($_POST['form_submit'] == 'ok') {
            ...
            if ($error != '') {
                ...
                $result = $model_mb_ad->editMbAd($update_array, array(
