...
class goods_classControl extends SystemControl
{
    ...
    private $links = array(
        array(
            'url' => 'act=goods_class&op=goods_class',
            'lang' => 'nc_manage'
        ),
        array(
            'url' => 'act=goods_class&op=goods_class_add',
            'lang' => 'nc_new'
        ),
        array(
            'url' => 'act=goods_class&op=goods_class_export',
            'lang' => 'goods_class_index_export'
        ),
        array(
            'url' => 'act=goods_class&op=goods_class_import',
            'lang' => 'goods_class_index_import'
        ),
        array(
            'url' => 'act=goods_class&op=tag',
            'lang' => 'goods_class_index_tag'
        )
    );
    ...
    public function goods_class_addOp()
    {
        ...
        if (chksubmit()) {
            ...
            if ($error != '') {
                ...
                //shijian 8-21 修复def_44
                //$insert_array['gc_sku'] = trim($_POST['gc_sku']);
        ...
        $type_list = $model_type->typeList(array(
            'order' => 'type_sort asc'
        ), '', 'type_id,type_name,class_id,class_name');
        $t_list = array();
    ...
    public function goods_class_editOp()
    {
        ...
        if (chksubmit()) {
            ...
            //shijian 8-21 修复def_44
            //$update_array['gc_sku'] = trim($_POST['gc_sku']);
    ...
    public function tag_resetOp()
    {
        ...
        // 商品分类
        $goods_class = $model_class->getTreeClassList(3, array(
    ...
    public function ajaxOp()
    {
        switch ($_GET['branch']) {
            ...
            case 'check_class_name':
                ...
                //shijian 8-21 修复def_44
                //$condition['gc_sku'] = trim($_GET['gc_sku']);
                $class_list = $model_class->getClassList($condition);
                if (empty($class_list)) {
                    echo 'true';
                    exit();
