...
class admin_logControl extends SystemControl
{
    ...
    private $links = array(
        array(
            'url' => 'act=admin_log&op=index',
            'lang' => 'ucenter_integration'
        )
    );
    ...
    private function createExcel($data = array())
    {
        ...
        foreach ((array) $data as $k => $v) {
            ...
            $tmp[] = array(
                'data' => date('Y-m-d H:i:s', $v['createtime'])
            );
            $tmp[] = array(
                'data' => $v['ip']
            );
