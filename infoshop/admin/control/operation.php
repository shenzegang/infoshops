...
class operationControl extends SystemControl
{
    ...
    private $links = array(
        array(
            'url' => 'act=operation&op=setting',
            'lang' => 'nc_operation_set'
        )
    );
    ...
    public function settingOp()
    {
        ...
        if (chksubmit()) {
            ...
            if ($error != '') {
                ...
                $update_array['points_buyrate'] = intval($_POST['points_buyrate']) ? $_POST['points_buyrate'] : 0;
                $update_array['points_buymax'] = intval($_POST['points_buymax']) ? $_POST['points_buymax'] : 0;
