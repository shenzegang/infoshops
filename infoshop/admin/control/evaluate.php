...
class evaluateControl extends SystemControl
{
    ...
    public function evalgoods_listOp()
    {
        ...
        if (! empty($_GET['store_name'])) {
            $condition['geval_storename'] = array(
                'like',
                '%' . $_GET['store_name'] . '%'
            );
        }
        $condition['geval_addtime'] = array(
            'time',
            array(
                strtotime($_GET['stime']),
                strtotime($_GET['etime'])
            )
        );
    ...
    public function evalgoods_delOp()
    {
        ...
        $result = $model_evaluate_goods->delEvaluateGoods(array(
            'geval_id' => $geval_id
        ));
    ...
    public function evalstore_listOp()
    {
        ...
        $condition['seval_addtime_gt'] = array(
            'time',
            array(
                strtotime($_GET['stime']),
                strtotime($_GET['etime'])
    ...
    public function evalstore_delOp()
    {
        ...
        $result = $model_evaluate_store->delEvaluateStore(array(
            'seval_id' => $seval_id
        ));
