...
class uploadControl extends SystemControl
{
    ...
    private $links = array(
        array(
            'url' => 'act=upload&op=param',
            'lang' => 'upload_param'
        ),
        array(
            'url' => 'act=upload&op=default_thumb',
            'lang' => 'default_thumb'
        ),
        array(
            'url' => 'act=upload&op=login',
            'lang' => 'loginSettings'
        ),
        array(
            'url' => 'act=upload&op=tool',
            'lang' => 'image_thumb_tool'
        ),
        array(
            'url' => 'act=upload&op=font',
            'lang' => 'font_set'
        )
    );
        ...
        if (chksubmit()) {
            ...
            $obj_validate->validateparam = array(
                array(
                    ...
                    "require" => "true",
                    "validator" => "Number",
                    "message" => L('upload_image_filesize_is_number')
                ),
                array(
                    "input" => trim($_POST["image_allow_ext"]),
                    "require" => "true",
                    "message" => L('image_allow_ext_not_null')
                )
            );
