...
<div class="warp-all picture-layout-b">
	<div class="sitenav-bar">
		<div class="sitenav"><?php echo $lang['current_location'];?><?php echo $lang['nc_colon'];?> <a
			...
			> <a
				href="<?php echo CMS_SITE_URL.DS.'index.php?act=picture&op=picture_list';?>"><?php echo $lang['cms_picture'];?></a> <?php echo empty($_GET['class_id'])?'':' > '.$output['picture_class_list'][$_GET['class_id']]['class_name'];?></div>
	</div>
	<div class="mainbox">
      ...
      <li>
				...
				<div class="thumb">
					<a href="<?php echo getCMSPictureUrl($value['picture_id']);?>"
						...
						alt="<?php echo $value['picture_title'];?>" class="t-img" /></a></span>
				</div>
				<p class="title">
					<a href="<?php echo getCMSPictureUrl($value['picture_id']);?>"
    ...
    <div class="no-content-b">
			<i class="picture"></i><?php echo $lang['no_record'];?></div>
    <?php } ?>
  </div>
	<div class="sidebar">
