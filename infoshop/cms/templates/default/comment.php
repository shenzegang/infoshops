...
<link type="text/css" rel="stylesheet"
	href="<?php echo SHOP_SITE_URL;?>/templates/default/css/home_login.css">
...
<div id="cms_comment_flag" class="article-comment-title">
	<h3></h3>
	<span><?php echo $lang['cms_comment1'];?><a
		href="<?php echo CMS_SITE_URL.DS;?>index.php?act=<?php echo $_GET['act'];?>&op=<?php echo $_GET['act'];?>_comment_detail&<?php echo $_GET['act'];?>_id=<?php echo $output['detail_object_id'];?>"><em><?php echo $output[$_GET['act'].'_detail'][$_GET['act'].'_comment_count'];?></em></a><?php echo $lang['cms_comment2'];?><em><?php echo $output[$_GET['act'].'_detail'][$_GET['act'].'_click'];?></em><?php echo $lang['cms_comment3'];?></span>
</div>
<form id="add_form" action="" class="article-comment-form">
	<input id="input_comment_type" name="comment_type" type="hidden"
		value="<?php echo $_GET['act'];?>" /> <input
		id="input_comment_object_id" name="comment_object_id" type="hidden"
		value="<?php echo $output['detail_object_id'];?>" />
	<textarea id="input_comment_message" name="comment_message"
		class="article-comment-textarea"></textarea>
	<input id="btn_comment_submit" type="button"
		class="article-comment-btn" value="发布" />
  <?php if($_SESSION['is_login'] != '1'){?>
  <div class="article-comment-login"><?php echo $lang['cms_comment4'];?><a
			id="btn_login" href="###">[<?php echo $lang['cms_login'];?>]</a><?php echo $lang['cms_comment5'];?></div>
  <?php }?>
</form>
<div id="comment_list" class="article-comment-list"></div>
<div id="comment_quote" style="display: none;">
	<a nctype="btn_comment_quote_cancel" href="JavaScript:;"
		class="cancel-btn" title="取消"></a>
	<textarea name="comment_quote" rows="3" cols="30"></textarea>
	<a nctype="btn_comment_quote_publish" href="JavaScript:;"
		class="publish-btn">发布</a>
</div>
