...
<ul id="cms_attitude_flag">
  <?php for ($i = 1; $i <= 6; $i++) { ?>
  <li nctype="article_attitude" attitude="<?php echo $i;?>"
		title="<?php echo $output['article_attitude_list'][$i];?>">
		<div class="article-attitude-percent-box">
			<em nctype="article_attitude_count"><?php echo $output['article_detail']['article_attitude_'.$i];?></em>
			<p class="article-attitude-percent-<?php echo $i;?>"
				nctype="article_attitude_percent"></p>
		</div> <img
		src="<?php echo CMS_TEMPLATES_URL;?>/images/attitude/<?php echo $i;?>.png"
		alt="" /> <span><?php echo $output['article_attitude_list'][$i];?></span>
	</li>
  <?php } ?>
</ul>
<div class="clear"></div>
