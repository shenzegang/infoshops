        ...
        <ol class="article-liked-top">
            ...
            <li>
				<div class="article-top">
					<em>0<?php echo $commend_count;?></em><span><i></i><?php echo $value['article_click'];?></span>
				</div>
				...
				<div class="article-title">
					<a href="<?php echo getCMSArticleUrl($value['article_id']);?>"><?php echo $value['article_title'];?></a>
				</div>
			</li>
            <?php $commend_count++;?>
            <?php } ?>
