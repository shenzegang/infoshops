...
<link href="<?php echo CMS_TEMPLATES_URL;?>/css/base.css"
	rel="stylesheet" type="text/css">
<link href="<?php echo CMS_TEMPLATES_URL;?>/css/layout.css"
	rel="stylesheet" type="text/css">
...
<script type="text/javascript"
	src="<?php echo CMS_RESOURCE_SITE_URL;?>/js/common.js" charset="utf-8"></script>
<script type="text/javascript">
...
$(function(){
	...
	<header id="topHeader">
      ...
      <?php } else { ?>
      <img
					src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_CMS.DS.$GLOBALS['setting_config']['cms_logo'];?>">
      <?php } ?>
      </a>
			</div>
			<div class="search-cms" id="searchCMS">
				<ul class="tab">
					<li <?php if($_GET['act'] != 'picture' ) echo 'class="current"'; ?>
						action="<?php echo CMS_SITE_URL.DS;?>index.php" act="article"
						op="article_search"><?php echo $lang['cms_article'];?><i></i></li>
					<li <?php if($_GET['act'] == 'picture' ) echo 'class="current"'; ?>
						action="<?php echo CMS_SITE_URL.DS;?>index.php" act="picture"
						op="picture_search"><?php echo $lang['cms_picture'];?><i></i></li>
				...
				<div class="form-box">
					<form id="form_search" method="get" action="">
						<input id="act" name="act" type="hidden" /> <input id="op"
							name="op" type="hidden" /> <input id="keyword" name="keyword"
