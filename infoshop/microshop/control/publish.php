...
class publishControl extends MircroShopControl
{
    ...
    private function get_commend_goods_list()
    {
        ...
        $commend_goods_list = $model_microshop_goods->getList(array(
            'commend_member_id' => $_SESSION['member_id']
        ));
    ...
    public function goods_saveOp()
    {
        ...
        $goods_relation = $model_goods_relation->getOne(array(
            'shop_class_id' => $goods_info['gc_id']
        ));
        ...
        if (empty($goods_relation)) {
            ...
            $default_class = $model_goods_class->getOne(array(
                'class_default' => 1
            ));
