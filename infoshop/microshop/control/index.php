...
class indexControl extends MircroShopControl
{
    ...
    public function indexOp()
    {
        ...
        foreach ($goods_class_root as $value) {
            ...
            $condition_goods['class_id'] = array(
                'in',
                rtrim($goods_class_root_children[$value['class_id']], ',')
            );
        ...
        $store_list1 = $model_micro_store->getListWithStoreInfo($condition_personal, null, 'like_count desc', '*', 5);
        Tpl::output('store_list1', $store_list1);
        
        $store_list2 = $model_micro_store->getListWithStoreInfo($condition_personal, null, 'click_count desc', '*', 5);
        Tpl::output('store_list2', $store_list2);
        
        $store_list3 = $model_micro_store->getListWithStoreInfo($condition_personal, null, 'microshop_store_id desc', '*', 5);
        Tpl::output('store_list3', $store_list3);
        Tpl::showpage('index');
    }
}
