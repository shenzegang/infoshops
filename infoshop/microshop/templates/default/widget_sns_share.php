...
<div id="div_sns_share" style="display: none;">
	<form
		action="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=share&op=share_save&type=<?php echo $_GET['act'];?>"
		method="post" id="share_form" class="feededitor">
        <?php if($_GET['act'] == 'goods') { ?>
        <input type="hidden"
			value="<?php echo $output['detail']['commend_id'];?>" name="share_id"
			id="share_id"></input>
		<div class="command-goods">
			<div class="pic">
                ...
                <img src="<?php echo $image_url;?>"
					...
					alt="<?php echo $output['detail']['commend_goods_name'];?>" /> </a>
				</span>
			</div>
        ...
        <input type="hidden"
			value="<?php echo $output['detail']['personal_id'];?>"
        ...
        <input type="hidden"
			value="<?php echo $output['detail']['microshop_store_id'];?>"
			name="share_id" id="share_id"></input>
		<div class="command-goods">
			<div class="pic">
		...
		<div class="handle">
			<input id="btn_publish" type="button"
				value="<?php echo $lang['microshop_text_share'];?>" />
			<!-- 站外分享 -->
