...
<div class="title-bar">
	...
	<a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?act=store"
		class="more" target="_blank"><?php echo $lang['nc_more'];?></a>
</div>
<div class="contnet-box">
    ...
    <li class="overall" style="display: none;"><i><?php echo $i;?></i>
			<dl class="store-intro">
				...
				<dd>
					<a
						href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?act=store&op=detail&store_id=<?php echo $value['microshop_store_id'];?>"
						target="_blank"><?php echo $lang['micro_api_store_info'];?></a>
				</dd>
			</dl></li>
