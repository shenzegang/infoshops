...
<div class="commend-goods-list">
	<ul id="pinterest">
        ...
        <!-- 个人主页删除按钮 -->
			<div class="del">
				<a nc_type="home_drop" type="goods"
					item_id="<?php echo $value['commend_id'];?>"
					href="javascript:void(0)" title="<?php echo $lang['nc_delete'];?>"><?php echo $lang['nc_delete'];?></a>
			</div>
        <?php } ?>
        <?php } ?>
        <div class="picture">
				<a
					href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=goods&op=detail&goods_id=<?php echo $value['commend_id'];?>"
					target="_blank">
				...
				<div class="price"> <?php echo $lang['currency'];?><strong><?php echo ncPriceFormat($value['commend_goods_price']);?></strong>
				</div>
			...
			<div class="handle">
				...
				<span class="comment"><a
					href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=goods&op=detail&goods_id=<?php echo $value['commend_id'];?>"
					target="_blank"><i title="<?php echo $lang['microshop_comment'];?>"
...
<div class="no-content">
	...
	<a
		href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=publish&op=goods_buy';?>"><?php echo $lang['microshop_goods_publish'];?></a>
            <?php } else { ?>
