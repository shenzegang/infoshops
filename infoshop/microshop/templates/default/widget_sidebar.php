...
<div class="title mt10">
	...
	<span><a
		href="<?php echo MICROSHOP_SITE_URL.DS?>index.php?act=home&op=goods&member_id=<?php echo $output['detail']['commend_member_id'];?>"><?php echo $lang['nc_common_more'];?></a></span>
</div>
    ...
    <li>
			<div class="picture">
				<span class="thumb size60"><i></i><a
					...
					target="_blank" titel="<?php echo $value['commend_goods_name'];?>">
...
<div class="title mt50">
	...
	<span><a
		href="<?php echo MICROSHOP_SITE_URL.DS?>index.php?act=home&op=personal&member_id=<?php echo $output['detail']['commend_member_id'];?>"><?php echo $lang['nc_common_more'];?></a></span>
</div>
