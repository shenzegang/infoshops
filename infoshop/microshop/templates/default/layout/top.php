...
<link href="<?php echo MICROSHOP_TEMPLATES_URL;?>/css/base.css"
	rel="stylesheet" type="text/css">
<link href="<?php echo MICROSHOP_TEMPLATES_URL;?>/css/layout.css"
	rel="stylesheet" type="text/css">
...
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.js" charset="utf-8"></script>
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery-ui/jquery.ui.js"></script>
<script id="dialog_js" type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/dialog/dialog.js"
	charset="utf-8"></script>
<script type="text/javascript"
	src="<?php echo MICROSHOP_RESOURCE_SITE_URL;?>/js/jquery.masonry.js"
	charset="utf-8"></script>
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/common.js" charset="utf-8"></script>
<script type="text/javascript"
	src="<?php echo MICROSHOP_RESOURCE_SITE_URL;?>/js/common.js"
	charset="utf-8"></script>
<script type="text/javascript">
			...
			<div class="quick-menu">
				...
				<dl>
					...
					<dd>
						<ul>
							<li><a
								href="<?php echo SHOP_SITE_URL;?>/index.php?act=article&ac_id=2">帮助中心</a></li>
							<li><a
								href="<?php echo SHOP_SITE_URL;?>/index.php?act=article&ac_id=5">售后服务</a></li>
							<li><a
								href="<?php echo SHOP_SITE_URL;?>/index.php?act=article&ac_id=6">客服中心</a></li>
						</ul>
					</dd>
				</dl>
				<dl>
	...
	<header id="topHeader">
		<div class="warp-all">
			<div class="micro-logo">
				<a href="<?php echo MICROSHOP_SITE_URL;?>">
      <?php if(C('microshop_logo')) { ?>
      <img src="<?php echo MICROSHOP_IMG_URL.DS.C('microshop_logo');?>"
					class="pngFix">
      <?php } else { ?>
      <img
					src="<?php echo MICROSHOP_IMG_URL.DS.'default_logo_image.png';?>"
					class="pngFix">
      <?php } ?>
      </a>
			</div>
			<div class="micro-header-pic">
				<a href="<?php echo MICROSHOP_SITE_URL;?>">
      <?php if(C('microshop_header_pic')) { ?>
      <img
					src="<?php echo MICROSHOP_IMG_URL.DS.C('microshop_header_pic');?>"
					class="pngFix">
      <?php } else { ?>
      <img
					src="<?php echo MICROSHOP_IMG_URL.DS.'default_header_pic_image.png';?>"
					class="pngFix">
      <?php } ?>
      </a>
			</div>
          ...
          <span id="micro_search_type"
							search_type="<?php echo $_GET['act'];?>"><?php echo $output['search_type'][$_GET['act']];?></span>
          <?php } else { ?>
          <span id="micro_search_type"
							search_type="<?php echo key($output['search_type']);?>"><?php echo current($output['search_type']);?></span>
          <?php } ?>
          <i></i>
					</div>
					<ul class="ms-list" id="micro_search_type_list"
						style="display: none;">
          ...
          <?php } ?>
				...
				<div class="ms-form">
					<form id="form_search" method="get"
						action="<?php echo MICROSHOP_SITE_URL;?>/index.php">
          <?php if(in_array($_GET['act'],array_keys($output['search_type']))) { ?>
          ...
          <input name="goods_class_root_id" type="hidden"
							value="<?php echo $_GET['goods_class_root_id'];?>" />
          <?php } ?>
          <?php if(isset($_GET['goods_class_menu_id'])) { ?>
          <input name="goods_class_menu_id" type="hidden"
							value="<?php echo $_GET['goods_class_menu_id'];?>" />
          <?php } ?>
	...
	<div id="navBar" class="pngFix">
		<div id="navBox">
			<ul class="nc-nav-menu">
				<li
					<?php echo $output['index_sign'] == 'index'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a
					href="<?php echo MICROSHOP_SITE_URL;?>" class="pngFix"><span
						class="pngFix"><?php echo $lang['nc_index'];?></span></a></li>
				<li
					<?php echo $output['index_sign'] == 'goods'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a
					href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=goods"
					class="pngFix"><span class="pngFix"><?php echo $lang['nc_microshop_goods'];?></span></a></li>
				<!--
      ...
      -->
				<li
					<?php echo $output['index_sign'] == 'personal'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a
					href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=personal"
					class="pngFix"><span class="pngFix"><?php echo $lang['nc_microshop_personal'];?></span></a></li>
				<li
					<?php echo $output['index_sign'] == 'store'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a
					href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=store"
					class="pngFix"><span class="pngFix"><?php echo $lang['nc_microshop_store'];?></span></a></li>
			</ul>
      ...
      <div class="head-portrait">
					<span class="thumb size32"
						title="<?php echo $_SESSION['member_name'];?>"><i></i><img
						src="<?php echo $member_avatar;?>"
						onload="javascript:DrawImage(this,30,30);" /></span>
				</div>
				<ul class="sub-menu">
        <?php if(isset($_SESSION['is_login'])) {?>
        <li class="pngFix"><a href="javascript:void(0)"><span
							title="<?php echo $_SESSION['member_name'];?>"><?php echo $_SESSION['member_name'];?></span><i></i></a>
						<ul>
							<li><a
								href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=home&op=goods'?>"><?php echo $lang['nc_microshop_goods'];?></a></li>
							<li><a
								href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=home&op=personal'?>"><?php echo $lang['nc_microshop_personal'];?></a></li>
							<!--
            <li> <a href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=home&op=album'?>"><?php echo $lang['nc_microshop_album'];?></a> </li>
            -->
						</ul></li>
        <?php } else { ?>
        <li class="no-sub pngFix"><a
						href="<?php echo SHOP_SITE_URL.'/index.php?act=login&ref_url='.getRefUrl();?>"><?php echo $lang['nc_login'];?></a></li>
        <?php } ?>
        <li class="pngFix"><a href="javascript:void(0)"><?php echo $lang['nc_publish'];?><i></i></a>
						<ul>
							<li><a
								href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=publish&op=goods_buy';?>"><?php echo $lang['microshop_goods_buy'];?></a>
							</li>
							<li><a
								href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=publish&op=goods_favorites';?>"><?php echo $lang['microshop_goods_favorite'];?></a>
							</li>
							<li><a
								href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=home&op=personal&publish=personal';?>"><?php echo $lang['nc_microshop_personal'];?></a>
							</li>
							<!--
            ...
            -->
					...
					<li class="pngFix"><a href="javascript:void(0)"><?php echo $lang['microshop_text_like'];?><i></i></a>
						<ul>
							<li><a
								href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=home&op=like_list&type=goods'?>"><?php echo $lang['nc_microshop_goods'];?></a>
							</li>
							<!--
            ...
            -->
							<li><a
								href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=home&op=like_list&type=personal'?>"><?php echo $lang['nc_microshop_personal'];?></a>
							</li>
							<li><a
								href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=home&op=like_list&type=store'?>"><?php echo $lang['nc_microshop_store'];?></a>
							</li>
						</ul></li>
				</ul>
			</div>
