			...
			<dl>
				<dt>
					<a
						...
						data-param="{'id':<?php echo $output['detail']['member_id'];?>}"> <?php echo $output['detail']['member_name'];?></a><?php echo $lang['microshop_personal_commend'];?><span
		...
		<div class="goods">
          ...
          <div class="buy-info">
            ...
            <dl>
							...
							<dd>
								<a href="<?php echo $val['link'];?>" class="goods-name"
									title="<?php echo $val['title'];?>" target="_blank"><?php echo $val['title'];?></a>
          ...
          <?php } ?>
				...
				<div class="buttons">
					<a nc_type="microshop_like"
						like_id="<?php echo $output['detail']['personal_id'];?>"
						href="javascript:void(0)" class="like"><i></i><em><?php echo $output['detail']['like_count']<=999?$output['detail']['like_count']:'999+';?></em></a><a
						id="btn_sns_share" href="javascript:void(0)" class="share"><i></i><?php echo $lang['microshop_text_share'];?><em></em></a>
				</div>
			</div>
