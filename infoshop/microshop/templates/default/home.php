...
<div class="user-page-top">
	<div class="user-info-box">
		...
		<dl class="user-intro">
          ...
          <?php }?>
      </span> <span class="location"><?php echo $output['member_info']['member_areainfo'];?></span>
      <?php if(isset($output['follow_flag'])) { ?>
      <a id="btn_sns_addfollow" href="javascript:void(0)"
					<?php if(!$output['follow_flag']){ echo "style='display:none;'";}?>><?php echo $lang['microshop_text_follow_add'];?></a>
				<a id="btn_sns_delfollow" href="javascript:void(0)"
					<?php if($output['follow_flag']){ echo "style='display:none;'";}?>><?php echo $lang['microshop_text_follow_del'];?></a>
      <?php } ?>
      </dd>
		</dl>
		<div class="user-stat">
...
<div class="user-page-nav">
	<ul>
		<li
			<?php echo $output['home_sign'] == 'goods'?'class="current"':'class="link"'; ?>><a
			href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=home&op=goods&member_id=<?php echo $output['member_info']['member_id'];?>"
			class="pngFix"><i class="link2 pngFix"></i><span><?php echo $lang['nc_microshop_goods'];?></span></a></li>
		<!--
        ...
        -->
		<li
			<?php echo $output['home_sign'] == 'personal'?'class="current pngFix"':'class="link pngFix"'; ?>><a
			href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=home&op=personal&member_id=<?php echo $output['member_info']['member_id'];?>"
			class="pngFix"><i class="link4 pngFix"></i><span><?php echo $lang['nc_microshop_personal'];?></span></a></li>
		<li
			<?php echo $output['home_sign'] == 'like'?'class="current pngFix"':'class="link pngFix"'; ?>><a
			href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=home&op=like_list&member_id=<?php echo $output['member_info']['member_id'];?>"
			class="pngFix"><i class="link5 pngFix"></i><span><?php echo $lang['nc_microshop_like'];?></span></a></li>
	</ul>
</div>
<?php
