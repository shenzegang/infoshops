...
<div class="microshop-store-list">
  ...
  <!-- 喜欢删除按钮 -->
	<div class="del">
		<a nc_type="like_drop"
			like_id="<?php echo $output['like_store_list'][$value['store_id']]['like_id'];?>"
			href="javascript:void(0)" title="<?php echo $lang['nc_delete'];?>">&nbsp;</a>
	</div>
  <?php } ?>
  <?php } ?>
  <div class="top">
		<span class="goods-count"><strong><?php echo $value['goods_count'];?></strong><?php echo $lang['microshop_text_jian'].$lang['microshop_text_goods'];?></span>
		<h2>
			<a
				href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=store&op=detail&store_id='.$value['microshop_store_id'];?>"><?php echo $value['store_name'];?></a>
		</h2>
	</div>
	<div style="zoom: 1;">
		<div class="microshop-store-info">
			...
			<dl>
				...
				<dd>
					<strong nctype="store_collect"><?php echo $value['store_collect']?></strong><?php echo $lang['nc_person'];?><?php echo $lang['nc_collect'];?></dd>
			</dl>
			<div class="handle">
				<span class="like-btn"><a nc_type="microshop_like"
					like_id="<?php echo $value['microshop_store_id'];?>"
				...
				<span class="comment"><a
					href="<?php echo MICROSHOP_SITE_URL.'/index.php?act=store&op=detail&store_id='.$value['microshop_store_id'];?>"><i
						class="pngFix"
						title="<?php echo $lang['microshop_text_comment'];?>">&nbsp;</i><em><?php echo $value['comment_count']<=999?$value['comment_count']:'999+';?></em></a></span>
			</div>
		</div>
