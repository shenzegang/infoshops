...
class store_snshomeControl extends BaseStoreSnsControl
{
    ...
    public function commenttopOp()
    {
        ...
        if ($stid > 0) {
            ...
            // 更新评论数量
            Model('store_sns_tracelog')->editStoreSnsTracelog(array(
                'strace_comment' => $countnum
            ), array(
                'strace_id' => $stid
            ));
        }
    ...
    public function commentlistOp()
    {
        ...
        if ($stid > 0) {
            ...
            // 更新评论数量
            $commentlist = Model('store_sns_tracelog')->editStoreSnsTracelog(array(
                'strace_comment' => $countnum
            ), array(
                'strace_id' => $stid
            ));
    ...
    public function addforwardOp()
    {
        ...
        // 查询原帖信息
        $model_stracelog = Model('store_sns_tracelog');
        $stracelog_info = $model_stracelog->getStoreSnsTracelogInfo(array(
            'strace_id' => $stid
        ));
    ...
    public function deltraceOp()
    {
        ...
        // 删除动态
        $result = Model('store_sns_tracelog')->delStoreSnsTracelog(array(
            'strace_id' => $stid,
    ...
    public function straceinfoOp()
    {
        ...
        $model_stracelog = Model('store_sns_tracelog');
        $strace_info = $model_stracelog->getStoreSnsTracelogInfo(array(
            'strace_id' => $stid
        ));
