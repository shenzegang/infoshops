...
class store_plateControl extends BaseSellerControl
{
    ...
    public function plate_listOp()
    {
        ...
        if (trim($_GET['p_name']) != '') {
            $where['plate_name'] = array(
                'like',
                '%' . trim($_GET['p_name']) . '%'
            );
        }
        if (in_array($_GET['p_position'], array(
            '0',
            '1'
        ))) {
    ...
    public function plate_editOp()
    {
        ...
        $plate_info = Model('store_plate')->getPlateInfo(array(
            'plate_id' => $plate_id,
    ...
    public function drop_plateOp()
    {
        ...
        $return = Model('store_plate')->delPlate(array(
            'plate_id' => array(
                'in',
                $plateid_array
            ),
