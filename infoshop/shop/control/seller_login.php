...
class seller_loginControl extends BaseSellerControl
{
    ...
    public function __construct()
    {
        ...
        if (!empty($_SESSION['seller_id'])) {
        	...
        	@header('location: index.php?act=show_joinin');
        	exit();
        }
    }
    ...
    public function show_loginOp()
    {
    	...
    	$ref_url = C('shop_site_url') . '/index.php?act=seller_login'; 
    	echo '<script language="javascript">window.location.href="index.php?act=login&ref_url=' . urlencode($ref_url) . '"</script>';
        /*
    ...
    public function loginOp()
    {
        ...
        if ($seller_info) {
            ...
            if ($member_info) {
                ...
                $seller_group_info = $model_seller_group->getSellerGroupInfo(array(
                    'group_id' => $seller_info['seller_group_id']
                ));
