...
class store_accountControl extends BaseSellerControl
{
    ...
    public function account_listOp()
    {
        ...
        $seller_group_list = $model_seller_group->getSellerGroupList(array(
            'store_id' => $_SESSION['store_id']
        ));
    ...
    public function account_saveOp()
    {
        ...
        */
        ...
        if ($result) {
        	$model_seller -> editSeller(array('seller_name' => $_SESSION['member_name'] . ':' . $member_name), array('seller_id' => $result));
