...
class store_promotion_mansongControl extends BaseSellerControl
{
    ...
    public function mansong_quota_add_saveOp()
    {
        ...
        if (empty($current_mansong_quota)) {
            ...
            $model_mansong_quota->editMansongQuota($param, array(
                'quota_id' => $current_mansong_quota['quota_id']
            ));
        }
        ...
        switch ($menu_key) {
            ...
            case 'mansong_detail':
                $menu_array[] = array(
                    ...
                    'menu_url' => urlShop('store_promotion_mansong', 'mansong_detail', array(
