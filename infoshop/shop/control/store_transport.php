...
class store_transportControl extends BaseSellerControl
{
    ...
    public function listOp()
    {
        ...
        $list = $model_transport->getTransportList(array(
    ...
    public function editOp()
    {
        ...
        $id = intval($_GET['id']);
        $model_transport = Model('transport');
        $transport = $model_transport->getTransportInfo(array(
            'id' => $id
        ));
        $extend = $model_transport->getExtendInfo(array(
            'transport_id' => $id
        ));
    ...
    public function deleteOp()
    {
        ...
        if ($model_transport->delTansport(array(
            'id' => $id
        ))) {
