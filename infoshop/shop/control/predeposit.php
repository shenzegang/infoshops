...
class predepositControl extends BaseMemberControl
{
    ...
    public function pd_log_listOp()
    {
        ...
        if($resp['returnStatus'] == '000' && !empty($userInfo)){
        	...
        	$member_info['freeze_predeposit'] = floatval($userInfo['blockedBalance']);
        }else{
    ...
    public function pd_cash_addOp()
    {
        if (chksubmit()) {
            ...
            $member_info = $member_model->infoMember(array(
                'member_id' => $_SESSION['member_id']
            ), 'member_id,available_predeposit');
            Tpl::output('member_info', $member_info);
        ...
        switch ($menu_type) {
            case 'recharge':
                $menu_array = array(
                    array(
                        ...
                        'menu_name' => Language::get('nc_member_path_predeposit_rechargelist'),
            ...
            case 'rechargeinfo':
                $menu_array = array(
                    ...
                    3 => array(
                        'menu_key' => 'rechargeinfo',
                        'menu_name' => Language::get('nc_member_path_predeposit_rechargeinfo'),
                        'menu_url' => ''
                    )
                );
                break;
            case 'log':
                $menu_array = array(
                    1 => array(
                        'menu_key' => 'loglist',
                        'menu_name' => Language::get('nc_member_path_predeposit_loglist'),
            ...
            case 'cash':
                $menu_array = array(
                    array(
                        'menu_key' => 'cashlist',
                        'menu_name' => Language::get('nc_member_path_predeposit_cashlist'),
            ...
            case 'cashadd':
                $menu_array = array(
                    ...
                    array(
                        'menu_key' => 'cashadd',
                        'menu_name' => Language::get('nc_member_path_predeposit_cashadd'),
            ...
            case 'cashinfo':
                $menu_array = array(
                    ...
                    array(
                        'menu_key' => 'cashinfo',
                        'menu_name' => Language::get('nc_member_path_predeposit_cashinfo'),
                        'menu_url' => ''
                    )
                );
                break;
