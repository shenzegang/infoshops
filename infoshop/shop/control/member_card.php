...
class member_cardControl extends BaseHomeControl
{
    ...
    public function indexOp()
    {
        ...
        $member_info = $model->table('member')
            ->field('member_id, member_name, member_truename, member_sex, member_email, member_qq, member_ww, member_areainfo, member_birthday, member_privacy')
            ->find($uid);
        ...
        $data['attention_count'] = $model->table('sns_friend')
            ->where(array(
            'friend_frommid' => $uid
        ))
            ->count();
        ...
        // Number of fans
        $data['fans_count'] = $model->table('sns_friend')
            ->where(array(
            'friend_tomid' => $uid
        ))
            ->count();
