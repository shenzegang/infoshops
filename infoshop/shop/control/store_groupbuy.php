...
class store_groupbuyControl extends BaseSellerControl
{
    ...
    public function groupbuy_quota_add_saveOp()
    {
        ...
        if (empty($current_groupbuy_quota)) {
            ...
            $model_groupbuy_quota->editGroupbuyQuota($param, array(
                'quota_id' => $current_groupbuy_quota['quota_id']
            ));
        }
    ...
    public function groupbuy_goods_infoOp()
    {
        ...
        $data['goods_href'] = urlShop('goods', 'index', array(
        ...
        switch ($menu_key) {
            case 'groupbuy_add':
                $menu_array[] = array(
                    ...
                    'menu_url' => 'index.php?act=store_groupbuy&groupbuy_add'
                );
                break;
            ...
            case 'cancel':
                $menu_array[] = array(
                    'menu_key' => 'groupbuy_cancel',
                    'menu_name' => L('nc_member_path_cancel_group')
                );
                break;
        }
