...
class store_albumControl extends BaseSellerControl
{
    ...
    public function album_cateOp()
    {
         ...
         * 验证是否存在默认相册
         */
        $return = $model_album->checkAlbum(array(
    ...
    public function album_delOp()
    {
        ...
        $return = $model_album->updatePic($param, array(
    ...
    public function change_album_coverOp()
    {
        ...
        if ($return) {
            $re = $model_album->updateClass(array(
                'aclass_cover' => $pic_info['apic_cover']
            ), $pic_info['aclass_id']);
            if ($re) {
    ...
    public function change_pic_nameOp()
    {
        ...
        $return = $model_album->updatePic(array(
            'apic_name' => $_POST['name']
        ), array(
            'apic_id' => intval($_POST['id'])
        ));
        if ($return) {
            echo 'true';
        } else {
    ...
    public function image_uploadOp()
    {
        ...
        $album_count = Model('album')->getCount(array(
            'store_id' => $store_id
        ));
