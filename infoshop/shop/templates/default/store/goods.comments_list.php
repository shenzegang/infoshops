		...
		<div class="ncs-goods-main" id="main-nav-holder">
			<div class="ncs-comment">
				<div class="ncs-goods-title-bar">
					<h4><?php echo $lang['goods_index_evaluation'];?></a>
					</h4>
				</div>
				<div class="ncs-goods-info-content bd" id="ncGoodsRate">
					...
					<div class="ncs-goods-title-nav">
						<ul id="comment_tab">
							<li <?php echo empty($output['type'])?'class="current"':'';?>><a
								href="<?php echo urlShop('goods', 'comments_list', array('goods_id' => $output['goods']['goods_id']));?>"><?php echo $lang['goods_index_evaluation'];?>(<?php echo $output['goods_evaluate_info']['all'];?>)</a></li>
            ...
            <div id="t" class="ncs-commend-floor">
							<div class="user-avatar">
								...
								<?php } else { ?>
									<a
										...
										nctype="mcard"><img
											src="<?php echo getMemberAvatarForID($v['geval_frommemberid']);?>"></a>
								<?php } ?>
							</div>
							<dl class="detail">
								<dt>
                  ...
                  <?php }?>
								...
								<dd>
									用户评分：<span class="raty"
										data-score="<?php echo $v['geval_scores'];?>"></span>
								</dd>
								<dd class="content">
									评价详情：<span><?php echo $v['geval_content'];?></span>
								</dd>
                <?php if (!empty($v['geval_explain'])){?>
                <dd class="explain"><?php echo $lang['nc_credit_explain'];?>：<span><?php echo $v['geval_explain'];?></span>
								</dd>
                <?php }?>
			...
			<div class="nc-s-c-s1">
				...
				<div class="content">
					<dl class="ncs-comment-goods">
						<dt class="goods-name">
							<a
								href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['goods']['goods_id']));?>"> <?php echo $output['goods']['goods_name']; ?> </a>
						</dt>
						<dd class="goods-pic">
							<a
								href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['goods']['goods_id']));?>">
								<img
								src="<?php echo cthumb($output['goods']['goods_image'], 240); ?>"
								alt="<?php echo $output['goods']['goods_name']; ?>">
							</a>
						</dd>
						<dd class="goods-price"><?php echo $lang['goods_index_goods_price'].$lang['nc_colon'];?><em
								class="saleP"><?php echo $lang['currency'].$output['goods']['goods_price'];?></em>
						</dd>
						<dd class="goods-raty"><?php echo $lang['goods_index_evaluation'].$lang['nc_colon'];?> <span
								class="raty"
								data-score="<?php echo $output['goods_evaluate_info']['good_star'];?>"></span>
						</dd>
					</dl>
				</div>
				<!--S 店铺信息-->
