			...
			<div class="nc-s-c-s3 ncg-list">
              ...
              <?php if(!empty($_GET['stc_id'])){echo $output['stc_name'];}elseif(!empty($_GET['keyword'])){echo $lang['show_store_index_include'].$_GET['keyword'].$lang['show_store_index_goods'];}else{ echo $lang['nc_whole_goods']; }?>
				...
				<div class="ncs-goodslist-bar">
					<ul class="ncs-array">
						<li class='<?php echo $_GET['key'] == '1'?'selected':'';?>'><a
							<?php if($_GET['key'] == '1'){?>
							class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"
							<?php }?>
							href="<?php echo ($_GET['key'] == '1' && $_GET['order'] == '2') ? replaceParam(array('key' => '1', 'order'=>'1')) : replaceParam(array('key' => '1', 'order' => '2'));?>"><?php echo $lang['show_store_all_new'];?></a></li>
						<li class='<?php echo $_GET['key'] == '2'?'selected':'';?>'><a
							<?php if($_GET['key'] == '2'){?>
							class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"
							<?php }?>
							href="<?php echo ($_GET['key'] == '2' && $_GET['order'] == '2') ? replaceParam(array('key' => '2', 'order'=>'1')) : replaceParam(array('key' => '2', 'order' => '2'));?>"><?php echo $lang['show_store_all_price'];?></a></li>
						<li class='<?php echo $_GET['key'] == '3'?'selected':'';?>'><a
							<?php if($_GET['key'] == '3'){?>
							class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"
							<?php }?>
							href="<?php echo ($_GET['key'] == '3' && $_GET['order'] == '2') ? replaceParam(array('key' => '3', 'order'=>'1')) : replaceParam(array('key' => '3', 'order' => '2'));?>"><?php echo $lang['show_store_all_sale'];?></a></li>
						<li class='<?php echo $_GET['key'] == '4'?'selected':'';?>'><a
							<?php if($_GET['key'] == '4'){?>
							class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"
							<?php }?>
							href="<?php echo ($_GET['key'] == '4' && $_GET['order'] == '2') ? replaceParam(array('key' => '4', 'order'=>'1')) : replaceParam(array('key' => '4', 'order' => '2'));?>"><?php echo $lang['show_store_all_collect'];?></a></li>
						<li class='<?php echo $_GET['key'] == '5'?'selected':'';?>'><a
							<?php if($_GET['key'] == '5'){?>
							class="<?php echo $_GET['order'] == 1 ? 'asc' : 'desc';?>"
							<?php }?>
							href="<?php echo ($_GET['key'] == '5' && $_GET['order'] == '2') ? replaceParam(array('key' => '5', 'order'=>'1')) : replaceParam(array('key' => '5', 'order' => '2'));?>"><?php echo $lang['show_store_all_click'];?></a></li>
					</ul>
				</div>
				<div class="content">
							...
							<dl>
								<dt>
									<a
										...
										target="_blank"><?php echo $value['goods_name']?></a>
								</dt>
								<dd class="ncg-pic pngFix">
									<a
										href="<?php echo urlShop('goods', 'index',array('goods_id'=>$value['goods_id']));?>"
										target="_blank" class="thumb size160"><i></i><img
								...
								<dd class="ncg-price">
									<em class="price"><?php echo $lang['currency'];?>
