...
<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/home_goods.css"
	rel="stylesheet" type="text/css">
<style type="text/css">
...
<div id="content" class="wrapper pr">
    ...
    <div class="ncs-inform">
			<span><?php echo $lang['goods_index_inform'];?><i></i></span><a
				href="index.php?act=member_inform&op=inform_submit&goods_id=<?php echo $output['goods']['goods_id'];?>"
				title="<?php echo $lang['goods_index_goods_inform'];?>"><?php echo $lang['goods_index_goods_inform'];?></a>
		</div>
    <?php } ?>
    <!-- End -->
		...
		<div class="ncs-goods-summary">
			<div class="name">
				...
				<strong><?php echo $output['goods']['goods_jingle'];?></strong>
			</div>
			<div class="ncs-meta">
				<!-- S 商品参考价格 -->
				<dl>
            ...
            <?php if ($output['xianshi_info']['xianshi_title'] != '') {?><span
							class="tag"><?php echo $output['xianshi_info']['xianshi_title'];?></span><?php }?><strong><?php echo $lang['currency'].$output['goods']['promotion_price'];?></strong><em>(原售价<?php echo $lang['nc_colon'];?><?php echo $lang['currency'].$output['goods']['goods_price'];?>)</em>
            <?php } else {?>
        ...
        <dl>
          ...
          <?php } ?>
          </em> <span><?php echo $output['xianshi_info']['xianshi_explain'];?></span>
					</dd>
				</dl>
        <?php }?>
        <!-- E 限时优惠  -->
        ...
        <dl>
          ...
          <?php } ?>
          </em> <span><?php echo $output['goods']['remark'];?></span>
					</dd>
				</dl>
        <?php }?>
        <!-- E 团购 -->
				...
				<dl>
					...
					<dd>
						<div class="raty"
							data-score="<?php echo $output['goods_evaluate_info']['good_star'];?>"></div>
						<a href="#ncGoodsRate">(<?php echo $output['goods_evaluate_info']['all'];?><?php echo $lang['goods_index_number_of_consult'];?>)</a>
					</dd>
				</dl>
				<!-- E 描述相符评分及评价数量 -->
				<!-- S 物流运费 -->
            ...
            <?php echo $lang['goods_index_trans_to'];?><a
							href="javascript:void(0)" id="ncrecive"><?php echo $lang['goods_index_trans_country'];?></a><?php echo $lang['nc_colon'];?>
            ...
            <?php }?>
				...
				<dl>
					...
					<dd>
						<strong><a href="#ncGoodsTraded"><?php echo $output['goods']['goods_salenum']; ?></a></strong>&nbsp;<?php echo $lang['nc_jian'];?></dd>
				</dl>
				<!-- E 累计售出数量 -->
            ...
            <ul nctyle="ul_sign">
              ...
              <!-- 图片类型规格-->
							<li class="sp-img"><a href="javascript:void(0);"
								class="<?php if (isset($output['goods']['goods_spec'][$k])) {echo 'hovered';}?>"
								data-param="{valid:<?php echo $k;?>}" title="<?php echo $v;?>"><img
									src="<?php echo $output['spec_image'][$k];?>" /><i></i></a></li>
              <?php }else{?>
              <!-- 文字类型规格-->
        ...
        <!-- E 商品规格值-->
				...
				<dl>
					...
					<dd class="ncs-figure-input">
						<input type="text" name="" id="quantity" value="1" size="3"
							maxlength="6" class="text w30" onblur="quantityCheck(this.value)"
							   onfocus="quantityFocus()";>
							   <a href="javascript:void(0)"
							class="increase">+</a><a href="javascript:void(0)"
							class="decrease">-</a> <em>(<?php echo $lang['goods_index_stock'];?><strong
							nctype="goods_stock"><?php echo $output['goods']['goods_storage']; ?></strong><?php echo $lang['nc_jian'];?>)</em>
            ...
            <?php }?>
					...
					<a href="javascript:void(0);" nctype="buynow_submit"
						class="buynow <?php if ($output['goods']['goods_storage'] <= 0) {?>no-buynow<?php }?>"
					   title="<?php echo $lang['goods_index_now_buy'];?>"><?php echo $lang['goods_index_now_buy'];?></a>
          <?php if ($output['goods']['promotion_type'] != 'groupbuy') {?>
          <!-- 加入购物车-->

					<a href="javascript:void(0);" nctype="addcart_submit"
						class="addcart <?php if ($output['goods']['goods_storage'] <= 0) {?>no-addcart<?php }?>"
						title="<?php echo $lang['goods_index_add_to_cart'];?>">
						<i class="icon-shopping-cart"></i><?php echo $lang['goods_index_add_to_cart'];?></a>
          <?php } ?>
          ...
          <!-- S 加入购物车弹出提示框 -->
					<div class="ncs-cart-popup">
						<dl>
							<dt><?php echo $lang['goods_index_cart_success'];?><a
									...
									onClick="$('.ncs-cart-popup').css({'display':'none'});">X</a>
							</dt>
							<dd><?php echo $lang['goods_index_cart_have'];?> <strong
									id="bold_num"></strong> <?php echo $lang['goods_index_number_of_goods'];?> <?php echo $lang['goods_index_total_price'];?><?php echo $lang['nc_colon'];?><em
									id="bold_mly" class="saleP"></em>
							</dd>
							<dd class="btns">
								<a href="/shop/index.php?act=cart" class="ncs-btn-mini ncs-btn-green"
									><?php echo $lang['goods_index_view_cart'];?></a>
								<a href="/" class="ncs-btn-mini" value=""
				...
				<!-- E 购买按钮 -->
				<div class="ncs_share">
					<a href="javascript:void(0);" nc_type="sharegoods"
						data-param='{"gid":"<?php echo $output['goods']['goods_id'];?>"}'><i
						class="icon-share"></i><?php echo $lang['goods_index_snsshare_goods'];?><em
						nc_type="sharecount_<?php echo $output['goods']['goods_id'];?>"><?php echo intval($output['goods']['sharenum'])>0?intval($output['goods']['sharenum']):0;?></em></a><a
						href="javascript:collect_goods('<?php echo $output['goods']['goods_id']; ?>','count','goods_collect');"><i
						class="icon-star-empty"></i><?php echo $lang['goods_index_favorite_goods'];?><em
						nctype="goods_collect"><?php echo $output['goods']['goods_collect']?></em></a>
				</div>
			</div>
      <?php }else{?>
      <div class="ncs-saleout">
				<dl>
					<dt>
						<i class="icon-info-sign"></i><?php echo $lang['goods_index_is_no_show'];?></dt>
					...
					<dd><?php echo $lang['goods_index_is_no_show_message_two_1'];?>&nbsp;<a
							...
							class="ncs-btn-mini"><?php echo $lang['goods_index_is_no_show_message_two_2'];?></a>&nbsp;<?php echo $lang['goods_index_is_no_show_message_two_3'];?> </dd>
				</dl>
			</div>
      <?php }?>
      <!--E 商品信息 -->
		...
		<!--S 店铺信息-->
		<div class="ncg-info"
			style="position: absolute; z-index: 1; top: 60px; right: 0;">
          ...
          <div class="nc-mansong">
                ...
                ， <?php echo $lang['nc_gift'];?> <a
									...
									target="_blank"> <img
										...
										alt="<?php echo $rule['mansong_goods_name'];?>">
								</a>&nbsp;。
                <?php } ?>
                </span>
                <?php } ?>
          ...
          <div class="ncs-goods-info-content">
			...
			<div class="ncs-comment">
				<div class="ncs-goods-title-bar hd">
					<h4>
						<a href="javascript:void(0);"><?php echo $lang['goods_index_evaluation'];?></a>
					</h4>
				</div>
						...
						<div class="btns">
							...
							<p>
								<a href="<?php echo urlShop('member_order', 'index');?>"
									class="ncs-btn ncs-btn-red" target="_blank"><i
			...
			<div class="ncg-salelog">
				<div class="ncs-goods-title-bar hd">
					<h4>
						<a href="javascript:void(0);"><?php echo $lang['goods_index_sold_record'];?></a>
					</h4>
				</div>
				<div class="ncs-goods-info-content bd" id="ncGoodsTraded">
					<div class="top">
						<div class="price"><?php echo $lang['goods_index_goods_price'];?><strong><?php echo $output['goods']['goods_price'];?></strong><?php echo $lang['goods_index_yuan'];?><span><?php echo $lang['goods_index_price_note'];?></span>
						</div>
					</div>
					<!-- 成交记录内容部分 -->
			...
			<div class="ncs-consult">
				<div class="ncs-goods-title-bar hd">
					<h4>
						<a href="javascript:void(0);"><?php echo $lang['goods_index_goods_consult'];?></a>
					</h4>
				</div>
							...
							<dl>
								<dt class="goods-name">
									<a
										...
										target="_blank"
										title="<?php echo $goods_commend['goods_jingle'];?>"><?php echo $goods_commend['goods_name'];?><em><?php echo $goods_commend['goods_jingle'];?></em></a>
								</dt>
								<dd class="goods-pic">
									<a
										href="<?php echo urlShop('goods', 'index', array('goods_id' => $goods_commend['goods_id']));?>"
										target="_blank"
										title="<?php echo $goods_commend['goods_jingle'];?>"><img
										src="<?php echo thumb($goods_commend, 240);?>"
										alt="<?php echo $goods_commend['goods_name'];?>" /></a>
								</dd>
			...
			<div class="nc-s-c-s1">
				...
				<div class="content">
					<div class="ncs-goods-code">
						<p>
							<img
								src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_STORE.DS.$output['goods']['store_id'].DS.$output['goods']['goods_id'].'.png';?>"
								onerror="this.src='<?php echo UPLOAD_SITE_URL.DS.ATTACH_STORE.DS.'default_qrcode.png';?>'"
								title="商品原始地址：<?php echo urlShop('goods', 'index', array('goods_id'=>$output['goods']['goods_id']));?>">
						</p>
...
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.charCount.js"></script>
<script
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.ajaxContent.pack.js"
	type="text/javascript"></script>
<script src="<?php echo RESOURCE_SITE_URL;?>/js/sns.js"
	type="text/javascript" charset="utf-8"></script>
<script src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.F_slider.js"
	type="text/javascript" charset="utf-8"></script>
<script type="text/javascript"
...
<?php if ($_SESSION['is_login'] !== '1'){?>
   var goods = goods_id+'|'+quantity;
    login_dialog_for_buy(goods);
<?php }else{?>
    if (!quantity) {
        return;
    }
...
$(document).ready(function(){
	...
	function quantityCheck(quantity ) {
		var pattern = /^[1-9]+[0-9]*(\.\d*)?$|^0(\.\d*)?$/;
		if (!pattern.test(quantity )) {
			$("#error_quantity").html('<label for="company_registered_capital" class="error">请输入正确的数量</label>');
			return false;
		}else{
			$("#error_quantity").html("");
			return true;
