		...
		<article class="nc-goods-main">
			...
			<div class="nc-s-c-s3 ncg-list mt10">
				<div class="title pngFix">
					<span><a
						href="<?php echo urlShop('show_store', 'goods_all', array('store_id' => $_GET['store_id']));?>"
						class="more"><?php echo $lang['nc_more'];?></a></span>
              ...
              <li>
							<dl>
								...
								<dd class="ncg-pic pngFix">
									<a
										href="<?php echo urlShop('goods', 'index', array('goods_id'=>$value['goods_id']));?>"
										target="_blank" class="thumb"><i></i><img
								...
								<dd class="ncg-price">
									<em class="price"><i><?php echo $lang['currency'];?></i>
