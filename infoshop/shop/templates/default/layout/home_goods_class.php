...
<div class="title">
	<h3>
		<a href="<?php echo urlShop('category');?>">全部商品分类</a>
	</h3>
	<i class="arrow"></i>
</div>
<div class="category">
	<ul class="menu">
          ...
          <li cat_id="<?php echo $val['gc_id'];?>"
			class="<?php echo $i%2==1 ? 'odd':'even';?>" <?php if($i>14){?>
			...
			<div class="sub-class" cat_menu_id="<?php echo $val['gc_id'];?>">
              ...
              <dl>
                  ...
                  <a
							href="<?php echo urlShop('search','index',array('cate_id'=> $v3['gc_id']));?>"><?php echo $v3['gc_name'];?></a>
                  <?php } ?>
                  <?php } ?>
                </dd>
...
foreach ($v['brands'] as $k3 => $v3) {
                                if ($n ++ < 10) {
                                    ?>
                    <a
							href="<?php echo urlShop('brand','list',array('brand'=> $v3['brand_id'])); ?>"><?php echo $v3['brand_name'];?></a>
                  <?php } ?>
                  <?php } ?>
                </dd>
                <?php } ?>
