...
<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/sns_store.css"
	rel="stylesheet" type="text/css">
		...
		<div class="ssns-layout">
			<div class="sidebar">
				...
				<div class="store-intro">
					...
					<dl class="tc">
						<a
							href="<?php echo urlShop('show_store', 'index', array('store_id'=>$output['store_info']['store_id']));?>"
							class="btn"><?php echo $lang['store_sns_enter_the_store'];?></a>
					</dl>
					<dl>
						<dt><?php echo $lang['store_sns_shopkeeper'].$lang['nc_colon']?></dt>
						<dd><?php echo $output['store_info']['member_name'];?><em
								member_id="<?php echo $output['store_info']['member_id'];?>"></em>
             <?php if(!empty($output['store_info']['store_qq'])){?>
               <a target="_blank"
								...
								border="0"
								src="http://wpa.qq.com/pa?p=2:<?php echo $output['store_info']['store_qq'];?>:52" /></a>
             <?php }?>
             ...
             <?php }?>
					...
					<dl>
						...
						<dd>
							<a nc_type="sharestore"
								data-param='{"sid":"<?php echo $output['store_info']['store_id'];?>"}'
								href="javascript:void(0);"><?php echo $lang['store_sns_share_store'];?></a>
						</dd>
					</dl>
				</div>
			</div>
			<div class="left-content">
				<div class="store-info">
					<div class="picture">
						<span class="thumb size160"><i></i><img
							src="<?php echo getStoreLogo($output['store_info']['store_label']);?>"
							onload="javascript:DrawImage(this,160,160);" /></span>
					</div>
					<dl class="store-name">
						<dt>
							<h2><?php echo $output['store_info']['store_name'];?></h2>
							<span> <a class="btn"
								href="javascript:collect_store('<?php echo $output['store_info']['store_id'];?>','count','store_collect')"><?php echo $lang['store_sns_will_collect'];?></a>
							</span>
						</dt>
						<dd>
							<span id="sCopyContent">
          <?php echo urlShop('show_store', 'index', array('store_id'=>$output['store_info']['store_id']));?>
          </span> <a href="javascript:void(0);" id="sCopy"><?php echo $lang['store_sns_copy'];?></a>
						</dd>
					</dl>
				</div>
				<div class="store-sns-tab">
					<ul>
						<li><a
							href="index.php?act=store_snshome&sid=<?php echo $output['store_info']['store_id'];?>"
							<?php if($_GET['type'] == ''){?> class="selected" <?php }?>><?php echo $lang['store_sns_all_trends'];?></a></li>
						<li><a
							href="index.php?act=store_snshome&sid=<?php echo $output['store_info']['store_id'];?>&type=promotion"
							<?php if($_GET['type'] == 'promotion'){?> class="selected"
							<?php }?>><?php echo $lang['store_sns_sales_promotion'];?></a></li>
						<li><a
							href="index.php?act=store_snshome&sid=<?php echo $output['store_info']['store_id'];?>&type=new"
							<?php if($_GET['type'] == 'new'){?> class="selected" <?php }?>><?php echo $lang['store_sns_new_goods'];?></a></li>
						<li><a
							href="index.php?act=store_snshome&sid=<?php echo $output['store_info']['store_id'];?>&type=hotsell"
							<?php if($_GET['type'] == 'hotsell'){?> class="selected"
							<?php }?>><?php echo $lang['store_sns_hot_sale'];?></a></li>
						<li><a
							href="index.php?act=store_snshome&sid=<?php echo $output['store_info']['store_id'];?>&type=recommend"
							<?php if($_GET['type'] == 'recommend'){?> class="selected"
							<?php }?>><?php echo $lang['store_sns_recommended'];?></a></li>
					</ul>
				</div>
				<div class="main">
        <?php
