...
<html>
<head>
<title>商家入驻 - <?php echo $output['html_title'];?></title>
<meta charset="utf-8">
...
<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/home_login.css"
	rel="stylesheet" type="text/css">
<link href="<?php echo SHOP_TEMPLATES_URL;?>/css/store_joinin_new.css"
	rel="stylesheet" type="text/css">
<style type="text/css">
body {
...
<body>
	<div class="header">
		...
		<ul class="header_menu">
			<li
				class="<?php echo $_GET['act'] == 'show_joinin' ? 'current' : '';?>"><a
				href="<?php echo urlShop('show_joinin','index');?>" class="joinin"><i></i>商家入驻申请</a></li>
			<li
				class="<?php echo $_GET['act'] == 'seller_center' ? 'current' : '';?>"><a
				href="<?php echo urlShop('seller_center','index');?>" class="login"><i></i>商家管理中心</a></li>
			<!--<li class="<?php echo $_GET['act'] == 'show_help' ? 'current' : '';?>"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_help&op=index" class="faq"><i></i>商家帮助指南</a></li>-->
		</ul>
	</div>
