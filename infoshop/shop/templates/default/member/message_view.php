...
if (is_array($output['member_menu']) and ! empty($output['member_menu'])) {
    ...
    <dl>
        ...
        <?php echo $v['from_member_name']; ?> <?php
...
echo $lang['nc_colon'];
    ...
    <form id="replyform" method="post"
			action="index.php?act=home&op=savereply">
			<input type="hidden" name="form_submit" value="ok" /> <input
				type="hidden" name="message_id"
				value="<?php echo $output['message_id']; ?>" />
			<dl class="bottom">
				...
				<dd>
					...
					<p>
						<input type="submit" class="submit"
							value="<?php echo $lang['home_message_submit'];?>" />
					</p>
				</dd>
			</dl>
		</form>
