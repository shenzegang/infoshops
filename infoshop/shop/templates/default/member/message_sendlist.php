...
if (is_array($output['member_menu']) and ! empty($output['member_menu'])) {
    ...
    <a href="index.php?act=home&op=sendmsg"
			title="<?php echo $lang['home_message_send_message'];?>"
			class="ncu-btn3"><?php echo $lang['home_message_send_message'];?></a>
    <?php }?>
  </div>
	<table class="ncu-table-style">
      ...
      <tr>
				...
				<td colspan="20"><label for="all"><?php echo $lang['home_message_select_all'];?></label>
					...
					nc_type="batchbutton"><span><?php echo $lang['home_message_delete'];?></span></a></td>
			</tr>
      <?php } ?>
    </thead>
		<tbody>
      ...
      <tr class="bd-line">
				...
				<td><a href="javascript:void(0)"
					...
					class="ncu-btn2"><?php echo $lang['home_message_delete'];?></a></td>
			</tr>
      <?php } ?>
      <?php } else { ?>
      <tr>
