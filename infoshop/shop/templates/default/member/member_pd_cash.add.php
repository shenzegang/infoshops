...
<div class="wrap">
	...
	<div class="ncu-form-style">
		<form method="post" id="cash_form"
			action="index.php?act=predeposit&op=pd_cash_add">
			<input type="hidden" name="form_submit" value="ok" />
			<dl>
				<dt class="required">
					<em class="pngFix"></em><?php echo $lang['predeposit_cash_price'].$lang['nc_colon']; ?></dt>
				<dd>
					<p>
						<input name="pdc_amount" type="text" class="text w50 mr5"
							id="pdc_amount" maxlength="10">
			...
			<dl>
				<dt class="required">
					<em class="pngFix"></em><?php echo $lang['predeposit_cash_shoukuanbank'].$lang['nc_colon']; ?></dt>
				<dd>
					<p>
						<input name="pdc_bank_name" type="text" class="text w200 mr5"
							id="pdc_bank_name" maxlength="40" />
					</p>
			...
			<dl>
				<dt class="required">
					<em class="pngFix"></em><?php echo $lang['predeposit_cash_shoukuanaccount'].$lang['nc_colon'];?></dt>
				<dd>
					<p>
						<input name="pdc_bank_no" type="text" class="text w200 mr5"
							id="pdc_bank_no" maxlength="30" />
					</p>
			...
			<dl>
				<dt class="required">
					<em class="pngFix"></em>&nbsp;<?php echo $lang['predeposit_cash_shoukuanname'].$lang['nc_colon'];?></dt>
				<dd>
					<p>
						<input name="pdc_bank_user" type="text" class="text w100 mr5"
							id="pdc_bank_user" maxlength="10" />
					</p>
