...
<div class="wrap">
  ...
  <form action="index.php?act=home&op=upload"
			...
			<dl>
				...
				<dd>
					<div class="member-avatar-thumb">
						<img
							src="<?php echo getMemberAvatar($output['member_avatar']).'?'.microtime(); ?>"
							alt="" nc_type="avatar" />
					</div>
				...
				<dd>
					<div class="upload-btn">
						<a href="javascript:void(0);"> <span> <input type="file"
								name="pic" id="pic" multiple="" file_id="0" class="file"
  ...
  <form action="index.php?act=home&op=cut" id="form_cut" method="post">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" id="x1" name="x1" /> <input type="hidden" id="x2"
			name="x2" /> <input type="hidden" id="w" name="w" /> <input
			type="hidden" id="y1" name="y1" /> <input type="hidden" id="y2"
			name="y2" /> <input type="hidden" id="h" name="h" /> <input
			type="hidden" id="newfile" name="newfile"
			value="<?php echo $output['newfile'];?>" />
		<div class="pic-cut-120">
			<div class="work-title"><?php echo $lang['nc_comm_workarea'];?></div>
			<div class="work-layer">
				<p>
					<img id="nccropbox"
						src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_AVATAR.DS.$output['newfile'].'?'.microtime(); ?>" />
				</p>
			</div>
			...
			<div class="cut-btn">
				<input type="button" id="ncsubmit" class="submit"
