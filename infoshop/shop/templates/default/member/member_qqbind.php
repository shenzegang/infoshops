...
<div class="wrap">
    ...
    <input type="hidden" name="form_submit" value="ok" />
		...
		<div class="left">
			<form method="post" id="editbind_form" name="editbind_form"
				action="index.php?act=member_qqconnect&op=unbind">
				<input type='hidden' id="is_editpw" name="is_editpw" value='no' />
				<dl>
					<dt><?php echo $lang['member_qqconnect_unbind_click']; ?></dt>
					<dd>
						<input class="submit" type="submit"
							value="<?php echo $lang['member_qqconnect_unbind_submit'];?>" />
					</dd>
				</dl>
			</form>
		</div>
		<div class="right">
			<form method="post" id="editpw_form" name="editpw_form"
				action="index.php?act=member_qqconnect&op=unbind">
				<input type='hidden' id="is_editpw" name="is_editpw" value='yes' />
				<dl>
					<dd>
						<span><?php echo $lang['member_qqconnect_modpw_newpw']; ?>:</span>
						<input type="password" name="new_password" id="new_password" /> <label
							for="new_password" generated="true" class="error"></label>
					</dd>
					<dd>
						<span><?php echo $lang['member_qqconnect_modpw_two_password']; ?>:</span>
						<input type="password" name="confirm_password"
							id="confirm_password" /> <label for="confirm_password"
							generated="true" class="error"></label>
					</dd>
					<dd>
						<span>&nbsp;</span> <input class="submit" type="submit"
							value="<?php echo $lang['member_qqconnect_unbind_updatepw_submit'];?>" />
					</dd>
					<dd>
    ...
    <?php } else {?>
      <div class="left">
			<p class="ico">
				<a href="<?php echo SHOP_SITE_URL;?>/api.php?act=toqq"><img
					src="<?php echo SHOP_TEMPLATES_URL;?>/images/qq_bind_small.gif"></a></a>
