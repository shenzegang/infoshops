...
if (is_array($output['member_menu']) and ! empty($output['member_menu'])) {
	...
	<div class="ncu-form-style">
		<form method="post" id="send_form"
			...
			<dl>
				<dt class="required">
					<em class="pngFix"></em><?php echo $lang['home_message_reveiver'].$lang['nc_colon'];?></dt>
				<dd>
					<p>
						<input type="text" class="w400 text" name="to_member_name"
			...
			<dl>
				<dt class="required">
					<em class="pngFix"></em><?php echo $lang['home_message_content'].$lang['nc_colon'];?></dt>
				<dd>
  ...
  <div class="message-friend-list">
		<h3><?php echo $lang['home_message_friend'];?><em class="gray ml5">(<?php echo intval(count($output['friend_list'])); ?>)</em>
		</h3>
		<ul>
      <?php if ($output['friend_list'] != '') { ?>
      <?php foreach ($output['friend_list'] as $val) { ?>
      <li><a href="javascript:void(0);"
				id="<?php echo $val['friend_tomname']; ?>" nc_type="to_member_name"><?php echo $val['friend_tomname']; ?></a></li>
      <?php } ?>
      <?php } else { ?>
