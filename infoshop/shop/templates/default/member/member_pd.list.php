...
<div class="wrap">
    ...
    <a class="ncu-btn3" href="index.php?act=buy&op=pd_pay">马上充值</a>
	</div>
	<form method="get" action="index.php">
		<table class="search-form">
			...
			<tr>
				...
				<td><?php echo $output['member_info']['available_predeposit']; ?> <?php echo $lang['currency_zh'];?>
				
				<td>
				
				<th><?php echo $lang['predeposit_rechargesn'].$lang['nc_colon'];?></th>
				<td class="w200 tc"><input type="text" class="text" name="pdr_sn"
					value="<?php echo $_GET['"pdr_sn"'];?>" /></td>
	...
	<table class="ncu-table-style">
      ...
      <tr class="bd-line">
		...
		<?php if (!intval($val['pdr_payment_state'])){?>
          <p>
						<a class="ncu-btn2 mt5"
							href="index.php?act=buy&op=pd_pay&pay_sn=<?php echo $val['pdr_sn'];?>">支付</a>
					</p>
					<p>
						<a href="javascript:void(0)"
							onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', 'index.php?act=predeposit&op=recharge_del&id=<?php echo $val['pdr_id']; ?>');"
							class="ncu-btn2 mt5"><?php echo $lang['nc_del_&nbsp'];?></a>
					</p>
          <?php }else{?>
          <p>
						<a
							href="index.php?act=predeposit&op=recharge_show&id=<?php echo $val['pdr_id']; ?>"
							class="ncu-btn2 mt5"><?php echo $lang['nc_view'];?></a>
					</p>
          <?php }?>
          </td>
			</tr>
