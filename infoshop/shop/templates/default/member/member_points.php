		...
		<table class="search-form">
			...
			<tr>
				...
				<td class="w100"><select name="stage">
						<option value=""
							<?php if (!$_GET['stage']){echo 'selected=selected';}?>><?php echo $lang['nc_please_choose'];?></option>
						<option value="regist"
							<?php if ($_GET['stage'] == 'regist'){echo 'selected=selected';}?>><?php echo $lang['points_stage_regist']; ?></option>
						<option value="login"
							<?php if ($_GET['stage'] == 'login'){echo 'selected=selected';}?>><?php echo $lang['points_stage_login']; ?></option>
						<option value="comments"
							<?php if ($_GET['stage'] == 'comments'){echo 'selected=selected';}?>><?php echo $lang['points_stage_comments']; ?></option>
						<option value="order"
							<?php if ($_GET['stage'] == 'order'){echo 'selected=selected';}?>><?php echo $lang['points_stage_order']; ?></option>
						<option value="system"
							<?php if ($_GET['stage'] == 'system'){echo 'selected=selected';}?>><?php echo $lang['points_stage_system']; ?></option>
						<option value="pointorder"
							<?php if ($_GET['stage'] == 'pointorder'){echo 'selected=selected';}?>><?php echo $lang['points_stage_pointorder']; ?></option>
						<option value="app"
							<?php if ($_GET['stage'] == 'app'){echo 'selected=selected';}?>><?php echo $lang['points_stage_app']; ?></option>
				</select></td>
				<th><?php echo $lang['points_addtime'].$lang['nc_colon']; ?></th>
				<td class="w180"><input type="text" id="stime" name="stime"
					class="text" value="<?php echo $_GET['stime'];?>">
          &nbsp;<?php echo $lang['points_addtime_to']; ?>
          <input type="text" id="etime" name="etime" class="text"
					value="<?php echo $_GET['etime'];?>"></td>
				<th><?php echo $lang['points_pointsdesc'].$lang['nc_colon']; ?></th>
				<td class="w150"><input type="text" class="text" id="description"
					name="description" value="<?php echo $_GET['description'];?>"></td>
