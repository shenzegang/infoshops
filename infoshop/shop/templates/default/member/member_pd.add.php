	...
	<div class="ncu-form-style">
		<form method="post" id="recharge_form" action="index.php">
			<input type="hidden" name="form_submit" value="ok" /> <input
				type="hidden" name="act" value="predeposit" /> <input type="hidden"
				name="op" value="recharge_add" />
			<dl>
				<dt class="required">
					<em class="pngFix"></em><?php echo $lang['predeposit_recharge_price'].$lang['nc_colon']; ?></dt>
				<dd>
					<input name="pdr_amount" type="text" class="text w50 mr5"
						id="pdr_amount" maxlength="8" />
