...
<div class="wrap">
    ...
    <?php include template('layout/submenu');?>
     <div class="text-intro"><?php echo $lang['predeposit_pricetype_available'].$lang['nc_colon']; ?><?php echo $output['member_info']['available_predeposit']; ?>&nbsp;<?php echo $lang['currency_zh'];?> <?php echo $lang['predeposit_pricetype_freeze'].$lang['nc_colon']; ?><?php echo abs($output['member_info']['freeze_predeposit']); ?>&nbsp;<?php echo $lang['currency_zh'];?></div>
	</div>
	<table class="ncu-table-style">
		<thead>
			<tr>
				...
				<th class="w120 tl"><?php echo '变动金额';?>(<?php echo $lang['currency_zh'];?>)</th>
