...
<div class="wrap">
	...
	<div class="ncu-form-style">
		...
		<form id="add_form" enctype="multipart/form-data" method="post"
			action="index.php?act=member_inform&op=inform_save">
			<input name="inform_goods_id" type="hidden"
				value=<?php echo $output['goods_info']['goods_id']; ?> />
			<dl>
				...
				<dd>
					<a
						...
						target="_blank"> <?php echo $output['goods_info']['goods_name']; ?> </a>
				</dd>
			</dl>
			<dl>
			...
			<dl class="bottom">
				<dt>&nbsp;</dt>
				<dd>
					<input id="btn_inform_submit" type="submit" class="submit"
...
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.selectboxes.pack.js"
