...
if (is_array($output['order_goods_list']) and ! empty($output['order_goods_list'])) {
            ...
            <?php } } ?>
				...
				<div class="express-add">
					<p>
						<strong><?php echo $lang['member_show_receive_info'].$lang['nc_colon'];?></strong><?php echo $output['order_info']['area_info'];?>&nbsp;<?php echo $output['order_info']['address'];?>&nbsp;<?php echo $output['order_info']['zip_code']?>&nbsp;<?php echo $output['order_info']['true_name'];?>&nbsp;<?php echo $output['order_info']['tel_phone'];?>&nbsp;<?php echo $output['order_info']['mob_phone']; ?></p>
					<p>
						<strong><?php echo $lang['member_show_deliver_info'].$lang['nc_colon'];?></strong><?php echo $output['daddress_info']['area_info']; ?>&nbsp;<?php echo $output['daddress_info']['address'];?>&nbsp;<?php echo $output['daddress_info']['zip_code'];?>&nbsp;<?php echo $output['daddress_info']['seller_name'];?>&nbsp;<?php echo $output['daddress_info']['tel_phone'];?>&nbsp;<?php echo $output['daddress_info']['mob_phone'];?></p>
				</div>
			</div>
		</div>
	</div>
