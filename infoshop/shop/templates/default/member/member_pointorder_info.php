...
<div class="wrap-shadow">
	<div class="wrap-all ncu-order-view">
		...
		<dl>
			...
			<dd>
				<strong><?php echo $output['order_info']['point_ordersn']; ?></strong>
			</dd>
          ...
          <tr class="bd-line">
					...
					<td><div class="goods-pic-small">
							<span class="thumb size60"><i></i><a
								href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $val['point_goodsid']));?>"
								target="_blank"> <img
									src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_POINTPROD.DS.str_ireplace('.', '_small.', $val['point_goodsimage']);?>"
					...
					<td><dl class="goods-name">
							<dt>
								<a
									href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $val['point_goodsid']));?>"
									target="_blank"><?php echo $val['point_goodsname']; ?></a>
							</dt>
						</dl></td>
