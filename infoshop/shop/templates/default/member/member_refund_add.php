<div class="eject_con">
	...
	<form id="post_form" method="post"
		action="index.php?act=member_refund&op=add_refund&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
		...
		<dl>
			<dt>
				<em class="pngFix"></em><?php echo '商品名称'.$lang['nc_colon'];?></dt>
			<dd>
		...
		<dl>
			<dt>
				<em class="pngFix"></em><?php echo '商品单价'.$lang['nc_colon'];?></dt>
			<dd>
		...
		<dl>
			<dt>
				<em class="pngFix"></em><?php echo '购买数量'.$lang['nc_colon'];?></dt>
			<dd>
		...
		<dl>
			<dt>
				<em class="pngFix"></em><?php echo $lang['refund_pay_refund'].$lang['nc_colon'];?></dt>
			<dd>
		...
		<dl>
			<dt class="required">
				<em class="pngFix"></em><?php echo '申请类型'.$lang['nc_colon'];?></dt>
			<dd>
				<label> <input type="radio" name="refund_type" value="1" />
          <?php echo '退款(不退货)';?> </label> <label> <input type="radio"
					name="refund_type" id="confirm_refund_type" value="2" />
          <?php echo '退货并退款';?> </label>
			</dd>
		</dl>
		<dl>
			<dt class="required">
				<em class="pngFix"></em><?php echo $lang['refund_order_refund'].$lang['nc_colon'];?></dt>
			<dd>
		...
		<dl>
			<dt>
				<em class="pngFix"></em><?php echo $lang['return_order_return'].$lang['nc_colon'];?></dt>
			<dd>
		...
		<dl>
			<dt class="required">
				<em class="pngFix"></em><?php echo $lang['refund_buyer_message'].$lang['nc_colon'];?></dt>
			<dd>
