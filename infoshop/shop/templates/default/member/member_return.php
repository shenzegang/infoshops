		...
		<table class="search-form">
			...
			<tr>
				...
				<th style="width: 115px"><select name="type">
						...
						<option value="return_sn"
							<?php if($_GET['type'] == 'return_sn'){?> selected <?php }?>><?php echo $lang['return_order_returnsn']; ?></option>
						<option value="goods_name"
							<?php if($_GET['type'] == 'goods_name'){?> selected <?php }?>><?php echo '商品名称'; ?></option>
				</select>
          <?php echo $lang['nc_colon'];?></th>
				...
				<td class="w180"><input type="text" class="text"
					...
					value="<?php echo $_GET['add_time_from']; ?>" /> &#8211; <input
					id="add_time_to" type="text" class="text" name="add_time_to"
					value="<?php echo $_GET['add_time_to']; ?>" /></td>
				<td class="w90 tc"><input type="submit" class="submit"
					value="<?php echo $lang['nc_search'];?>" /></td>
			</tr>
		</table>
	</form>
      ...
      <tr class="bd-line">
				...
				<td><div class="goods-pic-small">
						<span class="thumb size60"><i></i><a
							...
							target="_blank"><img src="<?php echo thumb($val,60);?>" /></a></span>
					</div></td>
				<td title="<?php echo $val['store_name']; ?>">
					<dl class="goods-name">
						...
						<dd><?php echo $lang['refund_order_ordersn'].$lang['nc_colon'];?><a
								href="index.php?act=member_order&op=show_order&order_id=<?php echo $val['order_id']; ?>"
				...
				<td><a href="javascript:void(0)" nc_type="dialog"
					dialog_title="<?php echo $lang['nc_view'];?>"
        	...
        	<p>
						<a href="javascript:void(0)" class="ncu-btn7 mt5" nc_type="dialog"
							dialog_title="发货" dialog_id="return_ship" dialog_width="480"
							uri="index.php?act=member_return&op=ship&return_id=<?php echo $val['refund_id']; ?>">
							发货 </a>
					</p>
        	<?php } ?>
        	...
        	<p>
						<a href="javascript:void(0)" class="ncu-btn7 mt5" nc_type="dialog"
							dialog_title="延迟时间" dialog_id="return_delay" dialog_width="480"
							uri="index.php?act=member_return&op=delay&return_id=<?php echo $val['refund_id']; ?>">
							延迟时间 </a>
					</p>
        	<?php } ?>
        </td>
