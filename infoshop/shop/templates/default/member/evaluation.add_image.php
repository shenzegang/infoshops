...
<form id="add_form"
	action="<?php echo urlShop('member_evaluate', 'add_image_save');?>"
	method="post">
	<input type="hidden" name="geval_id"
		value="<?php echo $output['geval_info']['geval_id'];?>">
		...
		<div class="wrap-all ncu-order-view">
				...
				<tbody>
					<tr>
						<td><div class="goods-pic-small">
								<span class="thumb size60"> <i></i> <a target="_blank"
									href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['geval_info']['geval_goodsid']));?>">
										<img
										src="<?php echo cthumb($output['goods_info']['goods_image'], 60);?>">
								</a>
								</span>
							</div></td>
						<td class="tl"><a
							href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['geval_info']['geval_goodsid']));?>"
							target="_blank" class="ml20"><?php echo $output['geval_info']['geval_goodsname'];?></a></td>
						<td><div class="raty" style="display: inline-block;"
								data-score="<?php echo $output['geval_info']['geval_scores'];?>"></div></td>
						...
						<div class="upload-thumb">
							<div nctype="image_item" style="display: none;">
								<img src=""> <input type="hidden" nctype="input_image"
									name="evaluate_image[]" value=""> <a href="javascript:;"
          ...
          <?php }?>
			...
			<div class="tc mt20 mb20">
				<a id="btn_submit" href="javascript:;" class="ncu-btn5">确定提交</a> <a
					href="<?php echo urlShop('member_evaluate', 'list');?>"
					class="ml30">取消返回</a>
			</div>
		</div>
	</div>
