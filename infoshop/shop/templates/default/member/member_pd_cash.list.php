...
<div class="wrap">
	...
	<form method="get" action="index.php">
		<table class="search-form">
			...
			<tr>
				...
				<td class="w90 tr"><select id="paystate_search"
					name="paystate_search">
						<option value="0"><?php echo $lang['nc_please_choose'];?></option>
						<option
							<?php if ($_GET['paystate_search'] == '0') echo 'selected';?>
							value="0">未支付</option>
						<option
							<?php if ($_GET['paystate_search'] == '1') echo 'selected';?>
							value="1">已支付</option>
				</select></td>
				<th><?php echo $lang['predeposit_cashsn'].$lang['nc_colon'];?></th>
				<td class="w200 tc"><input type="text" class="text" name="sn_search"
					value="<?php echo $_GET['sn_search'];?>" /></td>
	...
	<table class="ncu-table-style">
      ...
      <tr class="bd-line">
				...
				<td><p>
						<a
							href="index.php?act=predeposit&op=pd_cash_info&id=<?php echo $val['pdc_id']; ?>"><?php echo $lang['nc_view']; ?></a>
					</p></td>
			</tr>
      <?php } ?>
      <?php } else {?>
