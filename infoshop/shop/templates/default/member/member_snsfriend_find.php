	...
	<div class="friendfind">
		...
		<form id="search_form" method="post"
			...
			<div class="search-form p15">
				<div>
					<input type="text" class="text" style="width: 340px;"
					...
					<a href="javascript:void(0);" nctype="advanced_search"
						class="ml10 vm"><?php echo $lang['snsfriend_advanced_search'];?></a>
				</div>
      ...
      <dl>
				<dt>
					<i></i><?php echo $val['mtag_name'];?></dt>
				<dd>
					<div class="picture">
						<span class="thumb size100"><i></i><img
							title="<?php echo $val['mtag_name'];?>"
							src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_MEMBERTAG.'/'.($val['mtag_img'] != ''?$val['mtag_img']:'default_tag.gif')?>"
							onload="javascript:DrawImage(this,120,120);" /></span>
					</div>
					<div class="arrow"></div>
            ...
            <div>
                ...
                <?php }?></ul>
								...
								<p class="F-next">
									<a href="javascript:void(0);"><?php echo $lang['snsfriend_next'];?></a>
								</p>
								<a href="javascript:void(0);" class="care" nctype="batchFollow"
									data-param="{ids:'<?php echo implode(',', $param);?>'}"><?php echo $lang['snsfriend_attention_them'];?></a>
							</div>
            <?php }else{?>
              <?php echo $lang['snsfriend_null_members_tips1']?><a
								href="index.php?act=home&op=more"><?php echo $lang['snsfriend_null_members_tips2'];?></a>
            <?php }?>
          </div>
					</div>
				</dd>
...
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.F_slider.js"
	charset="utf-8"></script>
<script type="text/javascript">
$(function(){
