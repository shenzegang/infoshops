		...
		<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
			...
			<tr>
				...
				<td><input type="button" value="下载"
						   onClick="downloadFile('<?php echo getAgreementTemplateUrl($output['file_name']); ?>')"><span id="error_download" ></span>
				</td>
			</tr>
			<tr>
				<th>上传合同电子档：</br>(大小不超过20M)</th>
				<td><input id="agreement_name" name="agreement_name" type="file" /><span></span>
				</td>
			</tr>
			</tbody>
		</table>
