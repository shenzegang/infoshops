...
<div class="nc-login-layout">
	<div class="left-pic">
		<img src="<?php echo SHOP_TEMPLATES_URL;?>/images/login_weibo.jpg" /><span><?php echo $output['sinauser_info']['name'];?> </span>
	</div>
	<div class="nc-login" id="rotate">
		<ul>
			<li><a href="#register_form"><span><?php echo $lang['home_sconnect_register_title']; ?>
						<!-- 完善帐号信息 --></span></a></li>
			<li><a href="#log_form"><span><?php echo $lang['home_sconnect_login_title']; ?>
						<!-- 已有帐号？绑定我的帐号 --></span></a></li>
		</ul>
		<div class="nc-login-content">
			<form name="register_form" id="register_form" method="post"
				action="index.php?act=sconnect&op=register">
				<input type="hidden" value="ok" name="form_submit"> <input
					type='hidden' name="regsname"
					value="<?php echo $output['sinauser_info']['name'];?>" />
				<dl class="mt20">
				...
				<dl>
					...
					<dd>
						<input type="text" id="email" name="email" class="text tip"
							title="<?php echo $lang['login_register_input_valid_email'];?>" />
						<label></label>
					</dd>
				</dl>
        ...
        <dl>
					...
					<dd>
						<input type="text" id="captcha" name="captcha"
							...
							src="index.php?act=seccode&op=makecode&nchash=<?php echo $output['nchash'];?>"
							...
							class="fl ml5"><a href="javascript:void(0)" class="fl ml5"
							onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
						<input name="nchash" type="hidden"
							value="<?php echo $output['nchash'];?>" /> <label></label>
					</dd>
				</dl>
        <?php } ?>
        <dl>
					...
					<dd>
						<input type="submit" name="submit"
							value='<?php echo $lang['login_register_enter_now'];?>'
							class="submit fl" /> <input type="checkbox"
							class="fl ml10 mt10 mr5" name="agree" value='1' id="agree"
							checked="checked" /> <span for="agreebbrule" class="fl"><?php echo $lang['home_sconnect_login_agree'];?>
							<!-- 同意 --> <a target="_blank"
							href="index.php?act=document&amp;code=agreement"><?php echo $lang['home_sconnect_login_useragreement']; ?>
								<!-- 用户服务协议 --></a></span> <label></label>
					</dd>
				</dl>
			</form>
			<form name="log_form" id="log_form" method="post"
				action="index.php?act=sconnect&op=login">
				<input type="hidden" value="ok" name="form_submit"> <input
					type='hidden' name="loginsname"
					value="<?php echo $output['sinauser_info']['name'];?>" />
				<dl class="mt20">
        ...
        <dl>
					...
					<dd style="min-height: 54px;">
						<input type="text" id="captcha_login" name="captcha_login"
							class="text w50 fl" maxlength="4" size="10" /> <img
							src="index.php?act=seccode&op=makecode&nchash=<?php echo $output['nchash'];?>"
							title="<?php echo $lang['login_index_change_checkcode'];?>"
							border="0" id="codeimage2" name="codeimage2"
							onclick="this.src='index.php?act=seccode&op=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random()"
							class="fl ml5"><a href="javascript:void(0)" class="fl ml5"
							onclick="javascript:document.getElementById('codeimage2').src='index.php?act=seccode&op=makecode&nchash=<?php echo $output['nchash'];?>&t=' + Math.random();"><?php echo $lang['login_index_change_checkcode'];?></a>
						<input name="nchash" type="hidden"
							value="<?php echo $output['nchash'];?>" /> <label></label>
					</dd>
				</dl>
        ...
        <dl style="min-height: 54px;">
					...
					<dd>
						<input type="submit" name="Submit"
							value="<?php echo $lang['login_register_connect_now'];?>"
							class="submit fl" />
					</dd>
				</dl>
			</form>
