...
<div id="apply_credentials_info" class="apply-credentials-info">
	...
	<form id="form_credentials_info"
		action="index.php?act=store_joinin_c2c&op=step3" method="post"
			...
			<tbody>
				...
				<tr>
					...
					<td><input id="bank_account_number" name="bank_account_number" type="text" class="w200"
                               onblur="numberCheck(this.value)" onfocus="numberFocus();"/> <span id="error_number"></span></td>
				</tr>
				<tr>
					<th><i>*</i>开户银行支行名称：</th>
					<td><input name="bank_name" type="text" class="w200" /> <span></span></td>
				</tr>
				<tr id="bank_addressId">
					<th><i>*</i>开户银行所在地：</th>
		...
		<div id="div_settlement">
			<table border="0" cellpadding="0" cellspacing="0" class="all">
				...
				<tbody>
					...
					<tr>
						<th><i>*</i>银行账号：</th>
						<td><input id="settlement_bank_account_number"
							name="settlement_bank_account_number" type="text" class="w200"
