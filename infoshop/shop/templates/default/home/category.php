...
<div class="nch-container wrapper">
    ...
    <ul class="nch-category-container" id="categoryList">
      ...
      <li class="classes">
				<div class="title">
					<i></i> <a
						href="<?php echo urlShop('search', 'index', array('cate_id' => $gc_list['gc_id']));?>"><?php echo $gc_list['gc_name'];?></a>
				</div>
        ...
        <dl>
					<dt>
						<a
							href="<?php echo urlShop('search', 'index', array('cate_id' => $gc_list2['gc_id']));?>"><?php echo $gc_list2['gc_name'];?></a>
					</dt>
					<dd>
            <?php if(!empty($gc_list2['class3'])){?>
            <?php foreach($gc_list2['class3'] as $key=>$gc_list3){?>
            <a
							href="<?php echo urlShop('search', 'index', array('cate_id' => $gc_list3['gc_id']));?>"><?php echo $gc_list3['gc_name'];?></a>
            <?php }?>
            <?php }?>
          </dd>
				</dl>
