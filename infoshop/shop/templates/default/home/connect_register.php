...
<div class="nc-login-layout">
	<div class="left-pic">
		<img src="<?php echo SHOP_TEMPLATES_URL;?>/images/login_qq.jpg" />
		<p>
			<a href="#register_form"><?php echo $output['qquser_info']['nickname']; ?></a>
		</p>
	</div>
	<div class="nc-login" id="rotate">
		<ul>
			<li class="w400"><a href="#register_form"><?php echo $lang['home_qqconnect_register_title']; ?>
					<!-- 完善帐号信息 --></a></li>
		</ul>
		<div class="nc-login-content">
			<form name="register_form" id="register_form" method="post"
				action="index.php?act=connect&op=register">
				<input type="hidden" value="ok" name="form_submit"> <input
					type='hidden' name="loginnickname"
					value="<?php echo $output['qquser_info']['nickname'];?>" />
				<dl>
					<dt>
						<img src="<?php echo $output['qquser_info']['figureurl_qq_1'];?>" />
					</dt>
					<dd>
				...
				<dl>
					...
					<dd>
						<input type="text" value="<?php echo $output['user_passwd'];?>"
							id="password" name="password" class="text tip"
				...
				<dl>
					...
					<dd>
						<input type="submit" name="submit"
							...
							class="submit fl" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
							href="index.php"><?php echo $lang['home_qqconnect_homepage']; ?></a></span>
						<label></label>
					</dd>
				</dl>
			</form>
