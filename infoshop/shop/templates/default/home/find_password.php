...
<div class="nc-login-layout">
	...
	<div class="nc-login">
		...
		<div class="nc-login-content" id="demo-form-site">
			<form action="index.php?act=login&op=find_password" method="POST"
        ...
        <input type="hidden" name="form_submit" value="ok" /> <input
				...
				<dl>
					...
					<dd style="min-height: 54px;">
						<input type="text" class="text" name="username" /> <label></label>
					</dd>
				</dl>
				<dl>
					<dt><?php echo $lang['login_password_you_email'];?></dt>
					<dd style="min-height: 54px;">
						<input type="text" class="text" name="email" /> <label></label>
					</dd>
				</dl>
				<dl>
					...
					<dd style="min-height: 54px;">
						<input type="text" name="captcha" class="text w50 fl" id="captcha"
							...
							onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a>
						<label></label>
					</dd>
				</dl>
				<dl class="mb30">
					<dt></dt>
					<dd>
						<input type="submit" class="submit" value="重置密码" name="Submit"
							id="Submit">
					</dd>
				</dl>
				<input type="hidden" value="<?php echo $output['ref_url']?>"
					name="ref_url">
			</form>
		</div>
