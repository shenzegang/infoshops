...
<div id="apply_store_info" class="apply-store-info">
	...
	<form id="form_store_info"
		action="index.php?act=store_joinin_c2c&op=step4" method="post">
            ...
            <!--
				<tr>
					...
					<td>
                        ...
                        <input id="seller_name" name="seller_name" type="text" class="w200" /> <span></span>
                        <p class="emphasis">此帐号为日后登录并管理商家中心时使用，注册后不可修改，请牢记。</p>
                    </td>
				</tr>-->
				<tr>
					<th class="w150"><i>*</i>店铺名称：</th>
					<td>
                     <input type="hidden" id="seller_name" name="seller_name" value="<?php echo $_SESSION['member_name']; ?>" />
                    <input name="store_name" type="text" class="w200" /> <span></span>
                ...
                <?php } ?>
                <?php } ?>
              </select> <input id="sg_name" name="sg_name" type="hidden" />
						<span></span>
                ...
                <?php } ?>
                <?php } ?>
              </select> <input id="sc_name" name="sc_name" type="hidden" />
						<span></span>
				...
				<tr>
                  ...
                  <?php }?>
                  <?php }?>
                </select> <input id="btn_add_category" type="button"
								value="确认" /> <input id="btn_cancel_category" type="button"
								value="取消" />
						</div> <input id="store_class" name="store_class" type="hidden" />
						<span></span></td>
				</tr>
				<tr>
	...
	<div class="bottom">
		<a id="btn_apply_store_next" href="javascript:;" class="btn">提交申请</a>
	</div>
</div>
