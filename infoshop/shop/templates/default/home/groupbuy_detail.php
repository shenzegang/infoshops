...
<div class="ncg-container wrapper">
	<div class="ncg-layout-l">
		<div
			class="ncg-main <?php echo $output['groupbuy_info']['state_flag'];?>">
			<div class="ncg-group">
				...
				<div class="ncg-item">
					...
					<div class="button">
						<span><?php echo $lang['currency'];?><em><?php echo $output['groupbuy_info']['groupbuy_price'];?></em></span><a
							href="<?php echo $output['groupbuy_info']['goods_url'];?>"
							target="_blank"><?php echo $output['groupbuy_info']['button_text'];?></a>
					</div>
				...
				<div class="floating-bar">
					...
					<div class="prices">
						...
						<dl>
							...
							<dd>
								<a
									href="<?php echo urlShop('show_store', 'index', array('store_id' => $output['groupbuy_info']['store_id']));?>"
									target="_blank"><?php echo $output['groupbuy_info']['store_name'];?></a>
							</dd>
						</dl>
					</div>
				</div>
	...
	<div class="ncg-layout-r">
			...
			<div class="content">
				<div class="ncg-store-info">
					...
					<dl class="all-rate">
						...
						<dd>
							<div class="rating">
								<span style=" width:<?php echo $output['store_info']['store_credit_percent'];?>%"></span>
							</div>
		...
		<div class="ncg-module-sidebar">
          ...
          <dl
						<?php if($hot_groupbuy_count === 1) { echo "style=' border:none'";$hot_groupbuy_count++; }?>>
						<dt class="name">
							<a href="<?php echo $hot_groupbuy['groupbuy_url'];?>"
								target="_blank"><?php echo $hot_groupbuy['groupbuy_name'];?></a>
						</dt>
						<dd class="pic-thumb">
							<a href="<?php echo $hot_groupbuy['groupbuy_url'];?>"
								target="_blank"><img
								src="<?php echo gthumb($hot_groupbuy['groupbuy_image1'],'max');?>"></a>
						</dd>
						<dd class="item">
							<a href="<?php echo $hot_groupbuy['groupbuy_url'];?>"
								target="_blank"><?php echo $lang['to_see'];?></a> <span
								class="price"><?php echo $lang['currency'].$hot_groupbuy['groupbuy_price'];?></span>
							<span class="buy"><em><?php echo $hot_groupbuy['virtual_quantity']+$hot_groupbuy['buy_quantity'];?></em><?php echo $lang['text_piece'].$lang['text_buy'];?></span>
						</dd>
					</dl>
          <?php } ?>
          <?php } ?>
