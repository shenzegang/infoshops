...
<div class="sidebar">
	<div class="ad-image-date">
		...
		<dd>
			...
			<p>
				<b><?php echo $lang['album_pinfo_class_name'].$lang['nc_colon'];?></b><?php echo $output['class_info']['ac_name'];?></p>

			<p id="default_spec">
				<b><?php echo $lang['album_pinfo_original_spec'].$lang['nc_colon'];?></b><?php echo $output['pic_info']['ap_spec'];?></p>
...
<div class="left-content">
	...
	<div id="pictureFolder" class="album">
		<div class="intro mb20">
			<div class="covers">
				<span class="thumb size60"><i></i><a
					href="index.php?act=sns_album&op=album_pic_list&id=<?php echo $output['class_info']['ac_id']?>">
		...
		<div id="gallery" class="ad-gallery">
            ...
            <li><a
							href="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.$v['ap_cover'];?>"
							value="<?php echo $v['ap_id'] ?>"> <span class="thumb"><i></i> <img
									nctype="thumb" title="<?php echo $v['ap_name']?>"
									src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.str_ireplace('.', '_240.', $v['ap_cover']);?>" />
...
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.ad-gallery.js"></script>
<script type="text/javascript">
  $(function() {
