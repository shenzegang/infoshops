...
<div class="sns-main-all">
    ...
    <div class="album-info">
			<div class="build-album">
				<div class="button">
					<a uri="index.php?act=sns_album&op=album_add" nc_type="dialog"
						dialog_title="<?php echo $lang['album_new_class_add'];?>"
						class="btn"><i></i><?php echo $lang['album_new_class_add'];?></a>
				</div>
			</div>
                  ...
                  <?php }?>
						...
						<div class="upload-con-div mt10">
							<div class="ncsc-upload-btn">
								<span> <input type="file" hidefocus="true" size="1"
									class="input-file" name="file" multiple="multiple" />
								</span>
								<p>
									<i class="icon-upload-alt">选择图片上传
    ...
    <div class="album-cover">
			<div class="cover">
				<span class="thumb size190"><i></i><a
					href="index.php?act=sns_album&op=album_pic_list&id=<?php echo $v['ac_id']?>&mid=<?php echo $output['master_id'];?>">
        <?php if($v['ac_cover'] != ''){ ?>
        <img
						src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$output['master_id'].DS.$v['ac_cover'];?>"
        ...
        <?php }?>
			...
			<div class="title">
				...
				<em>(<?php echo $v['count']?>)</em>
			</div>
      <?php if($output['relation'] == '3'){?>
      <div class="handle">
				<a href="JavaScript:void(0);" class="edit" nc_type="dialog"
					dialog_title="<?php echo $lang['album_class_deit'];?>"
					dialog_id='album_<?php echo $v['ac_id'];?>' dialog_width="480"
					uri="index.php?act=sns_album&op=album_edit&id=<?php echo $v['ac_id'];?>"><i></i><?php echo $lang['album_class_edit'];?></a>
        <?php if($v['is_default'] != '1'){?>
        <a href="javascript:void(0)"
					onclick="ajax_get_confirm('<?php echo $lang['album_class_delete_confirm_message'];?>', 'index.php?act=sns_album&op=album_del&id=<?php echo $v['ac_id'];?>');"
					class="del"><i></i><?php echo $lang['album_class_delete'];?></a>
        <?php }?>
      </div>
      <?php }?>
    </div>
    ...
    <dl>
			<dd class="norecord">
				<i>&nbsp;</i><span><?php echo $lang['no_record'];?></span>
			</dd>
		</dl>
    <?php }?>
  </div>
