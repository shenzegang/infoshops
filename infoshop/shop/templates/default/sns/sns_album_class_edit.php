...
<div class="eject_con">
	...
	<form id="category_form" method="post" target="_parent"
		action="index.php?act=sns_album&op=album_edit_save">
		<input type="hidden" name="id"
			value="<?php echo $output['class_info']['ac_id'];?>" />
		<dl>
			<dt class="required">
				<em class="pngFix"></em><?php echo $lang['album_class_add_name'].$lang['nc_colon'];?></dt>
			<dd>
				<input class="w300 text" type="text" name="name" id="name"
					value="<?php echo $output['class_info']['ac_name'];?>" />
			</dd>
		</dl>
		<dl>
		...
		<dl>
			...
			<dd>
				<input type="text" class="text w50" name="sort" id="sort"
					value="<?php echo $output['class_info']['ac_sort'];?>" />
			</dd>
		</dl>
		<dl class="bottom">
			<dt>&nbsp;</dt>
