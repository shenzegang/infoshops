...
<ul>
  ...
  <li
		class="inv_item <?php echo $k == 0 ? 'ncc-selected-item' : null; ?>">
		<input content="<?php echo $val['content'];?>"
		id="inv_<?php echo $val['inv_id']; ?>" nc_type="inv" type="radio"
		name="inv" value="<?php echo $val['inv_id']; ?>"
		<?php echo $k == 0 ? 'checked' : null; ?> /> <label
		for="inv_<?php echo $val['inv_id']; ?>">&nbsp;&nbsp;<?php echo $val['content']; ?></label>
		&emsp;&emsp;&emsp;<a href="javascript:void(0);"
		onclick="delInv(<?php echo $val['inv_id']?>);" class="del">[ <?php echo $lang['nc_delete'];?> ]</a>
	</li>
  <?php } ?>
  <li class="inv_item">
	...
	<div id="add_inv_box" style="display: none">
		<form method="POST" id="inv_form" action="index.php">
			<input type="hidden" value="buy" name="act"> <input type="hidden"
				value="add_inv" name="op"> <input type="hidden" name="form_submit"
				value="ok" />
			<div class="ncc-form-default">
				<dl>
					<dt>发票类型<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<label> <input type="radio" checked name="invoice_type" value="1">
							普通发票
						</label>
            &emsp;&emsp;
            <?php if (!$output['vat_deny']) {?>
            <label> <input type="radio" name="invoice_type" value="2">
							增值税发票
						</label>
            <?php }?>
          </dd>
			...
			<div id="invoice_panel" class="ncc-form-default">
				<dl>
					...
					<dd>
						...
						</select> <input class="text w200" style="display: none"
							name="inv_title" id="inv_title" placeholder="单位名称" value="">
					</dd>
				</dl>
				<dl>
			...
			<div id="vat_invoice_panel" class="ncc-form-default"
				style="display: none">
				<dl>
					<dt>
						<i class="required">*</i>单位名称<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_company" value="">
					</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>纳税人识别号<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_code" value="">
					</dd>
				...
				<dl>
					<dt>
						<i class="required">*</i>注册地址<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_reg_addr" value="">
					</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>注册电话<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_reg_phone" value="">
					</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>开户银行<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_reg_bname" value="">
					</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>银行帐户<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_reg_baccount" value="">
					</dd>
				</dl>
				<dl>
					<dt></dt>
					<dd>如您是首次开具增值税专用发票，请您填写纳税人识别号等开票信息，并上传
						加盖公章的营业执照副本、税务登记证副本、一般纳税人资格证书及银行开户 许可证扫描件邮寄给我们，收到您的开票资料后，我们会尽快审核。
					</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>发票内容<?php echo $lang['nc_colon'];?></dt>
					<dd>明细</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>收票人姓名<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_rec_name" value="">
					</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>收票人手机号<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_rec_mobphone" value="">
					</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>收票人省份<?php echo $lang['nc_colon'];?></dt>
					<dd id="region">
						<select>
						</select> <input type="hidden" value="" name="city_id"
							id="city_id"> <input type="hidden" name="area_id" id="area_id"
							class="area_ids" /> <input type="hidden" name="area_info"
							id="area_info" class="area_names" />
					</dd>
				</dl>
				<dl>
					<dt>
						<i class="required">*</i>送票地址<?php echo $lang['nc_colon'];?></dt>
					<dd>
						<input type="text" class="text w200" maxlength="50"
							name="inv_goto_addr" value="">
					</dd>
				</dl>
			</div>
		</form>
...
<div class="hr16">
	<a id="hide_invoice_list" class="ncc-btn ncc-btn-red"
		href="javascript:void(0);"><?php echo $lang['cart_step1_invoice_submit'];?></a>
	<a id="cancel_invoice" class="ncc-btn ml10" href="javascript:void(0);">不需要发票</a>
</div>
<script>
