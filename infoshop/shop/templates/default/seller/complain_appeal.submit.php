...
<div class="ncsc-form-default">
	<form action="index.php?act=store_complain&op=appeal_save"
		...
		<dl>
			...
			<dd>
                ...
                <?php if ($output['complain_info']['complain_subject_id'] == 1) {?>
                    <input name="return_type" type="radio"
                           value="1" checked="checked"/>弃货
                    <input name="return_type" type="radio"
                           value="2" />需买家退货
                <?php } ?>
			</dd>
