...
<div class="ncsc-form-default">
	<form id="add_form"
		action="index.php?act=store_promotion_mansong&op=mansong_quota_add_save"
		method="post">
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['mansong_quota_add_quantity'].$lang['nc_colon'];?></dt>
			<dd>
				<input id="mansong_quota_quantity" name="mansong_quota_quantity"
					type="text" class="text w50" /><em class="add-on"><?php echo $lang['text_month'];?></em>
				<span></span>
