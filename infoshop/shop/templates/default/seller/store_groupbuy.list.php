...
<div class="tabmenu">
  ...
  <a href="<?php echo urlShop('store_groupbuy', 'groupbuy_add');?>"
		style="right: 100px" class="ncsc-btn ncsc-btn-green"
		title="<?php echo $lang['groupbuy_index_new_group'];?>"><i
		class="icon-plus-sign"></i><?php echo $lang['groupbuy_index_new_group'];?></a>
	<a class="ncsc-btn ncsc-btn-acidblue"
		href="<?php echo urlShop('store_groupbuy', 'groupbuy_quota_add');?>"
...
<div class="alert alert-block mt10">
  ...
  <strong>套餐过期时间<?php echo $lang['nc_colon'];?></strong><strong
		style="color: #F00;"><?php echo date('Y-m-d H:i:s', $output['current_groupbuy_quota']['end_time']);?></strong>
  <?php } else { ?>
	...
	<form method="get">
		...
		<tr>
          ...
          <?php } ?>
			...
			<td class="w160"><input class="text" type="text" name="groupbuy_name"
				value="<?php echo $_GET['groupbuy_name'];?>" /></td>
...
<table class="ncsc-table-style">
    ...
    <tr class="bd-line">
			...
			<td><div class="pic-thumb">
					<a href="<?php echo $group['groupbuy_url'];?>" target="_blank"><img
						src="<?php echo gthumb($group['groupbuy_image'], 'small');?>" /></a>
				</div></td>
