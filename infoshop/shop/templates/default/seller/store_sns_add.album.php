...
<div class="groupbuy-gallery" nctype="store_sns_album">
	<a class="sample_demo" id="select_s"
		href="index.php?act=store_album&op=pic_list&item=store_sns_normal"
		style="display: none;"><?php echo $lang['nc_submit'];?></a>
	<div class="nav">
    ...
    <li
			onclick="sns_insert('<?php echo cthumb($v['apic_cover'], 240,$v['store_id']);?>');"
			style="padding: 4px 0 4px 3px;"><a href="JavaScript:void(0);"><span
				class="thumb size90"><i></i><img
