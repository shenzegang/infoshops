...
<form method="get">
	<input type="hidden" name="act" value="seller_log" /> <input
		type="hidden" name="op" value="log_list" />
	<table class="search-form">
		<tr>
			<td>&nbsp;</td>
			<th>帐号</th>
			<td class="w100"><input type="text" class="text w80"
				name="seller_name" value="<?php echo trim($_GET['seller_name']); ?>" /></td>
			<th>日志内容</th>
			<td class="w160"><input type="text" class="text w150"
				name="log_content" value="<?php echo trim($_GET['log_content']); ?>" /></td>
			<th>时间</th>
