...
<div class="ncsc-form-default">
	<form method="post" action="index.php?act=store_storage_alarm"
		id="my_store_form">
		<input type="hidden" name="form_submit" value="ok" />
		<dl>
			<dt>库存警报<?php echo $lang['nc_colon'];?></dt>
			<dd>
				<input class="text w60" name="store_storage_alarm" maxlength="10"
					type="text" id="store_storage_alarm"
					value="<?php echo $output['store_storage_alarm'];?>" />
