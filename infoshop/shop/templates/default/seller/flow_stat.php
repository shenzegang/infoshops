	...
	<table class="search-form">
		...
		<tr>
			<td><a href="javascript:void(0);" class="ncsc-btn-mini"
				id="week_flow"><?php echo $lang['stat_week_flow']; ?></a><a
				href="javascript:void(0);" id="month_flow" class="ncsc-btn-mini"><?php echo $lang['stat_month_flow']; ?></a>
				<a href="javascript:void(0);" id="year_flow" class="ncsc-btn-mini"><?php echo $lang['stat_year_flow']; ?></a></td>
