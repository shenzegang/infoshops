	...
	<div class="adds">
		...
		<form method="post"
			...
			<dl>
				...
				<dd>
					<input type="text" class="text" name="new_reciver_name"
						id="new_reciver_name"
						value="<?php echo $output['address_info']['reciver_name'];?>" />
				</dd>
			</dl>
			<dl>
			...
			<dl>
				...
				<dd>
					<input type="text" class="text" name="new_phone" id="new_phone"
						value="<?php echo $output['address_info']['reciver_info']['phone'];?>" />
				</dd>
			</dl>
			<div class="bottom">
				<a href="javascript:void(0);" id="submit" class="submit"><?php echo $lang['nc_common_button_save'];?></a>
			</div>
		</form>
	</div>
</div>
