...
<div class="eject_con">
	...
	<form id="message" target="_parent" method="post"
		action="index.php?act=store_consult&op=reply_save&consult_id=<?php echo $output['consult']['consult_id'];?>">
		<input type="hidden" name="type"
			value="<?php echo $output['consult']['consult_reply']==""?"reply":"edit"?>" />
		<dl>
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_consult_list_reply_consult'].$lang['nc_colon'];?></dt>
			<dd>
				<input type="hidden" id="consult_id" name="consult_id"
					value="<?php echo $output['consult']['consult_id'];?>" />
