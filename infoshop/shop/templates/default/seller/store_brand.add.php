<div class="eject_con">
	...
	<form method="post" target="_parent"
		action="index.php?act=store_brand&op=<?php if ($output['brand_array']['brand_id']!='') echo 'brand_edit'; else echo 'brand_save'; ?>"
		enctype="multipart/form-data" id="brand_apply_form">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="brand_id"
			value="<?php echo $output['brand_array']['brand_id']; ?>" />
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_goods_brand_name'].$lang['nc_colon'];?></dt>
			<dd>
				<input type="text" class="text" name="brand_name"
		...
		<dl>
			...
			<dd id="gcategory">
				<input type="hidden"
					...
					name="brand_class" class="mls_name">
        ...
        <?php }?>
        <select <?php if($output['brand_array']['brand_id']!=''){?>
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_goods_brand_icon'].$lang['nc_colon'];?></dt>
			<dd>
				<div class="">
					<span class="sign"><img
						src="<?php echo brandImage($output['brand_array']['brand_pic']);?>"
						onload="javascript:DrawImage(this,150,50)" nc_type="logo1" /></span>
				</div>
				<div class="ncsc-upload-btn">
					<a href="javascript:void(0);"><span> <input type="file"
							hidefocus="true" size="1" class="input-file" name="brand_pic"
							id="brand_pic" nc_type="logo" />
					</span>
						<p>
