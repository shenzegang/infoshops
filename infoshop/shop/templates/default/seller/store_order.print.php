...
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.printarea.js"
	charset="utf-8"></script>
...
<div class="print-layout">
		<div class="print-btn" id="printbtn"
			title="<?php echo $lang['member_printorder_print_tip'];?>">
			<i></i><a href="javascript:void(0);"><?php echo $lang['member_printorder_print'];?></a>
		</div>
      ...
      <div class="orderprint">
          ...
          <?php }else {?>
          <div class="logo">
							<img src="<?php echo $output['store_info']['store_label']; ?>" />
						</div>
        ...
        <div class="explain">
        	<?php echo $output['store_info']['store_printdesc'];?>
					...
					<div class="seal">
						<img src="<?php echo $output['store_info']['store_stamp'];?>"
