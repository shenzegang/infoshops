...
<div class="eject_con">
	...
	<form id="category_form" method="post" target="_parent"
		action="index.php?act=store_album&op=album_add_save">
		...
		<dl>
			...
			<dd>
				<textarea class="w300 textarea" rows="3" name="description"
...
<div class="warning-option">
	<i class="icon-warning-sign">&nbsp;</i><span><?php echo $lang['album_class_add_max_20'];?></span>
</div>
<?php }?>
