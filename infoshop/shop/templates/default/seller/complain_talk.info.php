...
<?php if(intval($output['complain_info']['complain_state']) < 50) { ?>
<dl>
	...
	<div class="bottom">
		<label class="submit-border"> <a id="btn_publish" class="submit"><?php echo $lang['talk_send'];?></a>
		</label> <label class="submit-border"> <a id="btn_refresh"
			class="submit"><?php echo $lang['talk_refresh'];?></a>
		</label> <label class="submit-border"> <a id="btn_handle"
			class="submit"><?php echo $lang['handle_submit'];?></a>
		</label>
	</div>
<?php } ?>
<form action="index.php?act=store_complain&op=apply_handle"
		method="post" id="handle_form">
		<input name="input_complain_id" type="hidden"
