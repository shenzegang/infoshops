...
<div id="pictureFolder" class="ncsc-picture-folder">
	<dl class="ncsc-album-intro">
		<dt class="albume-name">
			<a
				href="index.php?act=store_album&op=album_pic_list&id=<?php echo $output['class_info']['aclass_id']?>"><?php echo $output['class_info']['aclass_name']?></a>
		</dt>
		<dd class="album-covers">
      <?php if($output['class_info']['aclass_cover'] != ''){ ?>
      <img
				src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_GOODS.DS.$_SESSION['store_id'].DS.str_replace('_small', '_tiny', $output['class_info']['aclass_cover']);?>">
      <?php }else{?>
	...
	<div id="gallery" class="ad-gallery">
		<div class="ad-nav">
          ...
          <li><a href="<?php echo thumb($v, 1280);?>"
						value="<?php echo $v['apic_id'] ?>"> <img
							title="<?php echo $v['apic_name']?>"
							src="<?php echo thumb($v, 60);?>" class="image0" /> <input
							type="hidden" value="" />
					</a></li>
          <?php }?>
        </ul>
		...
		<div class="ad-image-date">
			...
			<dd>
				<p id="upload_time">
					<b><?php echo $lang['album_pinfo_upload_time'].$lang['nc_colon'];?></b><?php echo date('Y-m-d',$output['pic_info']['upload_time']);?></p>
				<p>
					<b><?php echo $lang['album_pinfo_class_name'].$lang['nc_colon'];?></b><?php echo str_cut($output['class_info']['aclass_name'],20);?></p>
				<p id="default_size">
					<b><?php echo $lang['album_pinfo_original_size'].$lang['nc_colon'];?></b><?php echo $output['pic_info']['apic_size'];?>KB</p>
				<p id="default_spec">
					<b><?php echo $lang['album_pinfo_original_spec'].$lang['nc_colon'];?></b><?php echo $output['pic_info']['apic_spec'];?></p>
				<p><?php echo $lang['album_pinfo_see_src']?><span><a
						href="JavaScript:void(0);" target="_black" id="default_popup"
						class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span>
				</p>
				<p><?php echo $lang['album_pinfo_see_max']?><span><a
						href="JavaScript:void(0);" target="_black" id="max_popup"
						class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span>
				</p>
				<p><?php echo $lang['album_pinfo_see_mid']?><span><a
						href="JavaScript:void(0);" target="_black" id="mid_popup"
						class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span>
				</p>
				<p><?php echo $lang['album_pinfo_see_small']?><span><a
						href="JavaScript:void(0);" target="_black" id="small_popup"
						class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span>
				</p>
				<p><?php echo $lang['album_pinfo_see_tiny']?><span><a
						href="JavaScript:void(0);" target="_black" id="tiny_popup"
						class="view popup"><?php echo $lang['album_pinfo_see'];?></a></span>
				</p>
			</dd>
		</div>
