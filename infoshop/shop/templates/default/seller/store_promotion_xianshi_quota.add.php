...
<div class="ncsc-form-default">
	<form id="add_form"
		action="index.php?act=store_promotion_xianshi&op=xianshi_quota_add_save"
		method="post">
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['xianshi_quota_add_quantity'].$lang['nc_colon'];?></dt>
			<dd>
				<input id="xianshi_quota_quantity" name="xianshi_quota_quantity"
					type="text" class="text w30" /><em class="add-on"><?php echo $lang['text_month'];?></em><span></span>
