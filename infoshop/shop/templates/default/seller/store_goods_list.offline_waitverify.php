...
<form method="get" action="index.php">
	<table class="search-form">
		...
		<tr>
          ...
          <option
						<?php if (isset($_GET['verify']) && $_GET['verify'] == $key) {?>
						selected <?php }?> value='<?php  echo $key;?>'><?php echo $val;?></option>
          <?php }?>
        </select></td>
...
<table class="ncsc-table-style">
    ...
    <tr>
			...
			<td colspan="10"><label for="all"><?php echo $lang['nc_select_all'];?></label>
				...
				name="commonid" confirm="<?php echo $lang['nc_ensure_del'];?>"><i
					class="icon-trash"></i><?php echo $lang['nc_del'];?></a>
    ...
    <tr>
		...
		<tr>
			<td class="trigger"><i class="icon-plus-sign" nctype="ajaxGoodsList"
				data-comminid="<?php echo $val['goods_commonid'];?>"></i></td>
...
<script type="text/javascript"
	src="<?php echo SHOP_RESOURCE_SITE_URL;?>/js/store_goods_list.js"
