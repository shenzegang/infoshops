...
<div class="ncsc-form-default">
	<form method="post"
		action="index.php?act=store_setting&op=store_setting"
		...
		<dl>
			...
			<dd>
				<textarea name="store_zy" rows="2" class="textarea w400"
					maxlength="50"><?php echo $output['store_info']['store_zy'];?></textarea>
		...
		<dl>
			...
			<dd>
				<input type="hidden" name="store_old_label"
					value="<?php echo $output['store_info']['store_label'];?>" />
				<div class="ncsc-upload-thumb store-logo">
					<p><?php if(empty($output['store_info']['store_label'])){ ?>
          <i class="icon-picture"></i>
          <?php } else {?>
          <img
							src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_STORE.'/'.$output['store_info']['store_label'];?>"
							nc_type="store_label" />
          <?php }?></p>
				</div>
				<div class="ncsc-upload-btn">
					<a href="javascript:void(0);"><span> <input type="file"
							hidefocus="true" size="1" class="input-file" name="store_label"
							id="storeLablePic" nc_type="change_store_label" />
					</span>
						<p>
		...
		<dl>
			...
			<dd>
				<input type="hidden" name="store_old_banner"
					value="<?php echo $output['store_info']['store_banner'];?>" />
				<div class="ncsc-upload-thumb store-banner">
					<p><?php if(empty($output['store_info']['store_banner'])){?>
          <i class="icon-picture"></i>
          <?php }else{?>
          <img
							src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_STORE.'/'.$output['store_info']['store_banner'];?>"
							nc_type="store_banner" />
          <?php }?></p>
				</div>
				<div class="ncsc-upload-btn">
					<a href="javascript:void(0);"><span> <input type="file"
							hidefocus="true" size="1" class="input-file" name="store_banner"
							id="storeBannerPic" nc_type="change_store_banner" />
					</span>
						<p>
							<i class="icon-upload-alt"></i>图片上传
						</p> </a>
    ...
    <dl>
        ...
        <p>
					<input type="text" class="text" name="store_domain"
						value="<?php echo $output['store_info']['store_domain'];?>" />
    ...
    <dl>
			...
			<dd>
				<input class="w200 text" name="store_qq" type="text" id="store_qq"
					value="<?php echo $output['store_info']['store_qq'];?>" />
			</dd>
		</dl>
		<dl>
			<dt><?php echo $lang['store_setting_wangwang'].$lang['nc_colon'];?></dt>
			<dd>
				<input class="text w200" name="store_ww" type="text" id="store_ww"
					value="<?php echo $output['store_info']['store_ww'];?>" />
			</dd>
		</dl>
		<dl>
			<dt><?php echo $lang['store_create_phone'].$lang['nc_colon'];?></dt>
			<dd>
				<input class="text w200" name="store_tel" type="text" id="store_tel"
					   value="<?php echo $output['store_info']['store_tel'];?>" />
			</dd>
		</dl>
		<dl>
			...
			<dd>
				<p>
					<input class="text w400" name="seo_keywords" type="text"
						value="<?php echo $output['store_info']['store_keywords'];?>" />
				</p>
		...
		<dl>
			...
			<dd>
				<p>
					<textarea name="seo_description" rows="3" class="textarea w400"
						id="remark_input"><?php echo $output['store_info']['store_description'];?></textarea>
				</p>
