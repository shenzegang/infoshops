...
<div class="ncsc-form-default">
    ...
    <form id="add_form"
		action="index.php?act=store_promotion_xianshi&op=xianshi_save"
		method="post">
    <?php } else { ?>
    <form id="add_form"
			action="index.php?act=store_promotion_xianshi&op=xianshi_edit_save"
			method="post">
			<input type="hidden" name="xianshi_id"
				value="<?php echo $output['xianshi_info']['xianshi_id'];?>">
    <?php } ?>
    <dl>
				<dt>
					<i class="required">*</i><?php echo $lang['xianshi_name'];?><?php echo $lang['nc_colon'];?></dt>
				<dd>
					<input id="xianshi_name" name="xianshi_name" type="text"
						maxlength="25" class="text w400"
						value="<?php echo empty($output['xianshi_info'])?'':$output['xianshi_info']['xianshi_name'];?>" />
					<span></span>
			...
			<dl>
				...
				<dd>
					<input id="xianshi_title" name="xianshi_title" type="text"
						maxlength="10" class="text w200"
						value="<?php echo empty($output['xianshi_info'])?'':$output['xianshi_info']['xianshi_title'];?>" />
					<span></span>
			...
			<dl>
				...
				<dd>
					<input id="xianshi_explain" name="xianshi_explain" type="text"
						maxlength="30" class="text w400"
						value="<?php echo empty($output['xianshi_info'])?'':$output['xianshi_info']['xianshi_explain'];?>" />
					<span></span>
    ...
    <dl>
				<dt>
					<i class="required">*</i>购买下限<?php echo $lang['nc_colon'];?></dt>
				<dd>
					<input id="lower_limit" name="lower_limit" type="text"
						class="text w130"
						value="<?php echo empty($output['xianshi_info'])?'1':$output['xianshi_info']['lower_limit'];?>" /><span></span>
