<div class="eject_con">
	...
	<form
		action="index.php?act=store_return&op=receive&return_id=<?php echo $output['return']['refund_id']; ?>"
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo '收货情况'.$lang['nc_colon'];?></dt>
			<dd>
		...
		<div class="bottom">
			<label class="submit-border"><input type="submit" class="submit"
				id="confirm_yes" value="<?php echo $lang['nc_ok'];?>" /></label>
		</div>
	</form>
</div>
