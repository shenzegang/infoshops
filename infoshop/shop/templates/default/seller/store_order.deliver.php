...
<table class="ncsc-table-style order deliver">
  ...
  <tbody>
        ...
        <?php }?>
        <a
					href="index.php?act=store_order_print&order_id=<?php echo $order['order_id'];?>"
					target="_blank" class="ncsc-btn-mini"
    ...
    <tr>
			...
			<td class="w50"><div class="pic-thumb">
					<a
						...
						target="_blank"><img
						src="<?php echo cthumb($goods['goods_image'],60,$goods['store_id']); ?>" /></a>
				</div></td>
      ...
      <td class="bdl bdr order-info w500"
				rowspan="<?php echo count($order['extend_order_goods']);?>"><dl>
            ...
            <span><a
							...
							class="ncsc-btn-mini ncsc-btn-green fr"><i class="icon-truck"></i><?php echo $lang['store_order_send'];?></a></span>
            <?php } elseif ($order['order_state'] == ORDER_STATE_SEND){?>
            <span> <a href="javascript:void(0)"
							class="ncsc-btn-mini ncsc-btn-orange ml5 fr"
							...
							href="index.php?act=store_deliver&op=send&order_id=<?php echo $order['order_id'];?>"
							class="ncsc-btn-mini ncsc-btn-acidblue fr"><i class="icon-edit"></i><?php echo $lang['store_deliver_modify_info'];?></a>
						</span>
            <?php }?>
            <?php }?>
          </dd>
