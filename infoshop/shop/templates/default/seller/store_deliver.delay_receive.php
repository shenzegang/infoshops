...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post"
		action="index.php?act=store_deliver&op=delay_receive&order_id=<?php echo $output['order_info']['order_id']; ?>">
		...
		<dl>
			...
			<dd><?php echo date('Y-m-d H:i:s',$output['order_info']['delay_time']);?><br />如果超过该时间买家未点击收货，系统将自动更改为收货状态
			</dd>
		</dl>
		<dl>
