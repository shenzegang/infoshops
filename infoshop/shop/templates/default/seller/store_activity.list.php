  ...
  <thead>
    ...
    <tr>
			...
			<td class="tl"><a target="_blank"
				href="index.php?act=activity&activity_id=<?php echo $v['activity_id'];?>"><?php echo $v['activity_title']; ?></a></td>
			...
			<td class="nscs-table-handle"><span><a
					id="a_<?php echo $v['activity_id'];?>"
					href="index.php?act=store_activity&op=activity_apply&activity_id=<?php echo $v['activity_id'];?>"
					class="btn-green"><i class="icon-edit"></i>
						<p><?php echo $lang['store_activity_join'];?></p> </a></span></td>
		</tr>
    <?php } } else { ?>
    <tr>
