...
<div class="alert alert-block alert-info">
	<strong><?php echo $lang['store_sns_type'].$lang['nc_colon'];?></strong>
	<label class="mr20"> <input type="radio" name="sns_type" value="normal"
		id="sns_normal" checked="checked" class="vm mr5" />
    <?php echo $lang['store_sns_normal'];?></label> <label class="mr20">
		<input type="radio" name="sns_type" value="recommend"
		id="sns_recommend" class="vm mr5" />
    <?php echo $lang['store_sns_recommend'];?></label> <label
		class="mr20"> <input type="radio" name="sns_type" value="hotsell"
		id="sns_hotsell" class="vm mr5" />
    <?php echo $lang['store_sns_hotsell'];?></label> <label class="mr20">
		<input type="radio" name="sns_type" value="new" id="sns_new"
		class="vm mr5" />
    <?php echo $lang['store_sns_new'];?></label>
</div>
<div class="ncsc-form-default" nctype="normal" style="display: none;">
	<form method="post" action="index.php?act=store_sns&op=store_sns_save"
		id="normal_form">
		...
		<dl>
			...
			<dd>
				<div class="ncsc-upload-thumb store-sns-pic">
					<p>
						<img nctype="normal_img"
							src="<?php echo SHOP_TEMPLATES_URL?>/images/member/default_image.png" />
					</p>
				...
				<div class="handle">
					<div class="ncsc-upload-btn">
						<a href="javascript:void(0);"><span> <input type="file"
								hidefocus="true" size="1" class="input-file" name="normal_file"
								id="normal_file">
						</span>
							<p>
					...
					<a class="ncsc-btn" nctype="get_img"
						href="index.php?act=store_album&op=pic_list&item=store_sns_normal"><i
						class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);"
						nctype="del_img" class="ncsc-btn ml5" style="display: none;"><i
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_sns_cotent'].$lang['nc_colon'];?></dt>
			<dd>
				<textarea name="content" class="textarea w450 h100"
					id="content_normal" nctype="normal"></textarea>
				<p class="w450">
					<span class="smile"><a href="javascript:void(0)"
						nc_type="smiliesbtn" data-param='{"txtid":"normal"}'><?php echo $lang['store_sns_face'];?></a></span>
		...
		<div class="bottom">
			<label class="submit-border"><input type="submit" class="submit"
				value="<?php echo $lang['store_sns_release'];?>" /></label>
		</div>
	</form>
</div>
<div class="ncsc-form-default" nctype="recommend" style="display: none;">
	...
	<form method="post" action="index.php?act=store_sns&op=store_sns_save"
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_sns_goods'].$lang['nc_colon']?></dt>
			<dd>
				<p>
					<input type="text" class="text w400" name="goods_url" value=""
						placeholder="<?php echo $lang['store_sns_input_goods_url'];?>" />
				</p>
			</dd>
		</dl>
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_sns_cotent'].$lang['nc_colon'];?></dt>
			<dd>
				<textarea name="content" class="textarea w400 h100"
					nctype="recommend" id="content_recommend"></textarea>
				<p class="w400">
					<span class="smile"><a href="javascript:void(0)"
						nc_type="smiliesbtn" data-param='{"txtid":"recommend"}'><?php echo $lang['store_sns_face'];?></a>
					</span> <span id="weibocharcount_recommend" class="weibocharcount"></span>
				</p>
			</dd>
		</dl>
		<div class="bottom">
...
<div class="ncsc-form-default" nctype="hotsell" style="display: none;">
    ...
    <dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_sns_hotsell_dt'].$lang['nc_colon'];?></dt>
			<dd>
              ...
              <li>
								<div class="goods-thumb">
									<img
										src="<?php echo cthumb($val['goods_image'], 240, $val['store_id']);?>" />
								</div>
								<dl class="goods-info">
									<dt>
										<input type="checkbox" class="checkbox" name="goods_id[]"
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_sns_cotent'].$lang['nc_colon'];?></dt>
			<dd>
				<textarea name="content" class="textarea w450" nctype="hotsell"
					id="content_hotsell"></textarea>
				<p class="w450">
					<span class="smile"> <a href="javascript:void(0)"
						nc_type="smiliesbtn" data-param='{"txtid":"hotsell"}'><?php echo $lang['store_sns_face'];?></a>
					</span> <span id="weibocharcount_hotsell" class="weibocharcount"></span>
				</p>
			</dd>
		</dl>
		<div class="bottom">
    ...
    <div class="warning-option">
			<i class="icon-warning-sign">&nbsp;</i><span><span><?php echo $lang['store_sns_hotsell_null'];?>
...
<div class="ncsc-form-default" nctype="new" style="display: none;">
	<form method="post" action="index.php?act=store_sns&op=store_sns_save"
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_sns_recommend_dt'].$lang['nc_colon'];?></dt>
			<dd>
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_sns_cotent'].$lang['nc_colon'];?></dt>
			<dd>
				<textarea name="content" class="textarea w450" nctype="new"
					id="content_new"></textarea>
				<p class="w450">
					<span class="smile"> <a href="javascript:void(0)"
						nc_type="smiliesbtn" data-param='{"txtid":"new"}'><?php echo $lang['store_sns_face'];?></a>
					</span> <span id="weibocharcount_new" class="weibocharcount"></span>
				</p>
			</dd>
		</dl>
		<div class="bottom">
    ...
    <?php }else{?>
    <div class="warning-option">
			<i class="icon-warning-sign">&nbsp;</i><span><?php echo $lang['store_sns_new_null'];?>
      <label for="sns_recommend"><a><?php echo $lang['store_sns_self_recommend'];?></a></label>
			</span>
		</div>
    <?php }?>
