		...
		<tr>
			...
			<td class="w160"><select name="bill_state">
					...
					<option
						...
						selected <?php } ?> value="<?php echo BILL_STATE_STORE_COFIRM;?>">商家已确认</option>
					<option
			...
			<th>结算单号</th>
			<td class="w160"><input type="text" class="text w150" name="ob_no"
				value="<?php echo $_GET['ob_no']; ?>" /></td>
			<td class="w70 tc"><label class="submit-border"> <input type="submit"
					class="submit" value="<?php echo $lang['nc_common_search'];?>" />
			</label></td>
		</tr>
	</table>
</form>
<table class="ncsc-table-style">
    ...
    <tr class="bd-line">
			...
			<td><a
				href="index.php?act=store_bill&op=show_bill&ob_no=<?php echo $bill_info['ob_no'];?>"><?php echo $lang['nc_view'];?></a></td>
		</tr>
    <?php }?>
    <?php } else { ?>
    <tr>
