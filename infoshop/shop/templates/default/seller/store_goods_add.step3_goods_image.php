...
<div class="goods-gallery"
	nctype="gallery-<?php echo $output['color_id'];?>">
	<a class="sample_demo"
		href="index.php?act=store_album&op=pic_list&item=goods_image&color_id=<?php echo $output['color_id'];?>"
    ...
    <?php }?>
    </span><span class="r"> <select name="jumpMenu"
			style="width: 100px;">
    ...
    <li
			onclick="insert_img('<?php echo $v['apic_cover'];?>','<?php echo thumb($v, 240);?>', <?php echo $output['color_id'];?>);"><a
			href="JavaScript:void(0);"><img src="<?php echo thumb($v, 240);?>"
				title='<?php echo $v['apic_name']?>' /></a></li>
    <?php }?>
    <?php }else{?>
