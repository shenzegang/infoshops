...
<form method="POST" id='express_form'
	action="index.php?act=store_deliver_set&op=express"
	onsubmit="ajaxpost('express_form', '', '', 'onerror');return false;">
	...
	<table class="ncsc-table-style">
      ...
      <tr class="bd-line">
        ...
        <td class="tl"><label> <input type="checkbox" name="cexpress[]"
						<?php if (in_array($key,$output['express_select'])) echo 'checked';?>
						value="<?php echo $key;?>">
      ...
      <?php }?>
		...
		<tfoot>
			<tr>
				<td colspan="20" class="bottom"><label class="submit-border"><input
						class="submit" type="submit"
						value="<?php echo $lang['nc_common_button_save'];?>"></label></td>
			</tr>
		</tfoot>
	</table>
</form>
