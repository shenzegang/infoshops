<div class="eject_con">
    ...
    <form id="post_form" method="post"
          action="index.php?act=store_return&op=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
        ...
        <dl>
            ...
            <dd>
                <label> <input type="radio" name="seller_state" value="2"/>
                    ...
                    <input name="return_type" type="checkbox" value="1"/>弃货</label>
        ...
        <dl>
            <dt>
                <i class="required">*</i><?php echo $lang['return_message'] . $lang['nc_colon']; ?></dt>
            <dd>
        ...
        <div class="bottom">
            <label class="submit-border"><input type="submit" class="submit"
                                                id="confirm_button" name="confirm_button"
                                                value="<?php echo $lang['nc_ok']; ?>"/></label>
        </div>
    </form>
</div>
