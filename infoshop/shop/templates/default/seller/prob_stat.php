	...
	<table class="search-form">
		...
		<tr>
			<td><a href="javascript:void(0);" class="ncsc-btn-mini"
				id="week_flow"><?php echo $lang['stat_week_ps']; ?></a><a
				href="javascript:void(0);" class="ncsc-btn-mini" id="month_flow"><?php echo $lang['stat_month_ps']; ?></a><a
				href="javascript:void(0);" class="ncsc-btn-mini" id="year_flow"><?php echo $lang['stat_year_ps']; ?></a></td>
