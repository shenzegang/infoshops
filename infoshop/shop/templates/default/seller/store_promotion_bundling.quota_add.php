...
<div class="ncsc-form-default">
  ...
  <form id="add_form"
		action="index.php?act=store_promotion_bundling&op=bundling_quota_add"
		method="post">
  <?php } else {?>
  <form id="add_form"
			action="index.php?act=store_promotion_bundling&op=bundling_renew"
			method="post">
  <?php }?>
    <input type="hidden" name="form_submit" value="ok" />
			<dl>
				<dt>
					<i class="required">*</i><?php echo $lang['bundling_quota_add_quantity'].$lang['nc_colon'];?></dt>
				<dd>
					<input id="bundling_quota_quantity" name="bundling_quota_quantity"
						type="text" class="text w50" /><em class="add-on"><?php echo $lang['nc_month'];?></em><span></span>
