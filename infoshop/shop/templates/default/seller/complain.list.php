    ...
    <table class="search-form">
        ...
        <tr>
            ...
            <td class="w70 tc"><label class="submit-border"><input type="submit"
                                                                   class="submit"
                                                                   value="<?php echo $lang['nc_search']; ?>"/></label>
            </td>
        </tr>
    </table>
</form>
        ...
        <?php foreach ($output['list'] as $val) { ?>
            <tr class="bd-line">
                ...
                <td class="nscs-table-handle"><span><a
                            href="index.php?act=store_complain&op=complain_show&complain_id=<?php echo $val['complain_id']; ?>"
                            target="_blank" class="btn-blue"><i class="icon-edit"></i>

                            <p><?php echo $lang['complain_text_detail']; ?></p></a></span></td>
            </tr>
        <?php } ?>
    <?php } else { ?>
        <tr>
