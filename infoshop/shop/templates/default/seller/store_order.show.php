...
<div class="wrap-all ncu-order-view">
	<dl>
		...
		<dd>
			<strong><?php echo $output['order_info']['state_desc']; ?></strong>
		</dd>
	...
	<table class="ncsc-table-style">
      ...
      <tr class="bd-line">
				...
				<td class="tl">
					<dl class="goods-name" style="width: 100%;">
						<dt style="width: 100%;"><?php if(!empty($goods['is_gift'])){ ?><span
            ...
            <dd style="width: 100%;"><?php echo orderGoodsType($goods['goods_type']);?></dd>
            <?php } ?>
          </dl>
				</td>
