...
<div class="tabmenu">
  ...
  <a href="javascript:void(0)" class="ncsc-btn ncsc-btn-green"
		onclick="go('index.php?act=store_account&op=account_add');"
		title="添加帐号">添加帐号</a>
</div>
<table class="ncsc-table-style">
    ...
    <tr class="bd-line">
			...
			<td class="nscs-table-handle"><span><a
					href="<?php echo urlShop('store_account', 'account_edit', array('seller_id' => $value['seller_id']));?>"
					class="btn-blue"><i class="icon-edit"></i>
						<p><?php echo $lang['nc_edit'];?></p></a> </span><span><a
					nctype="btn_del_account"
					data-seller-id="<?php echo $value['seller_id'];?>"
...
<form id="del_form" method="post"
	action="<?php echo urlShop('store_account', 'account_del');?>">
