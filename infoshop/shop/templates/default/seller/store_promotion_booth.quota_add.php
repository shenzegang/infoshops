...
<div class="ncsc-form-default">
  ...
  <form id="add_form"
		action="<?php echo urlShop('store_promotion_booth', 'booth_quota_add');?>"
		method="post">
  <?php } else {?>
  <form id="add_form"
			action="<?php echo urlShop('store_promotion_booth', 'booth_renew');?>"
			method="post">
  <?php }?>
    <input type="hidden" name="form_submit" value="ok" />
			<dl>
				...
				<dd>
					<input id="booth_quota_quantity" name="booth_quota_quantity"
						type="text" class="text w50" /><em class="add-on">月</em><span></span>
