...
<div class="eject_con">
	...
	<form method="post"
		action="index.php?act=store_deliver_set&op=daddress_add"
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_daddress_receiver_name'].$lang['nc_colon'];?></dt>
			<dd>
				<input type="text" class="text" name="seller_name"
					value="<?php echo $output['address_info']['seller_name'];?>" />
			</dd>
		</dl>
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_daddress_location'].$lang['nc_colon'];?></dt>
			<dd>
				<div id="region">
					<input type="hidden"
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_daddress_address'].$lang['nc_colon'];?></dt>
			<dd>
		...
		<dl>
			<dt>
				<i class="required">*</i><?php echo $lang['store_daddress_phone_num'].$lang['nc_colon'];?></dt>
			<dd>
				<input type="hidden" name="telphone" value="ok" /> <input
					type="hidden" name="telphone"
					value="<?php echo $output['address_info']['telphone'];?>" />
				<input id='telphone' name="telphone" type="text" class="text"
					 value="<?php echo $output['address_info']['telphone'];?>"
					   onblur="phoneCheck(this.value)" onfocus=" phoneFocus();"/>
		...
		<dl>
			...
			<dd>
				<input type="text" class="text" name="company"
					value="<?php echo $output['address_info']['company'];?>" />
			</dd>
		</dl>
		<div class="bottom">
			<label class="submit-border"><input type="submit"
				nctype="address_add_submit" class="submit"
				value="<?php echo $lang['nc_common_button_save'];?>" /></label>
		</div>
	</form>
</div>
...
function phoneCheck(phone) {
	...
	if (!pattern.test(phone)) {
		$("#error_phone").html('<cite style="color: red">请输入正确的手机号</cite>');
		return false;
	}else{
		$("#error_phone").html("");
		return true;
