<div class="eject_con">
	...
	<form method="post"
		action="<?php echo urlShop('store_goods_online', 'edit_plate');?>"
		id="plate_form">
		<input type="hidden" name="form_submit" value="ok" /> <input
			type="hidden" name="commonid"
			value="<?php echo $_GET['commonid']; ?>" />
		<dl>
			<dt>关联版式：</dt>
			<dd>
				<p>
					<label>顶部版式</label> <select name="plate_top">
						<option>请选择</option>
            ...
            <?php }?>
				...
				<p>
					<label>底部版式</label> <select name="plate_bottom">
						<option>请选择</option>
