...
<div class="ncsc-form-default">
	<form method="post" action="index.php?act=store_printsetup&op=index"
		enctype="multipart/form-data" id="my_store_form">
		<input type="hidden" name="form_submit" value="ok" />
		<dl class="setup">
			<dt><?php echo $lang['store_printsetup_desc'].$lang['nc_colon'];?></dt>
			<dd>
				<textarea name="store_printdesc" cols="150" rows="3"
					class="textarea w400" id="store_printdesc"><?php echo $output['store_info']['store_printdesc'];?></textarea>
		...
		<dl class="setup">
			...
			<dd>
				<input type="hidden" name="store_stamp_old"
					value="<?php echo $output['store_info']['store_stamp'];?>" />
				<p class="picture">
					<span class="thumb size120"><i></i> <img
						src="<?php if(!empty($output['store_info']['store_stamp'])){echo UPLOAD_SITE_URL.'/'.ATTACH_STORE.'/'.$output['store_info']['store_stamp'];}?>"
						onload="javascript:DrawImage(this,120,120);" nc_type="store_stamp" /></span>
				</p>
				<p>
					<input name="store_stamp" type="file" hidefocus="true"
						nc_type="change_store_stamp" />
				</p>
