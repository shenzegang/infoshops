...
('sina_wb_akey', ''),
('sina_wb_skey', ''),
('site_bank_account', '银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:CorShop,开户行:中国银行广东省分行'),
('site_email', 'abc@corshop.net'),
('site_logo', 'logo.png'),
('site_name', 'CorShop【B2B2C】电商系统 - 演示站'),
('site_phone', '0755-83693310'),
('site_status', '1'),
('statistics_code', ''),
('subdomain_edit', '0'),
...
INSERT INTO `#__adv` (`adv_id`, `ap_id`, `adv_title`, `adv_content`, `adv_start_date`, `adv_end_date`, `slide_sort`, `member_id`, `member_name`, `click_num`, `is_allow`, `buy_style`, `goldpay`) VALUES (15, 9, '首页通栏', 'a:2:{s:7:"adv_pic";s:21:"04418235791378401.jpg";s:11:"adv_pic_url";s:14:"www.infol.com.cn";}', 1388505600, 1577721600, 0, 0, '', 0, 1, '', 0);
...
(22, 7, '', 1, 255, '关于南京盈放科技', '<p>　　南京盈放科技有限公司 </p>', 1389864697),
(23, 7, '', 1, 255, '联系我们', '', 1389864697),
(24, 7, '', 1, 255, '招聘英才', '', 1389864697),
(25, 7, '', 1, 255, '合作及洽谈', '', 1389864697),
...
(35, 1, 'http://www.infol.com.cn/', 1, 1, '火爆销售中', '火爆销售中<br />', 1389864697),
...
INSERT INTO `#__navigation` (`nav_id`, `nav_type`, `nav_title`, `nav_url`, `nav_location`, `nav_new_open`, `nav_sort`, `item_id`) VALUES(6, 0, '关于CorShop', 'shop/index.php?act=article&article_id=22', 2, 0, 255, 0),
...
INSERT INTO `#__seo` (`id`, `title`, `keywords`, `description`, `type`) VALUES (1, '{sitename}', 'CorShop,PHP商城系统,CorShop商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', 'CorShop专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-0808-868', 'index'),
(2, '{sitename} - 团购', 'CorShop,{sitename}', 'CorShop专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'group'),
(3, '{sitename} - {name}', 'CorShop,{name},{sitename}', 'CorShop,{name},{sitename}', 'group_content'),
(4, '{sitename} - 品牌', 'CorShop,{sitename}', 'CorShop,{sitename}', 'brand'),
(5, '{sitename} - {name}', 'CorShop,{sitename},{name}', 'CorShop,{sitename},{name}', 'brand_list'),
(7, '{sitename} - {name}', 'CorShop,{sitename},{name}', 'CorShop,{sitename},{name}', 'coupon_content'),
(8, '{sitename} - 积分商城', 'CorShop,{sitename}', 'CorShop,{sitename}', 'point'),
(9, '{sitename} - {name}', 'CorShop,{sitename},{key}', 'CorShop,{sitename},{description}', 'point_content'),
(10, '{sitename} - {article_class}', 'CorShop,{sitename}', 'CorShop,{sitename}', 'article'),
(11, '{sitename} - {name}', 'CorShop,{sitename},{key}', 'CorShop,{sitename},{description}', 'article_content'),
(12, '{sitename} - {shopname}', 'CorShop,{sitename},{key}', 'CorShop,{sitename},{description}', 'shop'),
(13, '{name} - {sitename}', 'CorShop,{sitename},{key}', 'CorShop,{sitename},{description}', 'product'),
(14, '看{name}怎么淘到好的宝贝-{sitename}', 'CorShop,{sitename},{name}', 'CorShop,{sitename},{name}', 'sns');
...
INSERT INTO `cor_setting` (`name`, `value`) VALUES ('mobile_isuse', '1');

DROP TABLE IF EXISTS `cor_mb_ad`;
CREATE TABLE `cor_mb_ad` (
...
INSERT INTO `cor_mb_ad` VALUES (15,'户外旅行','a93071f217d821d262a6ad081d383838.jpg',255,NULL),(16,'电器专场','8b89103d674133e00aadb2a0aa350e48.jpg',111,NULL),(13,'日用百货','adbbb2e550645d098d3e4ab92226de2a.jpg',128,'百货'),(14,'服饰专场','bd4fba92244e62aea5629aeeab2d9d95.jpg',255,NULL);

DROP TABLE IF EXISTS `cor_mb_feedback`;
CREATE TABLE `cor_mb_feedback` (
...
DROP TABLE IF EXISTS `cor_mb_home`;
CREATE TABLE `cor_mb_home` (
