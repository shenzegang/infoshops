...
$html_title = 'Corshop【B2B2C】 - 安装向导';

$html_header = <<<EOF
<div class="header">
  <div class="layout">
    <div class="title">
      <h5>Corshop【B2B2C】电商系统</h5>
      <h2>系统安装向导</h2>
    </div>
...
$html_footer = <<<EOF
<div class="footer">
  <h5>Powered by <font class="blue">Cor</font><font class="orange">Shop</font><font class="black">【B2B2C】</font></h5>
  <h6>版权所有 2003-2015 &copy; <a href="http://www.infol.com.cn" target="_blank">B2B2C电商平台</a></h6>
</div>
EOF;
...
function step3(&$install_error, &$install_recover)
{
    ...
    $con = mysqli_init();
    if (! $con) {
        $install_error = '初始化mysqli失败：' . mysqli_connect_error();
        return;
    }
    if (! mysqli_real_connect($con, $db_host . ":" . $db_port, $db_user, $db_pwd)) {
        $install_error = '数据库连接失败：' . mysqli_connect_error() . '(' . mysqli_connect_errno() . ')';
        return;
    }
