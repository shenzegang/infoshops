...
<div class="base-layout">
	<div class="mainbox">
      ...
      <ul class="group-theme-list">
        ...
        <li>
					<dl class="theme-info"
						data-param="{t_id:<?php echo $val['theme_id'];?>,c_id:<?php echo $val['circle_id'];?>}">
						<dt>
							<span class="theme-title"><a
								href="index.php?act=theme&op=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>"
								target="_blank"><?php echo $val['theme_name'];?></a></span>
						</dt>
                ...
                <?php echo $lang['p_center_published_since'];?><span
									class="group-name">&#8220;<a
                ...
                <?php }?>
                <span class="ml10"><a href="javascript:void(0);"
									onclick="likeNo($(this), {'t_id':<?php echo $val['theme_id'];?>,'c_id':<?php echo $val['circle_id'];?>});$(this).parents('li:first').remove();"
									class="edit"><?php echo $lang['circle_like_cancel'];?>(<em
										nctype="like"><?php echo $val['theme_likecount'];?></em>)</a></span>
							</div>
						</dd>
					</dl>
				</li>
      ...
      <?php }else{?>
      <div class="no-theme">
				<span><i></i><?php echo $lang['p_center_not_liked_theme'];?></span>
			</div>
      <?php }?>
    </div>
	</div>
