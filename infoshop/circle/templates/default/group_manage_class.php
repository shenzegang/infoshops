...
<div class="base-layout">
    ...
    <table class="base-table-style">
          ...
          <?php }?>
          <td colspan="20" class="tr"><?php if(count($output['thclass_list']) <10){?><a
						href="javascript:void(0);" nctype="add_thclass"
						class="add-group-class-btn mr10"><?php echo $lang['circle_tclass_add'];?></a><?php }else{echo $lang['circle_tclass_add_max_10'];}?></td>
				</tr>
			</thead>
			<tbody>
        <?php if(!empty($output['thclass_list'])){?>
        ...
        <tr>
					<td><input type="checkbox" class="checkitem"
						value="<?php echo $val['thclass_id'];?>" /></td>
					...
					<td class="handle"><a href="javascript:void(0);"
						onclick="edit_thclass(<?php echo $val['thclass_id'];?>)"><?php echo $lang['nc_edit'];?></a>&nbsp;|&nbsp;<a
						href="javascript:void(0);"
						onclick="del_thclass(<?php echo $val['thclass_id'];?>)"><?php echo $lang['nc_delete'];?></a></td>
				</tr>
        <?php }?>
        <?php }else{?>
        <tr>
