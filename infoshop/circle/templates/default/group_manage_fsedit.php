...
<div class="eject_con">
	<div id="warning"></div>
	<form id="fsedit_form"
		action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=manage&op=friendship_edit&c_id=<?php echo $output['c_id'];?>&fs_id=<?php echo $output['fs_id'];?>"
		...
		<dl>
			...
			<dd>
				<input type="text" name="sort" class="w50 text"
					value="<?php echo $output['friendship_info']['friendship_sort'];?>" />
			</dd>
		</dl>
		<dl>
			...
			<dd>
				<input type="radio" name="status" value="1"
					<?php if($output['friendship_info']['friendship_status'] == 1){?>
					checked="checked" <?php }?> />
        <?php echo $lang['nc_show'];?>&nbsp;
        <input type="radio" name="status" value="0"
					<?php if($output['friendship_info']['friendship_status'] == 0){?>
					checked="checked" <?php }?> />
