...
<div class="base-tab-menu">
	<dl class="my-manage">
		<dt class="group-name">
			<strong><a
				href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $output['c_id'];?>"><?php echo $output['circle_info']['circle_name'];?></a></strong>[<?php echo $lang['circle_management_center'];?>]</dt>
		<dd class="group-pic">
			<img
    ...
    <li
			<?php if($output['sidebar_sign'] == $key){ echo 'class="selected"';}?>>
      ...
      <div class="tabs-child-menu">
        ...
        <a href="<?php echo $v['url'];?>"
					<?php if($output['sidebar_child_sign'] == $k){echo 'class="selected"';}?>><i></i><?php echo $v['name'];?></a>
        <?php }?>
      </div>
      <?php }?>
    </li>
