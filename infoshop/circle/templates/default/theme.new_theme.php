...
<div class="group warp-all">
  ...
  <div class="theme-editor">
		<form method="post" id="theme_form"
			action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=save_theme&c_id=<?php echo $output['c_id'];?>">
			...
			<div class="quick-thread">
				<div class="base-tab-menu">
					<ul class="base-tabs-nav">
						...
						<li><a
							href="index.php?act=theme&op=new_theme&sp=1&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['circle_new_poll'];?></a></li>
					</ul>
				</div>
