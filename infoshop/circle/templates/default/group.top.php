...
<div class="group-top">
	<dl class="circle-info">
		<dt class="name">
			<h2>
				<a
					href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $output['c_id'];?>"
					class="group-name"><?php echo $output['circle_info']['circle_name'];?></a>
			</h2>
      <?php
    
switch ($output['identity']) {
        case 0:
        case 5:
    ...
    ?>
		...
		<dd class="pic">
			<a
				href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $output['c_id'];?>"><img
				src="<?php echo circleLogo($output['circle_info']['circle_id']);?>" /></a>
		</dd>
		...
		<dd class="manage">
			<span class="master">
        <?php echo $lang['circle_manager'].$lang['nc_colon'];?><a
				target="_blank"
				href="<?php echo SHOP_SITE_URL;?>/index.php?act=sns_circle&op=theme&mid=<?php echo $output['creator']['member_id'];?>"
				nctype="mcard"
				data-param="{'id':<?php echo $output['creator']['member_id'];?>}"><i></i><?php echo $output['creator']['member_name'];?></a>
			</span> <span class="moderator">
        ...
        <a target="_blank"
				...
				nctype="mcard" data-param="{'id':<?php echo $val['member_id'];?>}"><i></i><?php echo $val['member_name'];?></a>
...
<script type="text/javascript"
	src="<?php echo CIRCLE_RESOURCE_SITE_URL;?>/js/group.js"
