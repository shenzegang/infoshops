...
<div class="theme-top clearfix">
    ...
    <?php foreach ($output['new_themelist'] as $val){?>
      <li><a
				...
				class="theme-title" title="<?php echo $val['theme_name'];?>"><?php echo $val['theme_name'];?></a>
				<a
				href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>"
				class="group-name"
				title="<?php echo $lang['circle_theme_come_from'].$lang['nc_colon'].$val['circle_name'];?>"><?php echo $val['circle_name'];?></a>
			</li>
    <?php }?>
    </ul>
    <?php }?>
