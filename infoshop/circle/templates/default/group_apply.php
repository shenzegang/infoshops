...
<div class="eject_con group_apply">
	...
	<form id="apply_form"
		action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&op=apply&c_id=<?php echo $output['c_id'];?>"
		method="post">
		...
		<dl>
			...
			<dd>
				<h4>
					<i class="a"></i><?php echo $lang['circle_join_tips_h4'];?></h4>
		...
		<dl>
			...
			<dd>
				<h4>
					<i class="b"></i><?php echo $lang['circle_introduction_desc'];?></h4>
				<h5><?php echo $lang['circle_introduction_example'];?></h5>
				<textarea name="intro" class="textarea"></textarea>
			</dd>
		</dl>
		<div class="bottom">
			<a class="submit-btn" nctype="apply_submit"
				href="Javascript: void(0)"><?php echo $lang['circle_submit_applications'];?></a><a
				class="cancel-btn" nctype="apply_cancel" href="Javascript: void(0)"><?php echo $lang['nc_cancel'];?></a>
		</div>
	</form>
</div>
