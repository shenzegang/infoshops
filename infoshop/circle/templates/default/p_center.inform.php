...
<div class="base-layout">
	<div class="mainbox">
        ...
        <tr>
					...
					<td><a
						href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>"><?php echo $val['circle_name'];?></a></td>
					<td>
            ...
            <?php }?>
					...
					<td class="handle"><a href="javascript:void(0);"
						onclick="delinform(<?php echo $val['inform_id'];?>);"><?php echo $lang['nc_delete'];?></a>
					</td>
				</tr>
        <?php }?>
        <?php }else{?>
      ...
      <tfoot>
				<tr>
					...
					<th colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
						...
						nctype="batchbutton"
						uri="<?php echo CIRCLE_SITE_URL;?>/index.php?act=p_center&op=delinform"
