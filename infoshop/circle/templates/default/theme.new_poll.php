...
<div class="group warp-all">
  ...
  <div class="theme-editor">
		<form method="post" id="theme_form"
			action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=save_theme&sp=1&c_id=<?php echo $output['c_id'];?>">
			<input type="hidden" name="form_submit" value="ok" />
			<div class="quick-thread">
				<div class="base-tab-menu">
					<ul class="base-tabs-nav">
						<li><a
							href="index.php?act=theme&op=new_theme&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['circle_new_theme'];?></a></li>
              ...
              <?php echo $lang['circle_poll_options_max'];?> </span><span
								...
								<label> <input type="text" name="days" class="input-text" />
                <?php echo $lang['nc_day'];?></label>
						...
						<div id="poll_div_1" class="add-poll">
							<a href="javascript:void(0);" nctype="addpolloption" class="btn"><i></i><?php echo $lang['circle_add_new'];?></a>
						</div>
					</div>
          <?php echo showMiniEditor('themecontent', '', 'all', array(), 'goods', array(), $output['readperm']);?>
          <div class="bottom">
						<a class="submit-btn" nctype="theme_submit"
							href="Javascript: void(0)"><?php echo $lang['nc_release_new_theme'];?></a>
