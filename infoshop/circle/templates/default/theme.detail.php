...
<link href="<?php echo CIRCLE_TEMPLATES_URL;?>/css/ubb.css"
  ...
  <div class="base-layout mt20">
		<div class="mainbox">
			<div class="theme-detail-header">
				<div class="member-avatar-m">
					<img
						src="<?php echo getMemberAvatarForID($output['theme_info']['member_id']);?>" />
				</div>
				<div class="theme-title">
					<i
						class="<?php
    
if ($output['theme_info']['is_shut'] == 1) {
        echo 'close';
    ...
    ?>"
				...
				<div class="theme-info-a">
					<a target="_blank"
						href="<?php echo SHOP_SITE_URL;?>/index.php?act=sns_circle&mid=<?php echo $output['theme_info']['member_id'];?>"
						nctype="mcard"
						data-param="{'id':<?php echo $output['theme_info']['member_id'];?>}"><?php echo $output['theme_info']['member_name'];?></a><span
						class="floor">(<?php echo $lang['circle_landlord'];?>)</span>
          ...
          <span class="addtime"><?php echo $lang['circle_posted_in'];?><em><?php echo @date('Y-m-d', $output['theme_info']['theme_addtime']);?></em></span><span
						class="theme-edit"><i></i><a
						href="index.php?act=theme&op=edit_theme&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>"><?php echo $lang['nc_edit_theme'];?></a></span>
          <?php }?>
        </div>
				<div class="buttons">
					<a href="Javascript:history.go(-1);" class="back"><i></i><?php echo $lang['circle_return'];?></a>
          <?php if(C('circle_istalk') == 1){?>
          <div class="post-btn">
						<a
							href="index.php?act=theme&op=new_theme&c_id=<?php echo $output['c_id'];?>"
							class="new-theme"><i></i><?php echo $lang['circle_new_theme'];?></a>
						<div class="sub-menu">
							<span class="arrow"></span>
							<ul>
								<li class="new-poll"><a
									href="index.php?act=theme&op=new_theme&sp=1&c_id=<?php echo $output['c_id'];?>"><i></i><?php echo $lang['circle_new_poll'];?></a></li>
							</ul>
						</div>
					</div>
      ...
      <div class="theme-detail-content">
        ...
        <div class="theme-edittime">
					<span><?php echo $output['theme_info']['theme_editname'];?>&nbsp;<?php echo $lang['nc_at'];?>&nbsp;<?php echo @date('Y-m-d', $output['theme_info']['theme_edittime'])?>&nbsp;<?php echo $lang['circle_last_edit'];?></span>
				</div>
        <?php }?>
        <?php if(!empty($output['goods_list'])){?>
        <div class="theme-content-goods">
					<h4>
						<i></i><?php echo $lang['circle_relevance_goods'];?></h4>
					<ul>
            <?php foreach($output['goods_list'] as $val){?>
            <li>
							<div class="goods-pic thumb">
								<a href="javascript:void(0);"><img
									src="<?php echo $val['image'];?>" class="t-img" /></a>
							</div>
							<div class="goods-name"><?php echo $val['goods_name'];?></div>
							<div class="goods-price">
								<em><?php echo $val['goods_price'];?></em>
							</div> <a href="<?php echo $val['thg_url'];?>" class="goto"
							target="_blank"><?php echo $lang['circle_goods_detail'];?></a>
						</li>
            <?php }?>
          </ul>
				</div>
        ...
        <div class="theme-content-file clearfix">
					<h4 class="file-hidden-btn">
						<i></i><?php echo $lang['nc_relevance_adjunct'];?></h4>
					<div class="file-hidden">
						<i class="arrow"></i>
						<ul>
              <?php foreach($output['affix_list'] as $val){?>
              <li><a
								href="<?php echo themeImageUrl($val['affix_filename']);?>"
								class="nyroModal" rel="gal"
								title="<?php echo $lang['circle_affix_image_title_one'].$output['theme_info']['theme_name'].$lang['circle_affix_image_title_two'];?>"><img
									src="<?php echo themeImageUrl($val['affix_filethumb']);?>" /></a>
							</li>
              <?php }?>
            </ul>
					</div>
        ...
        <div class="handle-bar">
          ...
          <div class="manage">
						<a href="javascript:void(0);" class="manage-button"><?php echo $lang['circle_theme_manage'];?></a>
						<span class="manage-content"> <a href="javascript:void(0);"
							nctype="<?php if($output['theme_info']['is_digest'] == 0){?>themeDigestYes<?php }else{?>themeDigestNo<?php }?>">
            <?php if($output['theme_info']['is_digest'] == 0){echo $lang['circle_digest'];}else{echo $lang['circle_digest_cancel'];}?>
            </a> <a href="javascript:void(0);"
							nctype="<?php if($output['theme_info']['is_stick'] == 0){?>themeTopYes<?php }else{?>themeTopNo<?php }?>">
            <?php if($output['theme_info']['is_stick'] == 0){echo $lang['circle_stick'];}else{echo $lang['circle_stick_cancel'];}?>
            </a> <a href="javascript:void(0);"
							nctype="<?php if($output['theme_info']['is_closed'] == 0){?>themeCloseYes<?php }else{?>themeCloseNo<?php }?>"
							data-param="<?php echo $output['theme_info']['member_id'];?>">
            <?php if($output['theme_info']['is_closed'] == 0){echo $lang['circle_nospeak'];}else{echo $lang['circle_nospeak_cancel'];}?>
            </a> <a href="javascript:void(0);"
							nctype="<?php if($output['theme_info']['is_shut'] == 0){?>themeShutYes<?php }else{?>themeShutNo<?php }?>">
            <?php if($output['theme_info']['is_shut'] == 0){echo $lang['nc_close'];}else{echo $lang['nc_open'];}?>
            </a> <a
							href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=manage&op=edit_theme&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>"><?php echo $lang['nc_edit'];?></a>
							<a href="javascript:void(0);" nctype="themeDelManage"><?php echo $lang['nc_delete'];?></a>
						</span>
					</div>
          <?php }?>
          <div class="normal">
						<a
							href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=theme_detail&c_id=<?php echo $output['c_id']?>&t_id=<?php echo $output['t_id'];if($_GET['only_id'] == ''){?>&only_id=<?php echo $val['member_id'];}?>"
							class="noborder">
            <?php if($_GET['only_id'] != ''){echo $lang['circle_see_all'];}else{echo $lang['circle_see_TA'];}?>
            </a> <a href="javascript:void(0);"
							nctype="<?php if($output['theme_onlike'] == 1){?>themeLikeYes<?php }else{?>themeLikeNo<?php }?>">
            <?php if($output['theme_onlike'] == 1){echo $lang['circle_like'];}else{echo $lang['circle_like_cancel'];}?>
            (<em nctype="like"><?php echo $output['theme_info']['theme_likecount'];?></em>)
						</a> <a href="#quickReply"> <?php echo $lang['circle_reply'];?>(<?php echo $output['theme_info']['theme_commentcount'];?>) </a>
						<a href="javascript:void(0);" nctype="themeShare"> <?php echo $lang['circle_share'];?>(<em
							nctype="share"><?php echo $output['theme_info']['theme_sharecount'];?></em>)
						</a>
      ...
      <ul class="theme-reply-list">
        ...
        <li class="reply-info" id="f<?php echo $val['reply_id'];?>">
					<dl>
						<dt class="membar-name">
							<a href="javascript:void(0);" nctype="mcard"
								data-param="{'id':<?php echo $val['member_id'];?>}"><?php echo $val['member_name'];?></a>
              ...
              <span class="reply-floor"><a
								href="<?php echo spellInformUrl(array('circle_id'=>$val['circle_id'], 'theme_id'=>$val['theme_id'], 'reply_id'=>$val['reply_replyid']));?>"><?php echo $lang['circle_reply'];?>&nbsp;<?php echo $val['reply_replyid'].$lang['circle_floor'];?>&nbsp;<?php echo $val['reply_replyname']?>&nbsp;<?php echo $lang['circle_of_post'];?></a></span>
              <?php }?>
            </dt>
            <?php if($val['member_id'] == $_SESSION['member_id']){?>
            <dd class="reply-manage">
							<span><?php echo $lang['circle_my_manage'];?><i></i></span><span
								class="hidden"><a
								href="index.php?act=theme&op=edit_reply&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>&r_id=<?php echo $val['reply_id'];?>"><?php echo $lang['circle_edit_my_reply'];?></a><a
								href="Javascript: void(0)" nctype="del_reply"
								data-param="<?php echo $val['reply_id'];?>"><?php echo $lang['circle_delete_my_reply'];?></a></span>
						</dd>
            <?php }?>
            ...
            <dd class="reply-file clearfix">
                ...
                <li><a
									href="<?php echo themeImageUrl($val['affix_filename']);?>"
									class="nyroModal" rel="gal"
									title="<?php echo $lang['circle_reply_image_title_one'].$val['reply_id'].$lang['circle_reply_image_title_two'];?>"><img
										src="<?php echo themeImageUrl($val['affix_filethumb']);?>" /></a>
								</li>
                <?php }?>
              </ul>
            ...
            <dd class="reply-goods clearfix">
                ...
                <li>
									<div class="goods-pic thumb size30">
										<a href="javascript:void(0);" class="size30"><img
											src="<?php echo $val['image'];?>" class="t-img" /></a>
									</div>
									<div class="goods-name"><?php echo $val['goods_name'];?></div>
									<div class="goods-price">
            ...
            <dd class="floor"><?php echo $val['reply_id'].$lang['circle_floor'];?></dd>
              ...
              <?php if(in_array($output['identity'], array(1,2))){?>
              <div class="manage">
								<a href="javascript:void(0);" class="manage-button"><?php echo $val['reply_id'].$lang['circle_floor'];?>&nbsp;<?php echo $lang['circle_reply_manage'];?></a>
								<span class="manage-content"> <a href="javascript:void(0);"
									nctype="<?php if($val['is_closed'] == 0){?>themeCloseYes<?php }else{?>themeCloseNo<?php }?>"
									data-param="<?php echo $val['member_id'];?>">
                <?php if($val['is_closed'] == 0){echo $lang['circle_nospeak'];}else{echo $lang['circle_nospeak_cancel'];}?>
                </a> <a href="javascript:void(0);"
									nctype="replyDelManage"
									data-param="<?php echo $val['reply_id'];?>"><?php echo $lang['nc_delete'];?></a></span>
							</div>
              <?php }?>
              <div class="normal">
								<a
                ...
                <?php if($_GET['only_id'] != ''){echo $lang['circle_see_all'];}else{echo $lang['circle_see_TA'];}?>
									...
									href="<?php echo CIRCLE_SITE_URL?>/index.php?act=theme&op=reply&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>&answer_id=<?php echo $val['reply_id'];?>"><?php echo $lang['circle_reply'];?></a>
                <?php if(in_array($output['identity'], array(1,2,3))){?>
                <a href="javascript:void(0);" nctype="inform"
									data-param="{r_id:<?php echo $val['reply_id'];?>}"><?php echo $lang['circle_inform'];?></a>
                <?php }?>
              </div>
						</dd>
					</dl>
      ...
      <div class="quick-reply">
        ...
        <div class="ban"><?php echo $lang['circle_not_login_prompt'];?><a
						href="javascript:void(0);" nctype="login"><?php echo $lang['nc_login'];?></a>
				</div>
        <?php }else if(in_array($output['identity'], array(0,5))){?>
        <div class="ban"> <?php echo $lang['circle_not_join_prompt_one'];?><a
						href="javascript:void(0);" nctype="apply"><?php echo $lang['circle_not_join_prompt_two'];?></a><?php echo $lang['circle_not_join_prompt_three'];?></div>
        ...
        <?php }?>
        <div class="quick-reply-member">
					<a id="quickReply"></a>
					<div class="member-avatar-m">
						<img
							src="<?php echo getMemberAvatarForID($output['cm_info']['member_id']);?>" />
					</div>
				</div>
				<form method="post" id="reply_form"
					action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=save_reply&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>">
					<input type="hidden" name="form_submit" value="ok" />
          <?php echo showMiniEditor('replycontent', '', 'hQuickReply');?>
          <div class="bottom">
						<a class="submit-btn" nctype="reply_submit"
							href="Javascript: void(0)"><?php echo $lang['nc_release_reply'];?></a>
						<div id="warning"></div>
					</div>
				</form>
				<div class="clear"></div>
...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="<?php echo CIRCLE_RESOURCE_SITE_URL;?>/js/miniditor/jquery.insertsome.min.js"></script>
<script type="text/javascript"
	src="<?php echo CIRCLE_RESOURCE_SITE_URL;?>/js/miniditor/ubb.insert.js"
	charset="utf-8"></script>
<link
	href="<?php echo RESOURCE_SITE_URL;?>/js/jquery.nyroModal/styles/nyroModal.css"
	rel="stylesheet" type="text/css">
<script type="text/javascript"
	src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.nyroModal/custom.min.js"></script>
<!--[if IE 6]>
