    ...
    <table class="base-table-style">
        ...
        <tr>
					...
					<td colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
						...
						nctype="batchbutton"
						uri="<?php echo CIRCLE_SITE_URL;?>/index.php?act=manage&op=applying_manage&type=yes&c_id=<?php echo $output['c_id'];?>"
						name="cm_id"><i class="ac6"></i><?php echo $lang['circle_pass'];?></a>
						<a href="javascript:void(0);" class="handle-btn"
						nctype="batchbutton"
						uri="<?php echo CIRCLE_SITE_URL;?>/index.php?act=manage&op=applying_manage&type=no&c_id=<?php echo $output['c_id'];?>"
						name="cm_id"
						confirm="<?php echo $lang['circle_refuse_confirm'];?>"><i
							class="ac7"></i><?php echo $lang['circle_refuse'];?></a></td>
				</tr>
        <?php }?>
      </thead>
			<tbody>
        ...
        <tr>
					...
					<td><dl class="member-base">
							<dt class="name">
								<a
									...
									target="_blank"><?php echo $val['member_name'];?></a>
							</dt>
					...
					<td><div class="long-text tip"
							title="<?php echo $val['cm_applycontent'];?>"
							style="color: #2D917A;"><?php echo $val['cm_applycontent'];?></div></td>
					<td><div class="long-text tip"
							title="<?php echo $val['cm_intro'];?>" style="color: #F66"><?php echo $val['cm_intro'];?></div></td>
					<td class="handle"><a href="javascript:void(0);"
						onclick="applyingManage('yes', <?php echo $val['member_id'];?>);"><i
							class="ac6"></i><?php echo $lang['circle_pass'];?></a>&nbsp;|&nbsp;<a
						href="javascript:void(0);"
						onclick="applyingManage('no', <?php echo $val['member_id'];?>);"><i
							class="ac7"></i><?php echo $lang['circle_refuse'];?></a></td>
				</tr>
        <?php }?>
        <?php }else{?>
      ...
      <tfoot>
				<tr>
					...
					<th colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
						...
						name="cm_id"
						confirm="<?php echo $lang['circle_refuse_confirm'];?>"><i
							class="ac7"></i><?php echo $lang['circle_refuse'];?></a></th>
				</tr>
			</tfoot>
      <?php }?>
    </table>
