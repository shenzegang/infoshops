...
<div class="eject_con">
	...
	<form id="fsadd_form"
		action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=manage&op=friendship_add&c_id=<?php echo $output['c_id'];?>"
		method="post" class="base-form-style">
		<input type="hidden" value="ok" name="form_submit">
		<dl>
			<dt><?php echo $lang['circle_name'].$lang['nc_colon'];?></dt>
			<dd>
				<input type="text" name="name" class="w200 text" /> <a
					href="javascript:void(0);" nctype="fsadd_search"><?php echo $lang['nc_search'];?></a>
			</dd>
			<dd>
				<select name="cid" nctype="fsadd_select">
					<option value='0'><?php echo $lang['nc_common_pselect'];?></option>
				</select> <input type="hidden" name="cname" id="cname" value="" />
			</dd>
		</dl>
		<dl>
