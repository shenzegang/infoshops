...
<div class="circle-share">
	<form method="post"
		action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme_share&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>"
		id="share_form" class="feededitor">
        ...
        <?php }?>
			...
			<dd class="sub">
				<span id="_share_publisher">作者：<?php echo $output['theme_info']['member_name'];?></span><span
					id="_share_origin">来自：<?php echo $output['theme_info']['circle_name'];?></span>
			</dd>
...
with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
    ...
    <div class="share-content">
			<textarea
				...
				name="content" id="content_sgweibo" resize="none"></textarea>
		</div>
...
<div class="eject_con">
		<dl>
			<dt style="width: 25%">
				<img
					src="<?php echo CIRCLE_TEMPLATES_URL;?>/images/shareicon/shareicon_@apikey.png"
...
<dl class="bottom">
        ...
        <dd style="width: 75%">
				<a href="javascript:void(0);" nc_type="finishbtn"
					...
					target="_blank"
					href="<?php echo CIRCLE_SITE_URL;?>/api.php?act=sharebind&type=@apikey"
