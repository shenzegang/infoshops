...
<div class="group warp-all">
  ...
  <div class="theme-editor">
		<form method="post" id="reply_form1"
			action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=save_reply&type=adv&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>">
			<input type="hidden" name="form_submit" value="ok" />
      <?php if(!empty($output['answer'])){?>
      <input type="hidden" name="answer_id"
				value="<?php echo $output['answer']['reply_id'];?>" />
      <?php }?>
      <div class="quick-thread">
          ...
          <div class="bottom">
						<a class="submit-btn" nctype="reply_submit"
							href="Javascript: void(0)"><?php echo $lang['nc_reply_theme'];?></a>
