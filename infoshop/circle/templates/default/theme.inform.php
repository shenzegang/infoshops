...
<div class="eject_con inform-reason">
	...
	<form id="inform_form"
		action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme_inform&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id']; if(isset($_GET['r_id'])){echo '&r_id='.$_GET['r_id'];}?>"
		method="post"
		onsubmit="ajaxpost('inform_form', '<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme_inform&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id']; if(isset($_GET['r_id'])){echo '&r_id='.$_GET['r_id'];}?>', '', 'onerror');">
		...
		<dl>
			...
			<dd>
				...
				<p>
					<textarea name="content" class="textarea" id="i_content"></textarea>
				</p>
				<p>
					<span class="count" id="i_contentcharcount"></span>
				</p>
			</dd>
		</dl>
		<div class="bottom">
			<a class="submit-btn" nctype="inform_submit"
				href="Javascript: void(0)"><?php echo $lang['nc_submit'];?></a> <a
				class="cancel-btn" nctype="inform_cancel" href="Javascript: void(0)"><?php echo $lang['nc_cancel'];?></a>
		</div>
	</form>
</div>
<script>
