...
<div class="base-layout">
	<div class="mainbox">
      ...
      <ul class="group-theme-list">
        ...
        <li>
					<dl class="theme-info"
						...
						<dt>
							<span class="theme-title"><a
								...
								target="_blank" class="title"><?php echo $val['theme_name'];?></a></span>
						</dt>
                ...
                <?php echo $lang['p_center_published_since'];?><span
									class="group-name">&#8220;<a
									href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>"><?php echo $val['circle_name'];?></a>&#8221;<?php echo $lang['p_center_is_theme'];?></span>
                ...
                <?php }?>
                <span class="ml10"><?php echo $lang['circle_like'];?>(<em><?php echo $val['theme_likecount'];?></em>)</span>
							</div>
						</dd>
					</dl>
				</li>
      ...
      <?php }else{?>
      <div class="no-theme">
				<span><i></i><?php echo $lang['p_center_not_published_theme'];?></span>
			</div>
      <?php }?>
    </div>
	</div>
