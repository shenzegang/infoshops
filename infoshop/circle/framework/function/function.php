...
function spellInformUrl($param)
{
    ...
    $count = Model()->table('circle_threply')
        ->where($where)
        ->count();
    $page = ceil($count / 15);
 ...
 *
 * @param string $cname
 *            content of the editor 'id' and the 'name' of the name
 ...
 *            affix content
 * @param string $gname
 *            name of the goods content
 * @param array $goods
 *            goods content
 * @param array $readperm
 *            permissions array
 * @param int $rpvalue
 *            chosen the permissions
 */
