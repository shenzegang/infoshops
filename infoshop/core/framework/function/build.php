...
function build()
{
    ...
    $compile .= "\nBase::run();";
    file_put_contents(RUNCOREPATH, compress_code("<?php defined('CorShop') or exit('Access Invalid!');" . $compile));
}
...
function compile($filename)
{
    ...
    $content = str_ireplace("defined('CorShop') or exit('Access Invalid!')", '', $content);
