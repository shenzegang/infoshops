...
final class Base
{
    ...
    private static function parse_conf(&$setting_config)
    {
        ...
        $setting['shopnc_version'] = '<span class="vol"><font class="b">Infol</font><font class="o">Shop</font></span>';
    ...
    private static function cp()
    {
        ...
        if (strpos(self::CPURL, '||') !== false) {
            ...
            header('location: http://www.infol.com.cn');
            exit();
        } else {
    ...
    public static function shopError($errno, $errstr, $errfile, $errline){
        $errorStr = "$errstr" . $errfile . "第$errline 行。";
        Log :: record($errorStr);
    }
    
    public static function shopException($errno, $errstr, $errfile, $errline){
